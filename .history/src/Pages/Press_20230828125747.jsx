		...
		<motion.div variants={SecMotion}>
			<section className='relative z-1 max-w-[85rem] px-4 mx-auto'>
				<div className='container px-6 py-10 pt-32 mx-auto md:pt-44'>
					...
					<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/FootballSponsor.jpg' className='w-full' />
					...
					<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/ice_cream.jpg' className='w-full' />
				</div>
			</section>
