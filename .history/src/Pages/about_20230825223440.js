...
const About = () => (
	<>
		...
		<div aria-label='card-overlay-v2' className=' relative w-[250px] h-[300px] overflow-hidden rounded-lg'>
				...
				<div className='grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4'>
					<div className='flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-d7 rounded-xl'>
						...
						<div className='flex mt-3 -mx-2'>
							<a href='#' className='mx-2 text-l5 hover:text-l3 group-hover:text-l1' aria-label='Reddit'>
								<svg
							...
							<a href='#' className='mx-2 text-l5 hover:text-l3 group-hover:text-l1' aria-label='Facebook'>
								<svg
									className='w-6 h-6 fill-current'
									viewBox='0 0 24 24'
									fill='none'
							...
							<a href='#' className='mx-2 text-l5 hover:text-l3 group-hover:text-l1' aria-label='Github'>
								<svg
									className='w-6 h-6 fill-current'
									viewBox='0 0 24 24'
									fill='none'
