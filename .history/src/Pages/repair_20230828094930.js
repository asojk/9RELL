...
import RepairFaq from "../Faq/repairFaq";
  ...
  return (
		<>
			...
			<section className='pt-12 relative bg-[url(https://grell.s3.us-east-2.amazonaws.com/pics/repair1.jpg)] shadow-nimble bg-cover bg-center bg-no-repeat'>
				...
				<div className='relative max-w-screen-xl px-8 py-32 mx-auto sm:px-10 lg:flex lg:items-center lg:px-12'>
					<div className='max-w-2xl text-center sm:text-left'>
						...
						<h1 className='mb-8 text-4xl font-bold leading-none tracking-tighter text-l1 md:text-7xl lg:text-5xl'>Flat Roof Repair</h1>
						...
						<div className='flex flex-wrap gap-4 mt-8 text-center'>
							...
							className='px-8 py-3 mb-4 font-medium rounded-lg cursor-pointer text-l1 shadow-nimble bg-r hover:bg-rd2 focus:outline-none focus:ring-2 focus:ring-rd2 active:bg-rl'>
								Emergency?
							</a>
						</div>
					</div>
			...
			<section className='relative max-w-screen-xl px-8 py-16 mx-auto sm:px-16 lg:flex lg:items-center lg:justify-around lg:py-24'>
				<div className='relative z-10 max-w-3xl px-8 pb-8 mx-auto rounded-2xl'>
					<header className='text-center'>
						<h2 className='my-4 head'>Signs that it's time for a repair</h2>
						<h1 className='mb-8 text-4xl font-bold leading-none tracking-tighter text-l1 md:text-7xl lg:text-5xl'>Notice a leak?</h1>
					</header>
			...
			<section
				...
				<div className='relative z-10 max-w-3xl px-8 pb-8 mx-auto rounded-2xl'>
					<div className='text-center'>
						<header className='my-4 head'>24/7 Emergency Flat Roof Repair Services</header>
						<h1 className='mb-8 text-4xl font-bold leading-none tracking-tighter text-l1 md:text-7xl lg:text-5xl'>Emergency Repairs</h1>
						<p className='mb-8 text-base leading-relaxed text-l3'>
