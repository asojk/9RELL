										...
										<div className='max-w-xl text-base leading-7 text-l1 lg:max-w-lg'>
											...
											<ul role='list' className='mt-8 space-y-8 text-l1'>
												<li className='flex gap-x-3'>
													<NewI className='flex-none w-5 h-5 mt-1 text-yw' aria-hidden='true' />
													<span>
												...
												<li className='flex gap-x-3'>
													<CategoryI className='flex-none w-5 h-5 mt-1 text-yw' aria-hidden='true' />
													<span>
												...
												<li className='flex gap-x-3'>
													<ToolsI className='flex-none w-5 h-5 mt-1 text-yw' aria-hidden='true' />
													<span>
