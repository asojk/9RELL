...
<section className="relative max-w-screen-xl px-4 py-[15vh] mx-auto sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
...
<section ref={EmergencyRef} className="relative max-w-screen-xl px-4 py-[15vh] mx-auto sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
