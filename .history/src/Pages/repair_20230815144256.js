  ...
  <section className="text-l1 body-font max-w-[85rem] px-4 py-4 mx-auto">
    <div className="relative max-w-2xl mx-auto divide-y lg:max-w-6xl z-1 bg-d7 rounded-2xl divide-b2">
      <div className="grid grid-cols-[2fr,4fr] pt-8">
        ...
        <p className="px-2 pt-2 lg:px-0 text-yw">We ensure proper draining and flashings throughout all of our repairs.</p>
        </div>
