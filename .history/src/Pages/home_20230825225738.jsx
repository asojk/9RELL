	...
	return (
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			<div className='relative w-full max-w-lg'>
				<div className='absolute top-0 z-0 rounded-full bg-violet-300 -left-4 w-72 h-72 mix-blend-multiply filter blur-xl opacity-40 animate-blob' />

				<div className='absolute z-0 rounded-full bg-fuchsia-300 -bottom-24 right-20 w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000' />
			</div>
			<Clients />
