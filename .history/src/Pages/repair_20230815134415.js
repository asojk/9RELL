...
<div className="relative max-w-2xl mx-auto mt-32 lg:max-w-6xl rounded-2xl z-1">
  <div className="relative grid grid-cols-2 grid-rows-3 gap-2 px-12 pt-12 z-1 text-l1 body-font bg-d7 rounded-2xl">
    <div className="flex flex-col col-span-2 row-span-3">
      ...
      <p className="text-base">Over the past 30 years, Grell built a reputation throughout the Midwest for quality, affordable flat roof repairs for buildings of all sizes. We will also work with your insurance company to make sure the process goes as smoothly as possible.</p></div>
    </div>
