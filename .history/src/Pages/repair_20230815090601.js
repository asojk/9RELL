...
<section className="pt-32 text-l1 body-font">
  <div className="container px-5 py-24 mx-auto">
    ...
    <header className="header">
      ...
      <p className="mx-auto text-base leading-relaxed lg:w-3/4">We are confident that we can provide the flat roof repairs you need.
      <div className="relative h-64 p-8 overflow-hidden rounded-2xl">
            <img
              alt="Damaged Roof"
              src="https://grell.s3.us-east-2.amazonaws.com/pics/repair2.jpg"
              className="absolute inset-0 object-cover w-full h-full m-8 rounded-2xl"
            />
          </div>
