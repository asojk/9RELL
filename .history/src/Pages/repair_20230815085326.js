    ...
    <div className="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">Authentic Cliche Forage</span>
        </div>
      </div>
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">Kinfolk Chips Snackwave</span>
        </div>
      </div>
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">Coloring Book Ethical</span>
        </div>
      </div>
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">Typewriter Polaroid Cray</span>
        </div>
      </div>
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
      ...
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">The Catcher In The Rye</span>
        </div>
      </div>
    </div>
