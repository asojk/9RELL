		...
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			<div className='lg:hidden'>
				<img
					...
					alt='customer_avatar'
					className='flex-shrink-0 object-center mx-auto object-fit aboslute'></img>

				<div className='relative w-full h-96 bottom-48 z-1 bg-gradient-to-t from-black/0 to-black/0 via-black'></div>
			</div>
