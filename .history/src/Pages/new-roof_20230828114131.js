...
const NewRoof = () => {
  ...
  <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Choosing Your Commercial Roofing Materials</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Choosing a Commercial Roofing System</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Shape of Commercial Roofs</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Types of Commercial Roofing Systems</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Modified Bitumen Roofing Systems</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Built-Up Roofing Systems</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Metal Roofs</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Liquid Applied Roofing</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl"></h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Green Roofs</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Photovoltaic (PV) Solar Panels</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Steep Slope</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Insulation & Cover Boards</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">The Less-Than-10-Percent Group</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Built Up Roofing (BUR) Systems</h2>
  <p className=''>
 ...
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Mod Bit Systems Options:</h2>
  <p className=''></p>
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl"></h2>
  <p className=''></p>
  <h1 className=''>Single Ply 101</h1>
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Single Ply Membrane Systems</h2>
  <p className=''>Thermoset membranes</p>
  <p className=''>Thermoplastic membranes</p>
  <p className=''>Single Ply Attachment Methods:</p>
  <p className=''></p>
  <p className=''></p>
 <h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">The Value of Insulation and Vapor Retarders</h2>
  <p className=''>
