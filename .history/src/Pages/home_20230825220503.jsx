...
function Home() {
	...
	return (
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			<div className='flex-shrink-0 object-center mx-auto lg:hidden object-fit aboslute'>
			<img
				src='https://grell.s3.us-east-2.amazonaws.com/pics/finishedroof.jpg'
				alt='customer_avatar'
				className='relative z-1'></img>
				
				<div className='relative inset-0 z-0 w-full h-24 bottom-12 bg-gradient-to-t from-black to-black/0'></div></div>
			<div className='absolute inset-0 lg:hidden sm:from-black sm:to-d7/0 via-l1/0 sm:bg-gradient-to-b'></div>
