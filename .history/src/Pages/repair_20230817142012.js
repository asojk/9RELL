    ...
    <div className="relative max-w-screen-xl px-4 py-32 mx-auto sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
      <div className="max-w-2xl text-center sm:text-left">
        ...
        <div className="flex flex-wrap pt-4 pb-4">
          <RepairServices Services="Leaks & Holes/Punctures" />
          <RepairServices Services="Metal & Modified Bitumen" />
          <RepairServices Services="TPO, EPDM & PVC" />
          <RepairServices Services="Built-Up & Ballasted" />
          <RepairServices Services="Vent & Insulation " />
          <RepairServices Services="Membrane, Deck, & Sealant" />
          <RepairServices Services="Penetration & Perimeter" />
          <RepairServices Services="Seal-In Seams & Penetrations" />
        </div>
