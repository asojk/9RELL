...
function Home() {
	...
	return (
		<motion.div variants={content} animate='animate' initial='initial'>
			<Helmet title='GRELL ROOFING | Home' meta={[
			...
			<img
				src='https://grell.s3.us-east-2.amazonaws.com/pics/finishedroof.jpg'alt='customer_avatar'
				className='flex-shrink-0 object-center mx-auto md:hidden object-fit shadow-nimble aboslute'></img>
			<video className='hidden h-full md:block 2xl:w-screen max-h-[70vh]' autoPlay={true} muted loop={false}>
