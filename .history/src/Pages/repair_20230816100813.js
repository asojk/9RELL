...
<div className="absolute bg-black opacity-25 inset-10 rounded-2xl">
  ...
  <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
    ...
    <span className="tracking-[0.13rem] text-[min(8vw,1.2rem)] leading-loose uppercase text-yw">licensed, bonded, insured</span>
    <h1 class="text-[min(12vw,2.5rem)] font-bold leading-[4rem] tracking-[0.01em] text-l1">
        Flat Roof Repair
      </h1>
