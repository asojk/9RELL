		...
		<>
			...
			<div className='relative max-w-screen-xl px-4 py-[10vh] mx-auto sm:px-6 lg:flex lg:items-center lg:px-8'>
				<section className='relative z-1 max-w-[85rem] px-4 mx-auto'>
					<div className='container px-5 mx-auto rounded-2xl bg-d7'>
						<div className='mb-8 text-center'>
							...
							<div className='grid max-w-2xl grid-cols-1 mx-auto gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10'>
								<div className='lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8'>
									<div className='lg:pr-4'>
										<div className='lg:max-w-lg'>
											<p className='text-base font-semibold leading-7 text-yw'>Deploy faster</p>
											<h1 className='mt-2 text-3xl font-bold tracking-tight text-l1 sm:text-4xl'>
												A better workflow
											</h1>
											<p className='mt-6 text-xl leading-8 text-l3'>
								...
								<div className='p-12 -mt-12 -ml-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden'>
									<img
										className='w-[48rem] max-w-none rounded-xl shadow-nimble ring-1 ring-b3/10 sm:w-[57rem]'
								...
								<div className='lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8'>
									<div className='lg:pr-4'>
										<div className='max-w-xl text-base leading-7 text-l3 lg:max-w-lg'>
											<p>
											...
											<ul role='list' className='mt-8 space-y-8 text-l1'>
												<li className='flex gap-x-3'>
													<NewI className='flex-none w-5 h-5 mt-1 text-r' aria-hidden='true' />
													<span>
														<strong className='font-semibold text-l1'>Push to deploy.</strong> Lorem ipsum, dolor
														sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste
														dolor cupiditate blanditiis ratione.
													</span>
												</li>
												<li className='flex gap-x-3'>
													<CategoryI className='flex-none w-5 h-5 mt-1 text-r' aria-hidden='true' />
													<span>
														<strong className='font-semibold text-l1'>SSL certificates.</strong> Anim aute id
														magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.
													</span>
												</li>
												<li className='flex gap-x-3'>
													<ToolsI className='flex-none w-5 h-5 mt-1 text-r' aria-hidden='true' />
													<span>
														<strong className='font-semibold text-l1'>Database backups.</strong> Ac tincidunt
											...
											<h2 className='mt-16 text-2xl font-bold tracking-tight text-l1'>No server? No problem.</h2>
											<p className='mt-6'>
