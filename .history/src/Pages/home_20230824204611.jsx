...
function Home () {
  ...
  return (
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			<video className='hidden h-full md:block shadow shadow-nimble 2xl:w-screen 2xl:overflow-y-clip 2xl:h-[64rem] 2xl:shadow-none' autoPlay={true} muted loop={false}>
