...
const RepairServices = ({RepairServices}) => (
    ...
    <div className="flex items-center h-full">
      ...
      <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} className="flex-shrink-0 w-6 h-6 mr-3 text-yw" viewBox="0 0 24 24">
  ...
  >
    ...
    <h1 class="h1">
      ...
      <div className="flex flex-wrap gap-4 mt-8 text-center">
        <a onClick={scrollToEmergency} className="block w-full px-12 py-3 text-sm font-medium rounded shadow-sm cursor-pointer shadow-rd3 text-l1 bg-r hover:bg-rd2 focus:outline-none focus:ring active:bg-r sm:w-auto">
          Emergency?
        </a>

        <a onClick={scrollToSigns} className="block w-full px-12 py-3 text-sm font-medium rounded shadow-sm cursor-pointer shadow-d9 bg-d7 text-r hover:text-rd2 focus:outline-none focus:ring active:text-r sm:w-auto">
          Signs of Damage
        </a>

        <section className="text-l1 max-w-[85rem] px-4 py-4 mx-auto">
    <div className="relative max-w-2xl py-6 mx-auto lg:max-w-6xl z-1 rounded-2xl">

        <h3 className="head">Our Repair Services</h3>
