...
<section className="pt-32 text-l1 body-font max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto relative z-1">
  <div className="max-w-2xl mx-auto lg:max-w-6xl">
    <div className="grid grid-cols-2 grid-rows-2 gap-4 px-12 py-12 bg-d7 rounded-2xl">
      <div className="row-span-2">
        <span className="h4">licensed, bonded, insured</span>
        <h1 className="h1">Flat Roof Repair</h1>
      </div>
      <p className="px-4 pt-4 mx-auto mb-8 text-base leading-relaxed lg:w-3/4 bg-d7 rounded-2xl">Over the past 30 years, Grell built a reputation throughout the Midwest for quality, affordable flat roof repairs for buildings of all sizes. We will also work with your insurance company to make sure the process goes as smoothly as possible.</p>
    </div>
  </div>
</section>
...
<img alt="Damaged Roof" src="https://grell.s3.us-east-2.amazonaws.com/pics/repair2.jpg" className="content-image" />
  <div className="container relative px-5 py-24 mx-auto z-1">
      <span className="pl-16 h4">licensed, bonded, insured</span>
      <h1 className="pb-8 pl-16 h1">Flat Roof Repair</h1>
          <p className="px-4 pt-4 mx-auto mb-8 text-base leading-relaxed lg:w-3/4 bg-d7 rounded-2xl">
        Over the past 30 years, Grell built a reputation throughout the Midwest for quality, affordable flat roof repairs for buildings of all sizes. We will also work with your insurance company to make sure the process goes as smoothly as possible.</p>
      <div className="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
        <div className="w-1/2 px-2 sm:w-1/3">
          <div className="flex items-center h-full">
            <div className="flex items-center w-full p-4 bg-d7 rounded-2xl">
        ...
        <div className="w-1/2 px-2 sm:w-1/3">
          <div className="flex items-center h-full">
            ...
            <span className="font-medium title-font">
              Seal in Seams & Penetrations</span>
              </div>
          </div>
        </div>
        <div className="w-1/2 px-2 sm:w-1/3">
        ...
        <div className="w-1/2 px-2 sm:w-1/3">
          <div className="flex items-center h-full">
            ...
            <span className="font-medium title-font">
              Proper Roof Draining Ensured</span>
              </div>
          </div>
        </div>
      </div>
