  ...
  <section className="pt-32 text-l1 body-font max-w-[85rem] px-4 py-4 mx-auto">
    <div className="relative max-w-2xl mx-auto mt-32 divide-y lg:max-w-6xl z-1 bg-d7 rounded-2xl divide-b2">
      <div className="grid grid-cols-[2fr,4fr] pt-8">
        <h3 className="pl-12 h3">Our Repair Services</h3>
        <p className="pb-8">We ensure proper draining and flashings throughout all of our repairs.</p>
        </div>
        <div className="flex flex-wrap px-12 pt-4 pb-8 align-content-baseline">
