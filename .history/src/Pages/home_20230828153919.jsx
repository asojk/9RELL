...
function Home() {
	...
	return (
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			<span className='absolute -top-[325px] left-[50%] z-0 h-[800px] w-[1600px] -translate-x-[50%] rounded-full bg-gradient-to-b from-d9 to-d7/50 blur-3xl' />
			<div
				...
				<div className='px-6 m-auto text-l1 xl:container md:px-12 xl:px-6'>
					<span className='mb-8 text-sm font-bold tracking-widest underline uppercase decoration-rA'>
						{' '}
					...
					<p className='mb-8 text-base leading-relaxed text-left md:mb-24 md:text-lg xl:text-xl text-l1'>
						We build, repair, and replace commercial flat roofs. We're family owned and female operated, securing over
						12 million square feet of roof, in over 20 states, since 1985.
					</p>
