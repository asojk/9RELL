...
<div className="absolute bg-black opacity-25 inset-10 rounded-2xl">
  <img className="object-cover object-center w-1/4 rounded-2xl" alt="hero" src="https://grell.s3.us-east-2.amazonaws.com/pics/repair1.jpg" />
  </div>
  <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
    ...
    <span className="head">licensed, bonded, insured</span>
      <h1 class="max-w-5xl text-5xl font-bold leading-none tracking-tight text-l1 md:text-5xl lg:text-6xl lg:max-w-7xl">
        Flat Roof Repair
      </h1>
