  ...
  <div className="container px-5 py-24 mx-auto">
      ...
      <header className="header">
        ...
        <h1 class="h2">Emergency Repairs</h1>
            ...
            <div className="flex flex-wrap gap-4 mt-8 text-center">
          <a className="w-full px-12 py-3 text-sm font-medium rounded shadow-sm cursor-pointer shadow-rd3 text-l1 bg-r hover:bg-rd2 focus:outline-none focus:ring active:bg-r sm:w-auto">Emergency?</a>
          </div>
      </div>
    </div>
  </section>
