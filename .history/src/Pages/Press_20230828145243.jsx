...
const Press = () => {
	...
	return (
		<motion.div variants={SecMotion}>
			...
			<section className='relative z-1 max-w-[85rem] px-4 pt-64 mx-auto'>
				<div className='px-6 m-auto text-l1 xl:container md:px-12 xl:px-6'>
					...
					<p className='mb-8 text-base leading-relaxed text-left md:mb-24 text-l1'>
						...
						<li>
							Education: includes support for students, teachers, and parents, as well as scholarships and financial aid
							services
						</li>
					...
					<div class='lg:w-3/4 xl:w-2/4 lg:mx-auto'>
						<div class='group relative -mx-4 sm:-mx-8 p-6 sm:p-8 rounded-3xl bg-white dark:bg-transparent border border-transparent hover:border-gray-100 dark:shadow-none dark:hover:border-gray-700 dark:hover:bg-gray-800 shadow-2xl shadow-transparent hover:shadow-gray-600/10 sm:gap-8 sm:flex transition duration-300 hover:z-10'>
							...
							<p className='mb-8 text-base leading-relaxed text-left md:mb-24 text-l1'>
								...
								partner with organizations that align with our corporate values of giving. By ensuring that our
								employees have a voice in the way we give back to our community, we believe that makes for more
								meaningful fundraising and volunteering. Ultimately, everybody wins: the Grell Roofing works with
								organizations and causes that they’re passionate about—and our community grows stronger with every hour
								volunteered, and every dollar donated.
							</p>
						</div>
			...
			<div className='grid grid-cols-4 grid-rows-4 place-content-center'>
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/Award2023.jpg' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/BikesforTykes.jpg' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/BowDonation.jpg' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/BowDonation2.jpg' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/DL2019.jpg' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/DinnerSponsor.jpg' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/FootballSponsor.jpg' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/ReadersChoice.jpg' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/ReadersChoice.pdf' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/SIDSSponsor.png' className='w1/5' />
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/ice cream.jpg' className='w1/5' />
			</div>
