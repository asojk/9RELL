...
<div className="flex flex-wrap pb-4">
  ...
  <p className="pt-2 text-sm text-l3">
    Proper draining and flashings ensured in all repairs.</p>
</div>
      ...
      <div className="flex flex-wrap gap-4 mt-8 text-center">
        ...
        <p className="text-sm lg:px-0 text-l3">Proper draining and flashings ensured in all repairs.</p>
