...
<img alt="Damaged Roof" src="https://grell.s3.us-east-2.amazonaws.com/pics/repair2.jpg" className="content-image" />
  <div className="container relative px-5 py-24 mx-auto z-1">
    <div className="mb-20 text-center">
    <header className="header">
    <span className="head">We provide the flat roof repairs you need</span>
          <h2 className="heading">Flat Roof Repair</h2>
        </header>
          <p className="px-4 pt-4 mx-auto text-base leading-relaxed lg:w-3/4 bg-d7 rounded-2xl">
        When you are having issues with your commercial roof, let Grell Roofing take care of your flat roof repairs. Over the past 30 years, we have built a reputation throughout the Midwest for quality, affordable flat roof repairs for buildings of all sizes. We are licensed, bonded, insured, and stand behind our work. We will also work with your insurance company to make sure the process goes as smoothly as possible. Contact us today for flat roof repairs available throughout Iowa and the surrounding states.</p>
    </div>
    <div className="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
      <div className="w-full px-2 sm:w-1/2">
        <div className="flex items-center h-full px-4">
          <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} className="flex-shrink-0 w-6 h-6 mr-4 text-r bg-d7" viewBox="0 0 24 24">
            <path d="M22 11.08V12a10 10 0 11-5.93-9.14" />
            <path d="M22 4L12 14.01l-3-3" />
          </svg>
          <span className="p-4 font-medium title-font bg-d7 rounded-2xl">Roof Leaks</span>
        </div>
      </div>
      ...
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">Ballasted Roof Repairs</span>
        </div>
      </div>
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">TPO Repairs</span>
        </div>
      </div>
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">Seal in Seams & Penetrations</span>
        </div>
      </div>
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">Proper Flashings Ensured</span>
        </div>
      </div>
      <div className="w-full p-2 sm:w-1/2">
        <div className="flex items-center h-full p-4 bg-gray-100 rounded">
          ...
          <span className="font-medium title-font">Proper Roof Draining Ensured</span>
        </div>
      </div>
    </div>
