  ...
  return (
		<>
			...
			<section className='relative max-w-screen-xl px-8 py-16 mx-auto sm:px-16 lg:flex lg:items-center lg:justify-around lg:py-24'>
				<div className='relative z-10 max-w-3xl px-8 mx-auto bg-white shadow-lg rounded-2xl'>
					<header className='text-center'>
						<h2 className='mb-4 h2'>Signs that it's time for a repair</h2>
						<h1 className='mb-8 text-3xl font-bold text-gray-800'>Notice a leak?</h1>
					</header>
					<p className='my-8 text-base leading-relaxed text-l3'>
				...
				<div className='max-w-3xl px-8 mx-auto bg-white shadow-lg rounded-2xl'>
					<div className='text-center'>
						...
						<div className='flex justify-center gap-8'>
							<a className='px-8 py-3 font-medium text-white bg-blue-500 rounded-lg shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 active:bg-blue-700'>
								Contact
							</a>
						</div>
					</div>
