  ...
  <section className="relative z-1 max-w-[85rem] px-4 mx-auto">
    <div className="container px-5 mx-auto rounded-2xl">
      ...
      <div className="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
        <ReplaceSigns Signs="Less on-site seaming during installation, which minimizes problems
                and enables us to install quicker, saving you time and money"/>
        <ReplaceSigns Signs="A significant reduction in the potential for installation issues and
                future leak problems"/>
        <ReplaceSigns Signs="A reduction in waste, both during manufacturing and during
                installation"/>
