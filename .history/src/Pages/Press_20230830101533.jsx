	...
	return (
		<motion.div variants={SecMotion}>
				...
				<div class='xl:container m-auto px-6 text-gray-600 md:px-12 xl:px-6'>
					...
					<div class='grid gap-8 md:grid-cols-2 lg:grid-cols-3'>
						...
						<div class='group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10'>
							<div class='relative overflow-hidden rounded-xl'>
								<img
									src='https://grell.s3.us-east-2.amazonaws.com/Press/recycle2.jpg'
									alt='art cover'
									loading='lazy'
									width='1000'
									height='667'
							...
							<div class='mt-6 relative'>
								<h3 class='text-2xl font-semibold text-gray-800 dark:text-white'>Environmental</h3>
								<p class='mt-6 mb-8 text-gray-600 dark:text-gray-300'>
									Grell Roofing has always been dedicated to helping our community, our environment, and reducing our
									carbon footprint wherever we can. Today we want to share with you the opportunity we couldn’t pass up
									to honor those beliefs! This picture shows material that will be recycled, repurposed, and
									manufactured into other roofing products that can be utilized in future projects. This is the first of
									many loads and we believe by the end of our current job we should have over 30,000 pounds of material
									successfully transported back to Sigourney, Iowa. Does your local flat roofer believe in reducing
						...
						<div class='group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10'>
							...
							<div class='mt-6 relative'>
								<h3 class='text-2xl font-semibold text-gray-800 dark:text-white'>& More</h3>
								<p class='mt-6 mb-8 text-gray-600 dark:text-gray-300'>
									<li>
										Health: local hospitals ands clinics, medical research, and patient and family support charities
									</li>
									<li>Non-Government Organizations (NGO): disaster relief, peace, and human rights</li>
									<li>
										Education: support for students, teachers, and parents, as well as scholarships and financial aid
										services
									</li>
								</p>
							</div>
			...
			<div class='py-12'>
				<div class='xl-container m-auto px-6 text-gray-600 md:px-12 xl:px-6'>
					...
					<div class='lg:w-3/4 xl:w-2/4 lg:mx-auto'>
						<div class='group relative -mx-4 sm:-mx-8 p-6 sm:p-8 rounded-3xl bg-transparent border border-transparent hover:border-gray-100 hover:bg-d7/70 shadow-transparent hover:shadow-nimble sm:gap-8 sm:flex transition duration-300 hover:z-10'>
							...
							<div class='sm:p-2 sm:pl-0 sm:w-4/6'>
								...
								<h3 class='text-2xl font-semibold text-white'>
									An article by local paper Messenger News
								</h3>
			...
			<div className='grid grid-cols-8 grid-rows-8 place-content-center'>
				...
				<img alt='award' src='https://grell.s3.us-east-2.amazonaws.com/Press/recycle2.jpg' className='w1/5'></img>
