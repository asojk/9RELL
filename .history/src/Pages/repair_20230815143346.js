...
<section className="text-l1 body-font max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 lg:py-8 mx-auto">
...
<div className="relative max-w-2xl mx-auto mt-36 lg:mt-56 lg:max-w-6xl rounded-2xl z-1">
  <div className="relative grid grid-cols-[1fr,2fr] gap-4 px-12 py-12 z-1 text-l1 body-font rounded-2xl">
    <div className="row">
    <span className="head display:none lg:display:block">licensed, bonded, insured</span>
      <h1 className="h1">Flat Roof Repair</h1>
      
    </div>
      <p className="px-8 py-8 text-base rounded-2xl bg-d7">Over the past 30 years, Grell built a reputation throughout the Midwest for quality, affordable flat roof repairs for buildings of all sizes. We will also work with your insurance company to make sure the process goes as smoothly as possible.</p>
      </div>

    </div>

  </section>
  <section className="pt-32 text-l1 body-font max-w-[85rem] px-4 py-4 mx-auto">
    <div className="relative max-w-2xl mx-auto mt-32 divide-y lg:max-w-6xl z-1 bg-d7 rounded-2xl divide-b2">
      <div className="grid grid-cols-[2fr,4fr] pt-8">
        <h3 className="pb-4 pl-4 lg:pl-12 h3">Our Repair Services</h3>
        <p className="px-2 pt-2 lg:px-0">We ensure proper draining and flashings throughout all of our repairs.</p>
        </div>
