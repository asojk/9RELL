...
<div className="absolute bg-black opacity-25 inset-10 rounded-2xl">
  ...
  <section className="relative z-1 max-w-[85rem] px-4 py-4 mx-auto">
    ...
    <div className="relative max-w-2xl mx-auto divide-y lg:max-w-6xl z-1 rounded-2xl divide-b2">
      <div className="grid grid-cols-[2fr,4fr] pt-8 border-t-[1px] border-w4/30">
        <h3 className="pb-4 pl-8 lg:pl-12 head">Our Repair Services</h3>
        <p className="px-2 pt-2 text-center lg:px-0 text-l1">We ensure proper draining and flashings throughout all of our repairs.</p>
        </div>
  ...
  <section>
    <div className="flex flex-col items-center px-5 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center pb-10 mx-auto my-10 border-b border-gray-200 max-w-7xl sm:flex-row">
            <div className="inline-flex items-center justify-center flex-shrink-0 w-20 h-20 rounded-full text-neutral-600 bg-gray-50 sm:mr-10">
