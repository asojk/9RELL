								...
								<div class='flex flex-wrap w-1/2'>
									<div class='md:p-2 p-1 w-1/2'>
										<img
											...
											src='https://dummyimage.com/500x300'></img>
									</div>
									<div class='md:p-2 p-1 w-1/2'>
										<img
											alt='gallery'
											class='w-full object-cover h-full object-center block'
											src='https://dummyimage.com/501x301'></img>
									</div>
									<div class='md:p-2 p-1 w-full'>
										<img
											alt='gallery'
											class='w-full h-full object-cover object-center block'
											src='https://dummyimage.com/600x360'></img>
									</div>
								</div>
								<div class='flex flex-wrap w-1/2'>
									<div class='md:p-2 p-1 w-full'>
										<img
											alt='gallery'
											class='w-full h-full object-cover object-center block'
											src='https://dummyimage.com/601x361'></img>
									</div>
									<div class='md:p-2 p-1 w-1/2'>
										<img
											alt='gallery'
											class='w-full object-cover h-full object-center block'
											src='https://dummyimage.com/502x302'></img>
									</div>
									<div class='md:p-2 p-1 w-1/2'>
										<img
											alt='gallery'
											class='w-full object-cover h-full object-center block'
											src='https://dummyimage.com/503x303'></img>
									</div>
								</div>
							</div>
						</div>
