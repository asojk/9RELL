...
<section>
  <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
    ...
    <span className="head">licensed, bonded, insured</span>
      ...
      <p class="max-w-xl mx-auto mt-8 text-base leading-relaxed text-center text-l3">Over the past 30 years, Grell built a reputation throughout the Midwest for high-quality, affordable repairs for buildings of all sizes. <br></br><br></br>We will work with your insurance company to make sure the process goes as smoothly as possible.</p>
    </div>
  </div>
</section>
