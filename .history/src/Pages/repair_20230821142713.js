...
<div className="sticky top-0 flex flex-col items-center justify-center h-screen bg-green-400">
...
<div className="sticky top-0 flex flex-col items-center justify-center h-screen text-white bg-indigo-600">
...
<div className="sticky top-0 flex flex-col items-center justify-center h-screen text-white bg-purple-600">
...
<div className="sticky top-0 flex flex-col items-center justify-center h-screen text-white bg-neutral-800">
...
<section className="relative max-w-screen-xl px-4 py-32 mx-auto sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
...
<section ref={EmergencyRef} className="relative max-w-screen-xl px-4 py-32 mx-auto sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
