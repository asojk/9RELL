	...
	return (
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			<img
				...
				alt='customer_avatar'
				className='flex-shrink-0 object-center mx-auto md:hidden object-fit aboslute'></img>

			<section className='relative bg-center bg-no-repeat bg-cover'>
				<video
					className='hidden flex-shrink-0 object-center mx-auto md:block h-full md:object-fit aboslute lg:w-screen max-h-[70vh]'
					autoPlay={true}
					muted
					loop={false}>
