...
<div className="relative max-w-2xl mx-auto mt-32 lg:max-w-6xl rounded-2xl z-1">
  ...
  <div className="relative flex grid flex-wrap grid-rows-2 py-4 my-16 -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2 z-1 bg-d7 rounded-2xl">
    <div className="row">
    <h3 className="h3">Our Repair Services</h3></div>
