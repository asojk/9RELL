...
function Home() {
	...
	return (
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			/>
			<span className='fixed -top-[125px] left-[50%] z-50 h-[400px] w-[2600px] -translate-x-[50%]  bg-gradient-to-b from-d9 to-d7/50 blur-3xl' />
			...
			<motion.div variants={SecMotion}>
				<div
					...
					<div className='px-6 m-auto text-l1 xl:container md:px-12 xl:px-6'>
						<h1 className='mb-8 text-4xl font-bold leading-none tracking-tight text-l1 md:text-7xl lg:text-5xl'>
