		...
		<motion.div variants={SecMotion}>
			...
			<section className='relative z-1 max-w-[85rem] px-4 pt-80 mx-auto'>
				...
				<p className='mt-12 mb-8 text-base leading-relaxed text-left md:mb-24 text-l1'>
					...
					with organizations that align with our corporate values of giving. By ensuring that our employees have a voice
					in the way we give back to our community, we believe that makes for more meaningful fundraising and
