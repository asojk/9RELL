...
<div className="relative max-w-2xl mx-auto mt-36 lg:mt-56 lg:max-w-6xl rounded-2xl z-1">
  <div className="relative grid grid-cols-2 px-12 py-12 z-1 text-l1 body-font rounded-2xl">
    ...
    <span className="head">licensed, bonded, insured</span>
      ...
      <p className="p-8 text-base rounded-2xl bg-d7 lg:p-12">Over the past 30 years, Grell built a reputation throughout the Midwest for quality, affordable flat roof repairs for buildings of all sizes. We will also work with your insurance company to make sure the process goes as smoothly as possible.</p>
      </div>
