...
<div className="relative max-w-2xl mx-auto mt-32 lg:max-w-6xl rounded-2xl z-1">
  <div className="relative grid grid-cols-2 gap-2 px-12 pt-12 z-1 text-l1 body-font bg-d7 rounded-2xl">
    <div className="row">
      <span className="h4">licensed, bonded, insured</span>
      <h1 className="h1">Flat Roof Repair</h1>
      <button className="flex px-8 py-2 mx-auto my-8 text-lg border-0 rounded-2xl text-l1 bg-r focus:outline-none hover:bg-rd2">Button</button>
    </div>
  ...
  <div className="relative flex flex-wrap py-4 my-16 -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2 z-1 bg-d7 rounded-2xl">
