      ...
      <div className="container px-6 py-10 pt-32 mx-auto md:pt-44">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
          <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-blue-600 rounded-xl">
            ...
            <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-l1 group-hover:text-l1">
              arthur melo
            </h1>
            ...
            <div className="flex mt-3 -mx-2">
              <a
                href="#"
                className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-l1"
                aria-label="Reddit"
              >
                <svg
