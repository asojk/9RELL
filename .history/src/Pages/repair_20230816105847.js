...
<section className="pt-32 relative bg-[url(https://grell.s3.us-east-2.amazonaws.com/pics/repair1.jpg)] bg-cover bg-center bg-no-repeat">
...
<div
  ...
  >
    ...
    <h1 class="h1">
      ...
      <p className="max-w-xl mx-auto mt-8 text-base leading-relaxed text-center text-l3">A 35-year reputation for high-quality, affordable repairs for buildings of all sizes. <br></br><br></br>We will work with your insurance company to make sure the process goes as smoothly as possible.</p>
    </div>
  </div>
</section>
...
>
  <div
    className="absolute inset-0 bg-white/75 sm:bg-transparent sm:from-white/95 sm:to-white/25 ltr:sm:bg-gradient-to-r"
  ></div>
