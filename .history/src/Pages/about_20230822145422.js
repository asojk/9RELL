    ...
    <section className="">
      <div className="container px-6 py-10 mx-auto">
        ...
        <div className="flex min-w-[300px] rounded-full whitespace-nowrap overflow-x-auto gap-x-3">
          <div className="flex items-center px-6 py-3 overflow-hidden text-sm font-medium border border-gray-100 rounded-lg cursor-pointer gap-x-3">
            Description
          </div>
          <div className="flex items-center px-6 py-3 overflow-hidden text-sm font-medium text-white bg-blue-500 rounded-lg cursor-pointer gap-x-3">
            Photo & Videos
          </div>
          <div className="flex items-center px-6 py-3 overflow-hidden text-sm font-medium border border-gray-100 rounded-lg cursor-pointer gap-x-3">
            Map
