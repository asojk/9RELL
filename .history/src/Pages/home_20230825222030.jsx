	...
	return (
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			<img
				...
				alt='hospital roof'
				className='flex-shrink-0 object-center mx-auto lg:hidden object-fit aboslute'></img>

			<div className='relative z-0 w-full h-96 bottom-48 bg-gradient-to-t from-black/0 to-black/0 via-black'>
				<Clients />
			</div>
			<div
								...
								<div className='relative w-full max-w-lg'>
									...
									<div className='relative'>
										<img
											...
											alt='hero'
											src='https://grell.s3.us-east-2.amazonaws.com/pics/finishedroof.jpg'></img>
									</div>
								</div>
							</div>
						</div>
