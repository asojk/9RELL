...
<div className="absolute bg-black opacity-25 inset-10 rounded-2xl">
  ...
  <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
    ...
    <span className="tracking-[0.13rem] text-[min(8vw,1rem)] leading-loose uppercase text-yw">licensed, bonded, insured</span>
    <h1 class="text-[min(12vw,2.75rem)] font-[600] leading-[4rem] tracking-[0.01em] text-l1">
        Flat Roof Repair
      </h1>
  ...
  <section className="relative z-1 max-w-[85rem] px-4 py-4 mx-auto">
    <div className="container px-5 py-8 mx-auto rounded-2xl">
      <div className="mb-20 text-center">
        ...
        <span className="tracking-[0.13rem] text-[min(8vw,1rem)] leading-loose uppercase text-yw">Signs that it's time for a repair</span>
          <h1 class="max-w-5xl text-5xl font-bold leading-none tracking-tight text-l1 md:text-5xl lg:text-6xl lg:max-w-7xl">Notice a leak?</h1>
        </header>
  ...
  <div className="container px-5 py-24 mx-auto">
      <div className="mb-20 text-center">
      <header className="header py-6 border-y-[1px] border-b2">

        <h2 className="head">24/7 Emergency Flat Roof Repair Services</h2>
        <h1 class="max-w-5xl text-5xl font-bold leading-none tracking-tight text-l1 md:text-5xl lg:text-6xl lg:max-w-7xl">Emergency Repairs</h1>
          </header>
