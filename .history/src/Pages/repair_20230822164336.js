...
<section className="pt-12 relative bg-[url(https://grell.s3.us-east-2.amazonaws.com/pics/repair1.jpg)] bg-cover bg-center bg-no-repeat">
  <div className="absolute inset-0 bg-d7/75 sm:bg-transparent sm:from-d7/95 sm:to-d7/25 sm:bg-gradient-to-r"></div>
    <div className="relative h-screen max-w-screen-xl px-4 py-32 mx-auto sm:px-6 lg:flex lg:items-center lg:px-8">
...
<section className="relative max-w-screen-xl px-4 py-[10vh] mx-auto sm:px-6 lg:flex lg:items-center lg:px-8 h-screen">
...
<section class="panel purple h-screen">
<section ref={EmergencyRef} className="relative max-w-screen-xl px-4 py-[10vh] mx-auto sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8 h-screen">
