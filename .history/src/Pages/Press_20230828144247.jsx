	...
	return (
		<motion.div variants={SecMotion}>
			...
			<section className='relative z-1 max-w-[85rem] px-4 pt-64 mx-auto'>
				...
				<span className='mb-8 text-sm font-bold tracking-widest underline uppercase decoration-rA'> Flat Roof Specialist </span>
				<h1 className='mb-8 text-4xl font-bold leading-none tracking-tighter text-l1 md:text-7xl lg:text-5xl'>
					Your roof is our top priority.
				</h1>
				<p className='mb-8 text-base leading-relaxed text-left md:mb-24 text-l1'>
					We build, repair, and replace commercial flat roofs. We're family owned and female operated, serving 22 states in the Midwest and South since 1985.
				</p>
				</div>
