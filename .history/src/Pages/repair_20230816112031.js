  ...
  >
    ...
    <h1 class="h1">
      ...
      <div className="flex flex-wrap gap-4 mt-8 text-center">
        <a onClick={scrollToEmergency} className="block w-full px-12 py-3 text-sm font-medium text-white rounded shadow bg-rose-600 hover:bg-rose-700 focus:outline-none focus:ring active:bg-rose-500 sm:w-auto">
          Emergency?
        </a>

        <a onClick={scrollToSigns} className="block w-full px-12 py-3 text-sm font-medium bg-white rounded shadow text-rose-600 hover:text-rose-700 focus:outline-none focus:ring active:text-rose-500 sm:w-auto">
          Signs of Damage
        </a>
      </div>
    </div>
