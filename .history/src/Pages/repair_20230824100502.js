					...
					<div className='max-w-2xl text-center sm:text-left'>
						...
						<div className='flex flex-wrap gap-4 mt-8 text-center'>
							<a
								...
								className='block w-full px-12 py-3 text-sm font-medium rounded cursor-pointer shadow-nimble shadow-rd3 text-l1 bg-r hover:bg-rd2 focus:outline-none focus:ring active:bg-r sm:w-auto'>
								Emergency?
							</a>
						</div>
					</div>
			...
			<section
				...
				<div className='relative z-10 max-w-3xl px-8 pb-8 mx-auto bg-d7 shadow-nimble rounded-2xl'>
					<div className='text-center'>
						...
						<h1 class='mb-8 h2'>Emergency Repairs</h1>
						<p className='mb-8 text-base leading-relaxed text-l3'>
						...
						<div className='flex justify-center gap-8'>
							<a className='px-8 py-3 mb-4 font-medium rounded-lg text-l1 shadow-nimble bg-r hover:bg-rd2 focus:outline-none focus:ring-2 focus:ring-rd2 active:bg-rl'>
								Contact
							</a>
						</div>
					</div>
