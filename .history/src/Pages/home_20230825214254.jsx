		...
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			<img
				...
				className='flex-shrink-0 object-center mx-auto md:hidden object-fit shadow-nimble aboslute'></img>
							...
							<section className='relative pt-12 bg-center bg-no-repeat bg-cover'>
				<div className='absolute inset-0 bg-d7/75 sm:bg-transparent sm:from-d7/95 sm:to-d7/25 sm:bg-gradient-to-r'></div>
			<video className='hidden h-full md:block lg:w-screen max-h-[70vh] relative top-0' autoPlay={true} muted loop={false}>
