  ...
  >
    ...
    <h1 class="h1">
      ...
      <div className="flex flex-wrap gap-4 mt-8 text-center">
        ...
        <a onClick={scrollToSigns} className="block w-full px-12 py-3 text-sm font-medium rounded shadow-sm cursor-pointer shadow-w4 bg-d7 text-r hover:text-rd2 focus:outline-none focus:ring active:text-r sm:w-auto">
          Signs of Damage
        </a>
      </div>
    </div>
