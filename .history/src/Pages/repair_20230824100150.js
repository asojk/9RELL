				...
				<div className='max-w-3xl px-8 mx-auto bg-white shadow-lg rounded-2xl'>
					<div className='text-center'>
						...
						<div className='flex justify-center gap-8'>
							<a className='px-8 py-3 font-medium text-white rounded-lg shadow bg-r hover:bg-rd2 focus:outline-none focus:ring-2 focus:ring-blue-500 active:bg-blue-700'>
								Contact
							</a>
						</div>
					</div>
