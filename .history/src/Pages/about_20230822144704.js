    ...
    <section className="">
      <div className="container px-6 py-10 mx-auto">
        ...
        <div aria-label="card-overlay" className="relative w-[250px] h-[300px]">
          ...
          />
          <div className="absolute flex flex-col p-2 rounded bg-d7 text-l1 bottom-5 left-5 right-5 gap-y-1">
        ...
        <div
          className="bg-d7 w-[250px] rounded-xl shadow-nimble"
        ...
        >
          ...
          <div className="flex flex-col flex-1 p-5">
            <div className="pb-5 mb-5 border-b border-w3">
              <h3 className="mb-1 text-lg font-bold text-l1">The grand resort</h3>
              <span className="text-sm">Karineside</span>
            </div>
            <div className="flex items-center justify-between w-full ml-auto">
              <div className="text-sm text-l1">Tue, Jul 20</div>
