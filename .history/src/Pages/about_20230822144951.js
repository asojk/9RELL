      ...
      <div className="container px-6 py-10 pt-32 mx-auto md:pt-44">
        <div className="mb-8 text-center">
          ...
          <p className="pt-4 pb-12 mx-auto text-base leading-relaxed text-left text-l1 lg:w-3/4">
            ...
            application, Grell Roofing has served the commercial and industrial
            roofing needs of Iowa and the Upper Midwest. We are a family-owned
            firm with an outstanding reputation for workmanship, quality, and
            customer support. Additionally, all Duro-Last roofing is
            manufactured and created in the state of Iowa. Grell Roofing LLC is
            fully licensed, bonded and insured. We take the responsibility of
            safety and quality seriously. We are proud to say we have been a
            Duro-Last Elite Contractor for over 15 years.
          </p>
    ...
    <section className="">
      <div className="container px-6 py-10 mx-auto">
        ...
        >
          ...
          />
          <div className="absolute bottom-0 left-0 right-0 flex flex-col p-5 text-l1 gap-y-1 bg-gradient-to-t from-b3">
        ...
        <div aria-label="card-horizontal" className="flex items-center gap-x-5">
          ...
          <div className="flex flex-col flex-1 gap-y-1">
            <h3 className="text-base font-bold text-black">Miami</h3>
            <span className="text-sm text-gray-400">3 Hour drive</span>
          </div>
        </div>

        <div className="flex items-center gap-x-5" aria-label="simple-counter-v2">
          <button className="flex items-center justify-center w-8 h-8 p-1 text-white bg-blue-500 rounded-full">
            <svg
          ...
          <input
            ...
            value={10}
            type="text"
            className="w-16 h-16 text-xl font-bold text-center bg-white border rounded-lg outline-none border-slate-200 focus:border-blue-500"
          />
          <button className="flex items-center justify-center w-8 h-8 p-1 text-white bg-blue-500 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
          <div className="flex flex-col items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-d7 rounded-xl">
            ...
            <h1 className="mt-4 text-2xl font-semibold capitalize text-l1 group-hover:text-l1">
              arthur melo
            </h1>

            <p className="mt-2 capitalize text-l3 group-hover:text-r">
              design director
            </p>
            ...
            <div className="flex mt-3 -mx-2">
              <a
                href="#"
                className="mx-2 text-l5 hover:text-l3 group-hover:text-l1"
                aria-label="Reddit"
              >
                <svg
