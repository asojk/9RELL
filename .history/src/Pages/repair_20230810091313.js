    ...
    <div class=" flex flex-col items-center px-5 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col w-full max-w-3xl mx-auto prose text-left prose-blue">
            <div class="w-full mx-auto">
                ...
                <p>Whether from faulty installation, storm damage, or simply an outdated
      ...
      <li>Pooling water</li>
        ...
        <li>Roof or ceiling leaks</li>
                ...
                <p>If you are experiencing any of the issues above or even another type of
      problem with your flat roof, contact us today for a free inspection.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class=" flex flex-col items-center px-5 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col w-full max-w-3xl mx-auto prose text-left prose-blue">
            <div class="w-full mx-auto">
                ...
                <p>At Grell, we always strive to serve our customers as quickly and
      ...
      immediate assistance, call today.</p>
            </div>
        </div>
    </div>
</section>
