...
<div className="relative max-w-screen-xl px-4 py-[10vh] mx-auto sm:px-6 lg:flex lg:items-center lg:px-8">
  <section className="relative z-1 max-w-[85rem] px-4 mx-auto">
    <div className="container px-5 mx-auto rounded-2xl">
      ...
      <p class="leading-relaxed text-base text-l3">No matter which type of Duro-Last product you select for your flat roof, we can guarantee you will be satisfied with the end result. Contact us today to get a free estimate on your flat roof installation.</p>
