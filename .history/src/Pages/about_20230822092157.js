...
const About = () => (
  <><section className="relative z-1 max-w-[85rem] px-4 mx-auto">
      <div className="container px-5 pt-32 mx-auto md:pt-44 rounded-2xl">
        <div className="mb-8 text-center">
          <header className="header">
            <span className="head">Commercial Roofing Pros</span>
            <h1 class="h2">About Grell</h1>
          </header>
          <p className="py-4 mx-auto text-base leading-relaxed text-left lg:w-3/4">
          ...
          <span className="text-left head">What we do</span>
