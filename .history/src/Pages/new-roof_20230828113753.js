...
const NewRoof = () => {
  ...
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong>Pros:</strong> Sloped roofs have better drainage and less debris build-up than a flat roof, which means less need for maintenance visits.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong>Cons:</strong> Commercial roofing systems with slopes could be hazardous depending on the incline of the pitch. Even though you’ll need less maintenance, it can be more difficult for commercial roofing contractors to safely work on the roof, making it more expensive to perform routine maintenance.
  </p>
  ...
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong>Built-Up Roofing Systems (BUR):</strong> One of the most common types of commercial roofs are BUR systems. They use alternating layers of reinforcing fabric and asphalt, then have a gravel or stone layer on top. This multiple layer system can provide additional protection for your commercial roof and typically this type of commercial roof will last between 15-20 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong>Modified Bitumen (MB):</strong> This is an asphalt-based commercial roofing material made for flat and low-slope roofs. This type of commercial roof is quite durable due to its multiple layers and can withstand a wide variety of temperatures. MB roofs have a lifespan of approximately 20 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong>Polyvinyl Chloride (PVC):</strong> PVC is a classic flat commercial roofing material with a vinyl membrane. It is UV-resistant and will last well over 25 years, but this type of roof is more expensive than other options.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong>Ethylene Propylene Diene Monomer (EPDM):</strong> This option is made of synthetic rubber materials, and it is usually easy for commercial roofing contractors to apply but is not the most attractive type of commercial roof. EPDM is a great affordable option that will last approximately 25-30 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong>Metal:</strong> Whether you’re interested in a metal roof for a commercial or residential property, its durability depends on the thickness of the material. Thick and sturdy metals will be more expensive, but those types of roofs on commercial buildings can last over 50 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong>Spray Foam:</strong> Similar to metal roofs, this commercial roof type’s life expectancy is determined by the thickness of the foam. Spray foam commercial roofing systems can also last longer if recoating maintenance is performed. Spray foam roofing is energy efficient and easy to install, but requires specific weather conditions for installation, so it can be hard to find an ideal time. An investment in a spray foam commercial roof should last well over 50 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
