...
<div className="max-w-2xl pt-32 mx-auto lg:max-w-6xl">
  ...
  <div className="row-span-2">
      ...
      <div className="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
        ...
        <RepairServices RepairCheck="Duro-Last" />
        <RepairServices RepairCheck="TPO, EPDM % PVC" />
        <RepairServices RepairCheck="Metal, Modified Bitumen & Built-Up" />
        <RepairServices RepairCheck="Coating, Deck & Flashing" />
        <RepairServices RepairCheck="Drain, Vent & Insulation" />
