...
<section className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="max-w-2xl mx-auto lg:max-w-6xl">
    <div className="relative grid grid-cols-2 grid-rows-2 gap-4 px-12 py-12 pt-32 bg-d7 rounded-2xl z-1 text-l1 body-font">
      <div className="row-span-2">
        <span className="h4">licensed, bonded, insured</span>
        <h1 className="h1">Flat Roof Repair</h1>
      </div>
      <p className="px-4 pt-4 mx-auto mb-8 text-base leading-relaxed lg:w-3/4">Over the past 30 years, Grell built a reputation throughout the Midwest for quality, affordable flat roof repairs for buildings of all sizes. We will also work with your insurance company to make sure the process goes as smoothly as possible.</p>
    </div>
  </div>
</section>
