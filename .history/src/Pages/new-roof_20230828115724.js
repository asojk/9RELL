...
const NewRoof = () => {
			...
			<section className='pt-12 relative bg-[url(https://grell.s3.us-east-2.amazonaws.com/pics/finishedroof.jpg)] bg-cover bg-center bg-no-repeat'>
				...
				<div className='relative max-w-screen-xl px-4 py-32 mx-auto sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8'>
					<div className='max-w-2xl text-center sm:text-left'>
						...
						<h1 className='mb-8 text-4xl font-bold leading-none tracking-tighter text-l1 md:text-7xl lg:text-5xl'>New Construction</h1>
			...
			<div className='relative max-w-screen-xl px-4 py-[10vh] mx-auto sm:px-6 lg:flex lg:items-center lg:px-8'>
				<section className='relative z-1 max-w-[85rem] px-4 mx-auto'>
					<div className='z-20 max-w-2xl text-center sm:text-left'>
						<h1 className='mb-8 text-4xl font-bold leading-none tracking-tighter text-l1 md:text-7xl lg:text-5xl'>Choosing The Right Commercial Roof Type</h1>
						<p className='max-w-lg pb-12 mt-4 lg:pb-24 sm:text-xl/relaxed text-l3'>Whether you are making updates to commercial buildings or have new builds in the works, the type of commercial roof you choose can have a big impact on long-term costs. Learn about the best types of{' '}<a>commercial roofing</a>{' '} materials and the pros & cons of each.</p>
						<h2 className="mt-16 mb-12 text-2xl font-bold text-white md:text-4xl">Commercial Roof Types: Comparison Between Flat or Sloped</h2>
  ...
  <p className='mb-8 text-base leading-relaxed text-l3'>
    Flat roofs are by far the preferred type of roofs on commercial buildings because they are more cost-effective than a sloped roof. Additionally, the size of most commercial buildings would make a pitched roof dangerous or inefficient. Here are some more things to consider when choosing a flat type of roof on a commercial building:
        ...
        <div
          class="flex w-full justify-center text-l1 md:justify-start">
                <p className="w-full"><strong className="font-black">Pros:</strong></p>
  ...
  <p className='mt-8 mb-2 text-base leading-relaxed text-l3'>
    <strong className="font-black">Cons:</strong>
  </p>
  <ul className="text-base italic text-l1">
  ...
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-black">Pros:</strong> Sloped roofs have better drainage and less debris build-up than a flat roof, which means less need for maintenance visits.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-black">Cons:</strong> Commercial roofing systems with slopes could be hazardous depending on the incline of the pitch. Even though you’ll need less maintenance, it can be more difficult for commercial roofing contractors to safely work on the roof, making it more expensive to perform routine maintenance.
  </p>
  <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Choosing Your Commercial Roofing Materials</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <h3 className='mt-4 mb-4 text-lg font-medium text-r md:text-xl'>What is the best commercial roofing material?</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-black">Thermoplastic Polyolefin (TPO):</strong> The most cost effective option is a single-ply TPO roofing material. This commercial roofing system has strong seams to avoid water leaks but is not as flexible as other materials and seams can wear out in excessive heat. These flat roofs will need to be replaced about every 10-20 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-black">Built-Up Roofing Systems (BUR):</strong> One of the most common types of commercial roofs are BUR systems. They use alternating layers of reinforcing fabric and asphalt, then have a gravel or stone layer on top. This multiple layer system can provide additional protection for your commercial roof and typically this type of commercial roof will last between 15-20 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-black">Modified Bitumen (MB):</strong> This is an asphalt-based commercial roofing material made for flat and low-slope roofs. This type of commercial roof is quite durable due to its multiple layers and can withstand a wide variety of temperatures. MB roofs have a lifespan of approximately 20 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-black">Polyvinyl Chloride (PVC):</strong> PVC is a classic flat commercial roofing material with a vinyl membrane. It is UV-resistant and will last well over 25 years, but this type of roof is more expensive than other options.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-black">Ethylene Propylene Diene Monomer (EPDM):</strong> This option is made of synthetic rubber materials, and it is usually easy for commercial roofing contractors to apply but is not the most attractive type of commercial roof. EPDM is a great affordable option that will last approximately 25-30 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-black">Metal:</strong> Whether you’re interested in a metal roof for a commercial or residential property, its durability depends on the thickness of the material. Thick and sturdy metals will be more expensive, but those types of roofs on commercial buildings can last over 50 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-black">Spray Foam:</strong> Similar to metal roofs, this commercial roof type’s life expectancy is determined by the thickness of the foam. Spray foam commercial roofing systems can also last longer if recoating maintenance is performed. Spray foam roofing is energy efficient and easy to install, but requires specific weather conditions for installation, so it can be hard to find an ideal time. An investment in a spray foam commercial roof should last well over 50 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
 ...
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Choosing a Commercial Roofing System</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    There are factors to consider when choosing the type of commercial roofing system you’ll need for your business. You need to consider the type of facility you are working with as well since different types of businesses require specific planning. Becoming familiar with the types of commercial roofing systems that are available will help in your decision-making process.
  </p>
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Shape of Commercial Roofs</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    With commercial roofing systems, addressing the slope of the roof is important. Roofs are classified as Low Slope Roofs (or Flat Roofs) and Steep Slope Roofs. Low Slope Roofs: These roofing systems are common among warehouses, big box stores, and shopping centers. With this roofing system, there are several options for flat roofs including EPDM, PVC, and TPO. .. Steep Slope Roofs: These roofing systems are more commonly seen on single and multi-family homes than they are on commercial properties. With this roofing system, popular roof materials include metal, shingles, slate or tile.
  </p>
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Types of Commercial Roofing Systems</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <h3 className='mt-4 mb-4 text-lg font-medium text-r md:text-xl'> EPDM Roofing (Ethylene Propylene Diene Monomer)</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
 ...
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Modified Bitumen Roofing Systems</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
 ...
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Built-Up Roofing Systems</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
 ...
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Liquid Applied Roofing</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
 ...
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Green Roofs</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    Green roofs are not suitable for every space. But when in place, they can help to reduce energy costs with natural insulation, create enjoyable spaces for people and animals, and absorb stormwater, arguably lessening the need for complex and expensive drainage systems. Green roofs, in general, improve air quality and help reduce the Urban Heat Island Effect. Nations Roof® has installed many green or vegetative roofing systems across the country.
  </p>
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Photovoltaic (PV) Solar Panels</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
 ...
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">Insulation & Cover Boards</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
 ...
 <h2 className="mt-16 mb-12 text-2xl font-bold text-center text-white md:text-4xl">The Less-Than-10-Percent Group</h2>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    Liquid Applied and Spray Foam Roofing Systems - low permeability and require uniform thickness
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>Metal Roofing Systems - typically a much larger upfront investment</p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    Vegetative Roof Systems - with a membrane system base, can effectively provide an advantageous means for storm water control
  </p>
