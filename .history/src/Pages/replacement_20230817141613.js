...
const ReplacePoints = ({Points}) => (
  ...
  <div className="flex items-center">
    ...
    <span className="text-l3">{Points}</span>
  </div>
</div>
);
    ...
    <div className="container px-5 mx-auto rounded-2xl">
      <div className="mb-8 text-center">
        ...
        <h1 class="h2">Duro-Last Elite Contractor</h1>
          ...
          <p class="leading-relaxed text-left text-base">
          As a Duro-Last Elite Contractor, you can rest assured that you are not only getting the highest quality flat roofing but also excellent service and reliable installation that will last for years to come. </p>
      ...
      <div className="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
        <ReplacePoints Points="Less on-site seaming during installation, which minimizes problems and enables us to install quicker, saving you time and money"/>
        <ReplacePoints Points="A significant reduction in the potential for installation issues and future leak problems"/>
        <ReplacePoints Points="A reduction in waste, both during manufacturing and during installation"/>
        <ReplacePoints Points="More secure installation at critical roof transitions"/>
      </div>
    ...
    <div className="container px-5 mx-auto rounded-2xl">
      <div className="mb-8 text-center">
        <header className="header">
          ...
          <p class="leading-relaxed text-left text-base">It can be hard to know when it is time to get a new flat roof, and certainly, it can be quite an investment. What is even more costly, though, is not replacing a damaged roof which can lead to further issues and even more expenses. If you experience any of the signs below, it may be time to schedule your flat roof replacement:</p>
      </div>
      <div className="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
        <ReplaceSigns Signs="Water stains on the ceiling"/>
        <ReplaceSigns Signs="Multiple roof holes"/>
        <ReplaceSigns Signs="Leaking ceiling"/>
        <ReplaceSigns Signs="Torn vapor barrier"/>
        <ReplaceSigns Signs="Missing pieces of roof"/>
        <ReplaceSigns Signs="Pooling water"/>
        <ReplaceSigns Signs="Cracked roof membrane"/>
        <ReplaceSigns Signs="Bubbling roof membrane"/>
        <ReplaceSigns Signs="Sagging roof"/>
        <ReplaceSigns Signs="Mold or mildew"/>
        <ReplaceSigns Signs="Rusted flashing"/>
        <ReplaceSigns Signs="Damaged roof insulation"/>
        <ReplaceSigns Signs="Damaged roof deck"/>
        <ReplaceSigns Signs="Damaged roof membrane"/>
      </div>
      <p class="leading-relaxed text-base">The only way to be sure if your roof is still in good shape is to hire a professional. Contact Grell today for a free roofing inspection to see if a roof replacement is the next step for maintaining your building.</p>
    </div>
  </section>
</div>
