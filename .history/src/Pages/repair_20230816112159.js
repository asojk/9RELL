  ...
  >
    ...
    <h1 class="h1">
      ...
      <div className="flex flex-wrap gap-4 mt-8 text-center">
        <a onClick={scrollToEmergency} className="block w-full px-12 py-3 text-sm font-medium rounded shadow text-l1 bg-r hover:bg-rd2 focus:outline-none focus:ring active:bg-r sm:w-auto">
          Emergency?
        </a>
