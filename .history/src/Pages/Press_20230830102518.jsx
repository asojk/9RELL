			...
			<div class='pb-12'>
				<div class='xl:container m-auto px-6 text-gray-600 md:px-12 xl:px-6'>
					...
					<div class='grid gap-8 md:grid-cols-2 lg:grid-cols-3'>
						<Involvements img='https://grell.s3.us-east-2.amazonaws.com/Press/ice-cream.jpg' title='Human Services' subtitle='including food banks, homeless services, social services, and youth development' />
						...
						<Involvements img='https://grell.s3.us-east-2.amazonaws.com/Press/ice-cream.jpg' title='Health' subtitle='local hospitals ands clinics, medical research, and patient and family support charities' />
						<div class='group p-6 sm:p-8 rounded-3xl bg-transparent border border-transparent hover:border-d3 hover:bg-d7/70 shadow-transparent hover:shadow-nimbl'>
</div>
						<div class='group p-6 sm:p-8 rounded-3xl bg-transparent border border-transparent hover:border-d3 hover:bg-d7/70 shadow-transparent hover:shadow-nimbl'>
							<div class='relative overflow-hidden rounded-xl'>
