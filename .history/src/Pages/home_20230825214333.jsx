	...
	return (
		<motion.div variants={content} animate='animate' initial='initial'>
			...
			<section className='relative bg-center bg-no-repeat bg-cover'>
				<video
					className='hidden h-full md:block lg:w-screen max-h-[70vh] relative top-0'
					autoPlay={true}
					muted
					loop={false}>
				...
				<div className='absolute inset-0 bg-d7 sm:bg-transparent sm:from-d7/95 sm:to-d7/25 sm:bg-gradient-to-r'></div>
			</section>
