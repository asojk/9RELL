  ...
  <div className="container px-5 mx-auto rounded-2xl">
    <div className="mb-8 text-center">
      ...
      <h1 class="h2">Commercial repair services</h1>
            ...
            <p className="pt-4 mx-auto text-base leading-relaxed lg:w-3/4">As part of our maintenance program, you will receive a free basic preventative maintenance inspection every year to ensure your roof is performing as it should. When one of our technicians arrives at your property for an inspection, you can expect them to do the following:</p>
        <div className="flex flex-wrap pt-4 pb-4">
        ...
        <p className="pt-4 mx-auto text-base leading-relaxed lg:w-3/4">Without any effort on your end, a yearly flat roof inspection will allow you to be proactive instead of reactive when it comes to protecting your business.</p>
        </div>
  </div>
</section>
</div>
