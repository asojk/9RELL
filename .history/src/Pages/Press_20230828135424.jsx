				...
				<div className='container px-6 py-10 pt-32 mx-auto md:pt-44'>
					...
					<Container my='md'>
						<SimpleGrid cols={4} breakpoints={[{ maxWidth: 'xs', cols: 1 }]}>
							<img src='image1.jpg' alt='Image 1' style={{ height: `${BASE_HEIGHT}px` }} />
							<Stack>
								<img src='image2.jpg' alt='Image 2' style={{ height: `${getSubHeight(2, px(theme.spacing.md))}px` }} />
								<img src='image3.jpg' alt='Image 3' style={{ height: `${getSubHeight(2, px(theme.spacing.md))}px` }} />
							</Stack>
							<Stack>
								<img src='image4.jpg' alt='Image 4' style={{ height: `${getSubHeight(3, px(theme.spacing.md))}px` }} />
								<img src='image5.jpg' alt='Image 5' style={{ height: `${getSubHeight(3, px(theme.spacing.md))}px` }} />
