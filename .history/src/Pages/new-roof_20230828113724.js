...
const NewRoof = () => {
  ...
  <h3 className='mb-4 text-lg font-bold text-r md:text-xl'>Flat Commercial Roofing Systems</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <h3 className='mb-4 text-lg font-bold text-r md:text-xl'>Sloped Commercial Roofs</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <h3 className='mb-4 text-lg font-bold text-r md:text-xl'>What is the best commercial roofing material?</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <h3 className='mb-4 text-lg font-bold text-r md:text-xl'>What are commercial roofs made of?</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
