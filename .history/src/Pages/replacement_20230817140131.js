...
<div className="relative max-w-screen-xl px-4 py-32 mx-auto sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
  <section className="relative z-1 max-w-[85rem] px-4 mx-auto">
    <div className="container px-5 mx-auto rounded-2xl">
      ...
      <div className="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
        <ReplaceSigns Signs="Pooling water on the roof"/>
        <ReplaceSigns Signs="Water stains on the ceiling or around windows"/>
        <ReplaceSigns Signs="Flashing separation"/>
        <ReplaceSigns Signs="Cracks in coating"/>
        <ReplaceSigns Signs="Rips, cracks or bubbles in the roof membrane"/>
        <ReplaceSigns Signs="Loose or missing fasteners, flashing or caulking"/>
      </div>
    </div>
  </section>
</div>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="mb-20 text-center">
        ...
        <p className="mx-auto text-base leading-relaxed lg:w-3/4"> If your commercial property needs a new flat roof, let the experts at Grell Roofing take care of you. 
