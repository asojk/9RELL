...
<div className="relative max-w-2xl mx-auto mt-32 lg:max-w-6xl rounded-2xl z-1">
  ...
  <section className="pt-32 text-l1 body-font max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 lg:py-8 mx-auto">
    <div className="relative max-w-2xl mx-auto mt-32 lg:max-w-6xl z-1 bg-d7 rounded-2xl">
      <div className="grid grid-cols-[2fr,4fr]">
        <h3 className="pt-8 pb-4 pl-12 h4">Our Repair Services</h3>
        <p className="pt-8 pb-8 pl-4 text-[1.2rem]">We ensure proper draining and flashings throughout all of our repairs.</p>
        </div>
