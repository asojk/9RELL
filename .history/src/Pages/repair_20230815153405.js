...
<div className="relative max-w-2xl mx-auto mt-36 lg:mt-56 lg:max-w-6xl rounded-2xl z-1">
  <img className="object-cover object-center w-full rounded-2xl" alt="hero" src="https://images.unsplash.com/photo-1581093458791-9a9f1e9e9b7b?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8ZmxhdCUyMHJvb2Z8ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80" />
  ...
  <section className="relative z-1 max-w-[85rem] px-4 py-4 mx-auto">
    <div className="container px-5 py-8 mx-auto lg:bg-d7 rounded-2xl">
