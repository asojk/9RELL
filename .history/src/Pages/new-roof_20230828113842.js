...
const NewRoof = () => {
			...
			<div className='relative max-w-screen-xl px-4 py-[10vh] mx-auto sm:px-6 lg:flex lg:items-center lg:px-8'>
				<section className='relative z-1 max-w-[85rem] px-4 mx-auto'>
					<div className='z-20 max-w-2xl text-center sm:text-left'>
						...
						<h2 className="mb-12 text-2xl font-bold text-center text-white md:text-4xl">Commercial Roof Types: Comparison Between Flat or Sloped</h2>
  ...
  <h3 className='mb-4 text-lg font-medium text-r md:text-xl'>Flat Commercial Roofing Systems</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-bold text-r">Pros:</strong>
  </p>
  <ul>
    <li>
  ...
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-bold text-r">Cons:</strong>
  </p>
  <ul>
    <li>
  ...
  <h3 className='mb-4 text-lg font-medium text-r md:text-xl'>Sloped Commercial Roofs</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <h3 className='mb-4 text-lg font-medium text-r md:text-xl'>What is the best commercial roofing material?</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <h3 className='mb-4 text-lg font-medium text-r md:text-xl'>What are commercial roofs made of?</h3>
  <p className='mb-8 text-base leading-relaxed text-l3'>
  ...
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-bold text-r">Thermoplastic Polyolefin (TPO):</strong> The most cost effective option is a single-ply TPO roofing material. This commercial roofing system has strong seams to avoid water leaks but is not as flexible as other materials and seams can wear out in excessive heat. These flat roofs will need to be replaced about every 10-20 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-bold text-r">Built-Up Roofing Systems (BUR):</strong> One of the most common types of commercial roofs are BUR systems. They use alternating layers of reinforcing fabric and asphalt, then have a gravel or stone layer on top. This multiple layer system can provide additional protection for your commercial roof and typically this type of commercial roof will last between 15-20 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-bold text-r">Modified Bitumen (MB):</strong> This is an asphalt-based commercial roofing material made for flat and low-slope roofs. This type of commercial roof is quite durable due to its multiple layers and can withstand a wide variety of temperatures. MB roofs have a lifespan of approximately 20 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-bold text-r">Polyvinyl Chloride (PVC):</strong> PVC is a classic flat commercial roofing material with a vinyl membrane. It is UV-resistant and will last well over 25 years, but this type of roof is more expensive than other options.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-bold text-r">Ethylene Propylene Diene Monomer (EPDM):</strong> This option is made of synthetic rubber materials, and it is usually easy for commercial roofing contractors to apply but is not the most attractive type of commercial roof. EPDM is a great affordable option that will last approximately 25-30 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-bold text-r">Metal:</strong> Whether you’re interested in a metal roof for a commercial or residential property, its durability depends on the thickness of the material. Thick and sturdy metals will be more expensive, but those types of roofs on commercial buildings can last over 50 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
    <strong className="font-bold text-r">Spray Foam:</strong> Similar to metal roofs, this commercial roof type’s life expectancy is determined by the thickness of the foam. Spray foam commercial roofing systems can also last longer if recoating maintenance is performed. Spray foam roofing is energy efficient and easy to install, but requires specific weather conditions for installation, so it can be hard to find an ideal time. An investment in a spray foam commercial roof should last well over 50 years.
  </p>
  <p className='mb-8 text-base leading-relaxed text-l3'>
