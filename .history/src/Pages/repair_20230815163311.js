...
<section>
  <div class="px-4 pt-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:pt-24">
    <div class="flex flex-col w-full mb-12 text-center mt-32 lg:mt-48">
      <h1 class="max-w-5xl text-2xl font-bold leading-none tracking-tighter text-l1 md:text-5xl lg:text-6xl lg:max-w-7xl">
        Flat Roof Repair
      </h1>
      <p class="max-w-xl mx-auto mt-8 text-base leading-relaxed text-center text-l3">Over the past 30 years, Grell built a reputation throughout the Midwest for quality, affordable flat roof repairs for buildings of all sizes. <br></br><br></br>We will work with your insurance company to make sure the process goes as smoothly as possible.</p>
    </div>
  </div>
</section>
