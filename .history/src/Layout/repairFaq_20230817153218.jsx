  ...
  return (
    ...
    >
      <motion.div
        ...
        className="p-4 rounded-[7px] bg-d7/20 flex flex-col justify-between relative z-10 text-l1"
      >
        <div>
          <motion.p
            initial={false}
      ...
      <motion.div
        ...
        className="absolute inset-0 z-1 bg-gradient-to-r from-b3/50 to-d5/50"
      />
