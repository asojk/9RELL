        ...
        {/* Grid */}
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
                    <div className="relative mb-2 list-none group">
                      <label 
                      htmlFor="Username"
                        className="relative block border rounded-md shadow-sm bg-d7 focus-within:border-y1 focus-within:ring-1 focus-within:ring-y1">
                        <input
                        id="Username"
                          type="text"
                          name="user_name"
                          required
                          className="placeholder-transparent bg-transparent border-b border-none outline-none border-l5 text-l1 peer focus:border-transparent focus:outline-none focus:ring-0"
                          autoComplete="name"
                          placeholder="Name"
                          value={name}
                    ...
                    <label 
                      htmlFor="Email"
                        className="relative block border rounded-md shadow-sm dark:bg-d7 bg-d7 focus-within:border-y1 focus-within:ring-1 focus-within:ring-y1">
                        <input
                        id="Email"
                          type="email"
                          name="user_email"
                          required
                          autoComplete="email"
                          className="placeholder-transparent bg-transparent border-b border-none outline-none border-l5 text-l1 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                          placeholder="Email"
                          value={email}
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
                    <div className="relative py-4 mb-2 text-base list-none rounded-lg group">
                    <label 
                      htmlFor="Telephone"
                        ...
                        id="Telephone"
                          ...
                          required
                          placeholder="Phone"
                          className="text-base placeholder-transparent bg-transparent border-b border-l5 text-l1 peer"
                          autoComplete="tel"
                          value={phone}
                          onChange={(e) => setPhone(e.target.value)}
                        />
                        <span className="pointer-events-none absolute start-2.5 top-0 -translate-y-1/2 p-0.5 text-sm text-l3 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-0 peer-focus:text-xs">
                          Phone
                        </span>
                      </label>
                      </div>
                    ...
                    <div className="relative mb-2 list-none group">
                      <li className="py-2 pt-6 text-center rounded-lg text-l1">
                        <ReactDatePicker
                          selected={date}
