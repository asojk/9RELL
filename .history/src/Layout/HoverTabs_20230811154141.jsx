  ...
  return (
    <div className="relative w-full">
      <button
        ...
        className="relative z-0 flex flex-row items-center justify-center w-full gap-4 p-6 transition-colors border-b-4 border-rd2 bg-d7 hover:bg-d6 md:flex-col"
      >
        <span
