                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="relative px-4 py-8 text-base rounded-lg group">
                      <ReactDatePicker
                        ...
                        className="bg-transparent border-b outline-none cursor-pointer btn placeholder-l3 border-l5 text-l1 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                      />
                  </div>
                </div>
