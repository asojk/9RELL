  ...
  return (
    ...
    >
      <motion.div
        ...
        className="p-6 rounded-[7px] bg-d7 flex flex-col justify-between relative z-10 text-w4"
      >
        <div>
          <motion.p
            initial={false}
            ...
            className="text-lg font-bold w-fit bg-gradient-to-b from-r to-rA bg-clip-text"
          >
            {title}
          </motion.p>
          <motion.p
