                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="col-1">
                    ...
                    <select
                      ...
                      required
                      className="w-[80%] p-3 rounded-xl bg-transparent outline-none cursor-pointer btn placeholder-l3 border-l5 text-l1 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                      value={buildingType}
