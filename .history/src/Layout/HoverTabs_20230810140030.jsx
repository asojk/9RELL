  ...
  return (
    <div className="relative w-full">
      <button
        ...
        className="relative z-0 flex flex-row items-center justify-center w-full gap-4 p-6 transition-colors bg-white border-b-4 border-slate-200 hover:bg-slate-100 md:flex-col"
      >
        <span
