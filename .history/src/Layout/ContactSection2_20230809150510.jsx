            ...
            <div className="flex flex-col p-4 rounded-2xl sm:p-6 lg:p-8">
              <form ref={form} onSubmit={sendEmail} className="">
                ...
                <div className="relative z-0 w-full mb-6 group">
                    ...
                    />
                    <label htmlFor="floating_notes" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-y2 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Notes</label>
                </div>
