      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        {/* Grid */}
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
                    ...
                    <label 
                      htmlFor="Telephone"
                        className="relative block mb-2 rounded-md shadow-sm bg-d7">
                        <input
                        id="Telephone"
                          type="tel"
                          name="user_phone"
                          required
                          placeholder="Phone"
                          className="placeholder-transparent bg-transparent border-b border-l5 text-l1 peer focus:border-transparent focus:outline-none focus:ring-0"
                          autoComplete="tel"
                          value={phone}
