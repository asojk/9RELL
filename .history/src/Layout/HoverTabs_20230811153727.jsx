  ...
  return (
    <div className="relative w-full">
      <button
        ...
        className="relative z-0 flex flex-row items-center justify-center w-full gap-4 p-6 transition-colors border-b-4 border-b2 bg-b5 hover:bg-b3 md:flex-col"
      >
        <span
      ...
      {selected && (
        <motion.span
          ...
          className="absolute bottom-0 left-0 right-0 z-10 h-1 bg-b5"
        />
      )}
    </div>
  );
