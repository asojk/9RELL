      ...
      <SectionWrapper className="pb-0">
        <div className="container mx-auto my-24 md:px-6">
          <section className="mb-32">
            <h2 className="mb-16 text-2xl font-bold text-center text-white">
              Latest articles
            </h2>
            <div className="flex flex-wrap mb-16">
              <div className="w-full mb-6 shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
                <div
                  className="ripple relative overflow-hidden rounded-lg bg-cover bg-[50%] bg-no-repeat shadow-lg shadow-black/20"
                  data-te-ripple-init=""
