          ...
          <div className="grid items-center gap-6 mt-12 lg:grid-cols-2 lg:gap-16 bg-d7 rounded-2xl">
            ...
            <div className="flex flex-col p-4 rounded-2xl sm:p-6 lg:p-8">
              <form ref={form} onSubmit={sendEmail} className="">
                ...
                <div className="relative px-4 rounded-lg group">
                  <label
                    htmlFor="Notes"
                    className="relative block rounded-md shadow-sm bg-d7"
                  >
                    <input
                      id="Notes"
                      type="text"
                    ...
                    />
                    <span className="pointer-events-none absolute start-1 top-0 -translate-y-3/4 p-0.5 text-base text-l3 transition-all peer-placeholder-shown:top-1/4 peer-placeholder-shown:text-sm peer-focus:top-0 peer-active:text-xs peer-focus:text-xs peer-visited:text-xs">
                      Anything else?
                    </span>
                  </label>
                </div></div>
