  ...
  return (
    <div className="relative w-full">
      <button
        ...
        className="relative z-0 flex flex-row items-center justify-center w-full gap-8 p-6 transition-colors border-b-4 rounded-2xl border-rd3 bg-d7 hover:bg-d6 md:flex-col"
      >
        <span
      ...
      {selected && (
        <motion.span
          ...
          className="absolute bottom-0 left-0 right-0 z-10 h-1 bg-r"
        />
      )}
    </div>
  );
...
const ExampleFeature = ({ Icon }) => (
  <div className="w-full px-0 py-8 md:px-8">
    <div className="relative w-full shadow-xl h-96 rounded-xl bg-d7 shadow-d7">
