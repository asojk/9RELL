    ...
    <>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl mx-auto lg:max-w-5xl">
          ...
          <div className="items-center mt-12 bg-d7 rounded-2xl">
            {/* Card */}
            <div className="p-4 rounded-2xl sm:p-6 lg:p-8">
              <form
                ref={form}
                onSubmit={sendEmail}
                className="">
        {/* Grid */}
            ...
            <div className="relative px-4 py-8 text-base list-none rounded-lg group">
                      <label 
                      htmlFor="Username"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="relative list-none group">
