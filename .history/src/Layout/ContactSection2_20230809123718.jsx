...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="max-w-2xl mx-auto lg:max-w-5xl">
    ...
    <div className="grid items-center gap-6 mt-12 lg:grid-cols-2 lg:gap-16 bg-d9">
      { /* Card */ }
      <div className="flex flex-col p-4 border border-gray-700 rounded-xl sm:p-6 lg:p-8">
        ...
        <form>
          <div className="grid gap-4">
            ...
            <div>
              ...
              <input type="email" name="hs-email-contacts-1" id="hs-email-contacts-1" autoComplete="email" className="block w-full px-4 py-3 text-sm border-gray-200 rounded-md focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Email" />
            </div>
            ...
            <div>
              ...
              <textarea id="hs-about-contacts-1" name="hs-about-contacts-1" rows={4} className="block w-full px-4 py-3 text-sm border-gray-200 rounded-md focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Details" />
            </div>
          </div>
          { /* End Grid */ }
