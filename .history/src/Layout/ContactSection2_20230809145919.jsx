      ...
      <label htmlFor="floating_email" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email address</label>
                ...
                <div className="relative w-full px-4 group">
                    <input
                      ...
                      type="text"
                      name="user_notes"
                      className="border-l5 text-l1 bg-d7 block py-2.5 px-0 w-full text-sm text-l1 bg-transparent border-0 border-b-2 appearance-none peer focus:border-transparent focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                      value={notes}
