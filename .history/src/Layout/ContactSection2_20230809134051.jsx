            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
                    <div className="relative mb-2 list-none group">
                      ...
                      htmlFor="Username"
                        ...
                        />
                        <span className="pointer-events-none bg-d7 absolute start-2.5 top-0 -translate-y-1/2 p-0.5 text-xs text-l3 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-0 peer-focus:text-xs">
                          Name
                        </span>
                      </label>
                      </div>
