      ...
      >
        <div>
          <motion.p
            ...
            className="text-lg font-bold w-fit bg-gradient-to-r from-rA to-rd2 bg-clip-text"
          >
            {title}
          </motion.p>
          <motion.p
            ...
            className="mt-4 text-base text-l1 bg-gradient-to-r from-rA to-rd2 bg-clip-text"
          >
            {description}
          </motion.p>
        </div>
