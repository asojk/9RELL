  ...
  return (
    <div className="relative w-full my-10 lg:my-16">
      <button
        ...
        className="relative z-0 flex flex-row items-center justify-center w-full gap-4 p-2 transition-colors border-b-4 border-rd3 bg-d7 hover:bg-d6 md:flex-col"
      >
        <span
