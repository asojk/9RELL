  ...
  return (
    ...
    >
      <motion.div
        ...
        className="p-4 rounded-[7px] bg-b3/50 flex flex-col justify-between relative z-10 text-l1"
      >
        <div>
          <motion.p
            initial={false}
            animate={{
              color: isOpen ? "rgba(0, 0, 0, 0)" : "rgba(243 243 241, .5)",
            }}
      ...
      <motion.div
        ...
        className="absolute inset-0 z-1 bg-gradient-to-r from-b3 to-d5"
      />
