      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl mx-auto lg:max-w-5xl">
          ...
          <div className="grid items-center gap-6 mt-12 lg:grid-cols-2 lg:gap-16 bg-d7 rounded-2xl">
            {/* Card */}
            <div className="flex flex-col p-4 rounded-2xl sm:p-6 lg:p-12">
              <form
                ref={form}
                onSubmit={sendEmail}
                className="">
                ...
                <div className="grid gap-4">
                  ...
                  <label
              htmlFor="Username"
              className="relative block border rounded-md shadow-sm dark:bg-d7 bg-d7 focus-within:border-bl1 focus-within:ring-1 focus-within:ring-bl1">
              <input
                type="text"
                id="Username"
                className="placeholder-transparent border-none bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                placeholder="Username"/>
              <span
                className="pointer-events-none bg-d7 absolute start-2.5 top-0 -translate-y-1/2 p-0.5 text-xs text-l3 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-0 peer-focus:text-xs">
                Username
              </span>
            </label>
            </div>
            <div>
                  <label
              htmlFor="Username"
              className="relative block border rounded-md shadow-sm border-d5 focus-within:border-bl1 focus-within:ring-1 focus-within:ring-bl1">
              <input
                type="text"
                id="Username"
                ...
                placeholder="Username"/>
              <span
                className="pointer-events-none absolute start-2.5 top-0 -translate-y-1/2 bg-d7 p-0.5 text-xs text-l5 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-0 peer-focus:text-xs">
                Username
              </span>
            </label>
            </div>
