        ...
        <div className="max-w-2xl mx-auto lg:max-w-5xl">
          ...
          <div className="grid items-center gap-6 mt-12 lg:grid-cols-2 lg:gap-16 bg-d7 rounded-2xl">
            ...
            <div className="flex flex-col p-4 rounded-2xl sm:p-6 lg:p-8">
              ...
              <span
                className="pointer-events-none absolute start-2.5 top-0 -translate-y-1/2 p-0.5 text-xs text-l5 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-0 peer-focus:text-xs">
                Username
              </span>
            </label>
            </div>
