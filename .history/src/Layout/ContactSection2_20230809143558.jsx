                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="relative px-4 py-8 text-base rounded-lg group">
                    ...
                    >
                      ...
                      />
                      <span className="pointer-events-none absolute start-2.5 top-0 -translate-y-1/2 text-[.75rem] text-l3 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-0 peer-focus:text-xs peer-active:text-xs">
                        Email
                      </span>
                    </label>
                  </div>
