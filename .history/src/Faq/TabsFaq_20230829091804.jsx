...
const QUESTIONS = {
	...
	Other: [
		...
		{	question: 'can we install a new roof over an existing roof?',
			answer:
				"Yes, we can install a new roof over an existing roof. The viability of this depends on the current roof's integrity, appropriate underlayments used, and local building code permissions. Contact a Grell today to schedule a roof evaluation, which will determine if your roof is an ideal candidate for an overlay.",
		},
