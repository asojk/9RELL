                      ...
                      <div className="grid">
                        <div className="first:flex min-h-[60px] flex-col-reverse justify-center px-8 py-2 shadow-sm focus-within:shadow-inner relative z-0 group">
                          <ReactDatePicker
                            ...
                            className="w-1/2 font-thin tracking-wide bg-transparent rounded-lg outline-none cursor-pointer btn placeholder-l3 border-b1 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                          />
                        </div>
                      </div>
                      <div className="grid">
