...
<label
  htmlFor="UserEmail"
  className="block px-3 py-2 overflow-hidden border rounded-md shadow-nimble bg-d7 border-b3 focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600"
>
  ...
  *Name
  ...
  <input
    ...
    className="w-full p-0 mt-1 bg-transparent border-none rounded-full focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm text-b5"
  />
</label>
