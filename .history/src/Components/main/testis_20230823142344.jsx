						...
						{Quotes.map((quote, index) => (
							<SwiperSlide key={index}>
								...
								<div className='collapse bg-base-200'>
									<input type='checkbox' />
									<div className='text-xl font-medium collapse-title'>Click me to show/hide content</div>
									<div className='collapse-content'>
										<p>hello</p>
									</div>
								</div>
								<span className='px-4 pt-4 transition-all duration-500 line-clamp-6 lg:line-clamp-3 hover:line-clamp-none text-l2'>
									{quote.description}
								</span>
