		...
		<div className="container px-5 py-12 mx-auto rounded-2xl">
		  <div className="mb-8 bg-d7 rounded-2xl">
			<header className="header">
			  <span className="head">What others have to say</span>
			  <h1 class="h2">Testimonials</h1>
			</header>
			<Swiper
				modules={[Navigation, Autoplay]} spaceBetween={10} slidesPerView={2} navigation={false}
			...
			<SwiperSlide key={index}>
				<span className='px-4 pt-8 transition-all duration-700 line-clamp-6 lg:line-clamp-3 hover:line-clamp-none text-l2'>{quote.description}</span>
