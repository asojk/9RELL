    ...
    return (
			<div className='flex flex-col w-full my-4'>
				...
				<select
					...
					className='text-sm font-thin tracking-wide normal-case bg-transparent rounded-lg outline-none cursor-pointer w-[12rem] btn border-b1 text-w4 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0'>
