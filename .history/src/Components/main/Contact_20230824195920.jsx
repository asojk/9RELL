  ...
  return (
		<>
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-start lg:flex-nowrap'>
					...
					<div className='grid grid-cols-1 gap-2 lg:grid-cols-[1fr,2fr,1fr]'>
						...
						<div className='w-full p-4 lg:pb-8 rounded-2xl'>
							...
							<div className='relative w-1/3 overflow-hidden lg:w-full group'>
								<div className='absolute w-20 h-20 right-2 -bottom-8 text-r'>
									<FiMessageCircle />
								</div>
								<div className='w-full'>
									<p className='mt-2 text-sm font-semibold text-l3'>Text us</p>
									<a
							...
							<div className='relative w-1/3 overflow-hidden lg:w-full group'>
								<div className='absolute w-20 h-20 right-8 -bottom-10 text-r'>
									<FiPhone />
								</div>
								<div className='w-full'>
									<p className='mt-2 text-sm font-semibold text-l3'>Call instead</p>
									<a className='inline-flex items-center text-sm font-medium text-w3 hover:text-r'
              ...
              <div className='relative w-1/3 overflow-hidden lg:w-full group'>
								<div className='absolute w-20 h-20 -right-4 -bottom-8 text-r'>
									<FiSend />
								</div>
								<div className='w-full'>
									<p className='mt-2 text-sm font-semibold text-l3'>Send an email</p>
									<a className='inline-flex items-center text-sm font-medium text-w3 hover:text-r'
