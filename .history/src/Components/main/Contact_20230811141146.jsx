                    ...
                    <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
                      ...
                      <div className="pt-8 md:pt-0 first:flex min-h-[60px] flex-col-reverse justify-center shadow-sm focus-within:shadow-inner relative z-0 group">
                          <select
                            ...
                            required
                            className="mb-12 text-base font-thin tracking-wide normal-case bg-transparent border-none rounded-lg outline-none cursor-pointer md:pr-12 w-fit btn placeholder-l3 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                            value={application}
