...
const Contact = ({ BuildingType, Application }) => {
  ...
  return (
    ...
    <div className="px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto grid items-center lg:grid-cols-[8fr,2fr] gap-8">

        <div className="grid max-w-[85rem] gap-8 px-8 py-10 rounded-md sm:grid-cols-2 items-center justify-center">
