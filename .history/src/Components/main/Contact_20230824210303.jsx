...
const NameInput = () => {
    ...
    className="block px-3 py-2 overflow-hidden rounded-md">
...
const DateInput = () => {
    ...
    <label htmlFor="date"
    className="block px-3 py-2 overflow-hidden rounded-md cursor-pointer">
    ...
    return (
			<label htmlFor='user_notes' className='block px-3 py-4 overflow-hidden rounded-md'>
				...
				<input
					...
					className='w-full p-0 py-2 mt-1 bg-transparent border-none focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm text-b5'
				/>
			</label>
		);
};
const Send = () => {
    return (
        <button type="submit" className="flex px-5 py-2 m-6 font-bold tracking-widest text-center uppercase transition-all duration-500 rounded-md justify-self-start justify-items-center w-fit text-r hover:text-l1 animate-btn-anim-1 hover:bg-r hover:shadow-nimble">SEND</button>
    );
};
					...
					<div className='grid grid-cols-1 gap-2 lg:grid-cols-[1fr,1fr,1fr]'>
						...
						<div className='w-full p-4 lg:pb-8 md:p-12'>
							<div className='flex py-2 text-left'>
								<div>
									<h3 className='text-sm font-semibold text-yw'>Other ways to connect</h3>
									<p className='mt-1 text-xs text-left text-l3'>
