            ...
            <select
                ...
                <div className="relative z-0 px-8 mb-8 group">
                  <input type="text" name="user_notes" 
                    id="floating_notes"
                    className="block w-full px-6 py-1 text-base bg-transparent border-0 border-b appearance-none text-l1 border-b1 focus:outline-none focus:ring-0 focus:border-y2 peer"
                      value={notes}
