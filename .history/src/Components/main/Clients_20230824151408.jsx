...
const Clients = () => {
  return (
		<>
			<section className='relative z-1 max-w-[85rem] -mt-12 mx-auto '>
				<div className=''>
					...
					<span className='flex relative z-10 w-full px-6 pt-2 text-right justify-end items-end text-[.5rem] tracking-widest italic text-w4'>
