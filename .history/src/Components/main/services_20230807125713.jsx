		...
		<>
			<div className='flex mt-4 overflow-hidden'>
				<TranslateWrapper>
					...
					<div className='items-center px-8 mx-12 mt-[60vh] sm:mx-6 lg:mx-24 rounded-2xl max-w-6xl '>
						<div className='max-w-lg mx-auto lg:max-w-none'>
							<div className='mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0 rounded-2xl'>
								<div className='relative group'>
									<div className='relative w-full overflow-hidden rounded-lg cursor-pointer h-80 sm:h-64'>
										<img
                    ...
                    <div className='flex flex-row items-center gap-2 px-2 py-2 -mr-2 rounded-l-2xl hover:bg-r bg-d9/90'>
                          ...
                          New Construction</span>
								...
								<div className='relative group'>
									<div className='relative w-full overflow-hidden rounded-lg cursor-pointer bg-l1 h-80 sm:h-64'>
										<img
										...
										/>
										<button className='absolute right-0 bottom-2'>
                    <div className='flex flex-row items-center gap-2 px-2 py-2 -mr-2 rounded-l-2xl hover:bg-r bg-d1/90'>
