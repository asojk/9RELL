			...
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-start lg:flex-nowrap'>
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-2 lg:grid-cols-[1fr,2fr,1fr]'>
						...
						<div className='w-full p-4 lg:pb-8 rounded-2xl'>
							...
							<div className='relative w-1/3 overflow-hidden lg:w-full group'>
								<div className='absolute w-20 h-20 -right-12 -bottom-6 text-r'>
									<FiMessageCircle />
								</div>
								<div className='w-full'>
									<p className='mt-2 text-lg font-semibold text-l3'>Text us</p>
									<a
							...
							<div className='relative w-1/3 overflow-hidden lg:w-full group'>
								...
								<div className='w-full'>
									<p className='mt-2 text-lg font-semibold text-l3'>Call instead</p>
                    ...
                    href='tel:+18002089693'>
							...
							<div className='flex items-center pr-6 lg:py-2 lg:pr-0 gap-x-2 lg:gap-x-7 text-r'>
								<FiSend />
								<div>
