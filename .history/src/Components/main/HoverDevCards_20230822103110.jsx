...
const Card = ({ title, subtitle, Icon, href }) => {
  return (
    ...
    >
      ...
      <Icon className="absolute z-10 transition-transform duration-300 -top-12 -right-12 text-9xl text-d9 group-hover:text-r group-hover:rotate-12" />
      ...
      <p className="relative z-10 duration-300 text-l1 group-hover:text-yw">
        {subtitle}
      </p>
    </a>
  );
