          ...
          <div className="grid">
            <div className="first:flex min-h-[60px] flex-col-reverse justify-center px-2 shadow-sm focus-within:shadow-inner relative z-0 group">
                    <select
                      ...
                      required
                      className="w-[80%] mb-8 font-thin tracking-wide bg-transparent rounded-lg outline-none text-base normal-case cursor-pointer btn placeholder-l3 border-none text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                      value={buildingType}
            ...
            <select
                      ...
                      required
                      className="w-[80%] mb-8 text-base font-thin tracking-wide normal-case bg-transparent border-none rounded-lg outline-none cursor-pointer btn placeholder-l3 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                      value={application}
