		...
		<div className="container px-5 py-12 mx-auto rounded-2xl">
		  <div className="mb-8 bg-d7 rounded-2xl">
			...
			<SwiperSlide key={index}>
				...
				<h6 className='flex flex-row items-center justify-center gap-4 mt-4 mb-4 text-lg font-semibold leading-none'>{quote.icon}{quote.name}</h6>
...
const Quotes = [
	{
		avatar: <Avs />,
		icon: <SiMinutemailer className='text-sm text-l5' />,
		description:
	...
	{
		avatar: '',
		icon: <SiGoogle className='text-sm text-l5' />,
	...
	{
		avatar: '',
		icon: <SiHomeadvisor className='text-sm text-l5' />,
	...
	{
		avatar: '',
		icon: <SiFacebook className='text-sm text-l5' />,
		description:
