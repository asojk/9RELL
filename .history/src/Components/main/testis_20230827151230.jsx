...
const Testis = () => {
	...
	return (
		<section className='max-w-[85rem] px-4 py-12 pt-16 md:pt-36 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-center lg:flex-nowrap justify-center'>
			<div className='p-4'>
				<div className='grid grid-cols-1 gap-4 md:grid-cols-[1fr,2fr]'>
					<h1 className='relative p-4 h1'>
						What our <span className='text-r'>customers</span> are saying
					</h1>
					<div className='relative w-full p-4 overflow-hidden rounded-2xl group '>
						...
						<button
							...
							className='flex items-end justify-end mb-2 text-sm text-d71 hover:text-l3'>
...
const Quotes = [
	{
		avatar: <Tjaden />,
		icon: <SiMinutemailer className='text-sm text-l5 shadow-nimble' />,
		description:
	...
	{
		avatar: <AvAlt />,
		icon: <SiGoogle className='text-sm text-l5 shadow-nimble' />,
	...
	{
		avatar: <Dks />,
		icon: <SiHomeadvisor className='text-sm text-l5 shadow-nimble' />,
	...
	{
		avatar: <AvAlt />,
		icon: <SiFacebook className='text-sm text-l5 shadow-nimble' />,
		description:
