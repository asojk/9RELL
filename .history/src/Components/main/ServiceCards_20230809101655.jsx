    ...
    <><div className='flex pt-32 overflow-hidden'>
      <TranslateWrapper>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="relative w-64 p-4 m-auto shadow-lg bg-b1 rounded-2xl">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between h-full">
                <svg
                  ...
                  height="40"
                  fill="white"
                  className="w-20 h-20 m-auto mt-4 text-l1"
                ...
                <p className="mt-4 text-lg text-l1">Package delivered</p>
