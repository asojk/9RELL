          ...
          disableOnInteraction={true}
					...
					{Quotes.map((quote, index) => (
						<SwiperSlide key={index}>
							<div className='items-center justify-center p-4 bg-w2 rounded-2xl'>
								<div className='text-center carousel-item text-d7 w-fit'>
									<span className='transition-all duration-700 hover:line-clamp-none'>{quote.description}</span>
									<div>
