...
const Contact = ({ BuildingType, Application }) => {
	...
	const PreviousButton = () => {
		return (
			<button onClick={() => handleSetStep(-1)} className='px-4 py-1 -ml-8 rounded text-l1 hover:bg-d6'>
				Prev
			</button>
		)
	};
	const NextButton = () => {
		return (
			<button onClick={() => handleSetStep(1)} className='px-4 py-1 -ml-8 rounded text-l1 bg-r'>
				Next
			</button>
		)
	};
