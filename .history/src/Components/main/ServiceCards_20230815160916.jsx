    ...
    <>
      ...
      <div className="items-center container mx-auto md:mt-[40vh] mb-16">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <Link to="/new-roof">
          <div className="relative w-32 p-2 m-auto shadow-lg cursor-pointer md:p-4 md:w-64 bg-d7 rounded-2xl group hover:bg-d5">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between h-full">

                <VscNewFile className="iMain" />

                <p className="h4 group-hover:text-xl">Build</p>
