...
const Hero = () => {
  return (
<><section className="relative z-1 max-w-[85rem] px-2 mx-auto pt-[20vh] md:pt-[40vh]">
  ...
  <div className="p-4">
    <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
      ...
      <Card title="Repair" subtitle="For leaks, cracks, emergency repairs & more" Icon={Ri24HoursLine} href="/repair" />
