							...
							<div className='w-4/6'>
								...
								<motion.button
									...
									transition={{ duration: 0.225, ease: 'easeIn' }}
										...
										className='px-2 py-2 text-sm font-black text-white rounded-lg cursor-pointer shadow-nimble bg-rd2 hover:bg-r focus:outline-none focus:ring-1 focus:ring-rd2 active:bg-rl'>
