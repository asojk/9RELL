		...
		<>
			<section className='relative z-1 max-w-[85rem] px-4 py-12 lg:py-24 mx-auto'>
				<div className='container px-5 mx-auto'>
						...
						<span className='relative z-10 border head shadow-nimble border-b3 bg-d7 rounded-2xl'>Current & Former Clients</span>
						<div className='flex -mt-16 overflow-hidden z-1'>
							<TranslateWrapper>
								<LogoItemsTop />
							</TranslateWrapper>
						</div>
