...
const Contact = ({ BuildingType, Application }) => {
  ...
  <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div className="flex items-center justify-center w-full">
      ...
      <div className="first:flex min-h-[60px] flex-col-reverse justify-center mx-8 y-2 relative lg:mb-8 z-1">
        <div className="grid items-center grid-cols-2 gap-8 py-12">
            <label htmlFor="date" className="font-thin tracking-wide text-l5">If you'd like, select a day that works best for an inspection</label>
              ...
              className="my-8 text-base font-thin tracking-wide normal-case bg-transparent rounded-lg outline-none cursor-pointer w-[12rem] btn border-b1 text-w4 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"></ReactDatePicker>
              </div>
          ...
          <div className="first:flex min-h-[60px] flex-col-reverse">
              <select id="application" name="user_application" required value={application} onChange={(e) => setApplication(e.target.value)}
                ...
                <option value="I'm Not Sure">Not Sure</option></select></div></div></div></div>
                    ...
                    <label htmlFor="notes" className="font-thin tracking-wide text-l5">Do you have a special request or additional information to provide?</label>
                      <input
                        type="text"
                        name="user_notes"
                        id="notes"
                        className="block w-full px-0 py-2 text-base bg-transparent border-0 border-b appearance-none text-l5 border-b1 focus:outline-none focus:ring-0 focus:border-y2 peer"
                        value={notes}
                    ...
                    <div className="grid pr-8">
                        ...
                        <button
                          className="flex px-5 py-2 mt-4 mb-4 font-bold tracking-widest text-center uppercase transition-all duration-500 rounded-md justify-self-start justify-items-center w-fit text-l1 hover:text-l1 animate-btn-anim-1 hover:bg-r hover:shadow-xl"
                          type="submit"
                        >
                          SEND
                        </button>
