...
function Hero({ executeScroll }) {
	useEffect(() => {
		<iframe ref={ frameRef } onLoad={ handleLoad } />
	}, []);
					...
					<div className='grid grid-cols-1 grid-rows-2 gap-8 md:gap-12 place-content-center lg:grid-cols-[1fr,2fr] lg:grid-rows-1'>
						...
						<div className='relative justify-center w-full overflow-hidden rounded-2xl group'>
							...
							<div className='w-full'>
								...
								<p className='mb-4 text-md text-l3'>Grell is available to work in most of North America.
									Check our map of projects, and consider helping us cover the whole map in red.</p>
							</div>
							<iframe 
