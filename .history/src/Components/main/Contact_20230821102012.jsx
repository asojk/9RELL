    ...
    <>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl mx-auto lg:max-w-6xl">
          <div className="grid items-center gap-4 lg:grid-cols-[4fr,2fr] lg:gap-8">
            {/* Card */}
            <div className="flex flex-col p-2 rounded-2xl sm:p-6 lg:p-4">
              <form
                ref={form}
                onSubmit={sendEmail}
                className="shadow-nimble bg-d7 rounded-2xl"
              >
                <div></div>
                {/* Grid */}
                ...
                <div className="flex items-center justify-center w-full">
                  <div>
                    <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
                      <div className="grid">
                        <div className="flex min-h-[60px] flex-col-reverse justify-center px-3 py-2 relative z-0 group">
                          <input
                            id="floating_name"
                            type="text"
                            name="user_name"
                      ...
                      <div className="grid pt-8 md:pt-0">
                        <div className="first:flex min-h-[60px] flex-col-reverse justify-center px-3 py-2 relative z-0 group">
                          <input
                            id="floating_email"
                            type="email"
                            name="user_email"
                      ...
                      <div className="grid">
                        <div className="first:flex min-h-[60px] flex-col-reverse mt-8 justify-center px-3 py-2 relative z-0 group">
                          <input
                            id="floating_phone"
                            type="tel"
                            name="user_phone"
                    ...
                    <div className="first:flex min-h-[60px] flex-col-reverse justify-center mx-8 relative lg:mb-8 z-1 items-center content-center">
                      <div className="grid items-center grid-cols-2 gap-8 py-8">
                        <label
                          htmlFor="date"
                          className="font-thin tracking-wide text-l5"
                        >
                          If you'd like, select a day that works best for an
                          inspection
                        </label>
                        <ReactDatePicker
                          autoComplete="off"
                    ...
                    <div className="relative z-0 pl-8 mt-12 mb-8 lg:mt-4 group">
                      <label
                        ...
                        className="font-thin tracking-wide text-l5"
                      >
                        Do you have a special request or additional information
                        to provide?
                      </label>
                      <input
                        type="text"
                        ...
                        className="block w-full max-w-md px-0 py-2 text-base bg-transparent border appearance-none border-b1 textarea textarea-bordered textarea-md text-l5 focus:outline-none focus:ring-0 focus:border-y2 peer"
                      />
                    </div>
                    <div className="grid pr-8">
                      <button
                        type="submit"
                        className="flex px-5 py-2 m-6 font-bold tracking-widest text-center uppercase transition-all duration-500 rounded-md justify-self-start justify-items-center w-fit text-r hover:text-l1 animate-btn-anim-1 hover:bg-r hover:shadow-xl"
                      >
                        SEND
                      </button>
                    </div>
            ...
            <div className="lg:ml-6 md:pl-0 bg-d7 shadow-nimble rounded-2xl md:max-w-[300px] lg:max-w-[300px]">
              <div className="flex py-6 pr-8 text-right">
                <div>
                  <h3 className="font-semibold text-yw">
              ...
              <div className="flex items-center justify-end py-6 pr-12 gap-x-7 text-r">
                <FiMessageCircle />
                <div>
                  <h3 className="font-semibold text-w3">Text us</h3>
                  <a
                    href="sms:+15152276367"
                    className="items-center mt-2 text-sm font-medium text-w3 gap-x-2 hover:text-r"
                  >
                    (515) 227-6367
                    <svg
                      width="16"
