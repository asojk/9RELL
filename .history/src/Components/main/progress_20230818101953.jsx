...
const SteppedProgress = () => {
  ...
  return (
    <div className="px-4 py-14">
      <div className="w-full max-w-2xl p-8 mx-auto rounded-md shadow-blue">
        <Steps numSteps={numSteps} stepsComplete={stepsComplete} />
        <div className="h-48 p-2 my-6 border-2 rounded-lg border-b3 bg-d7"></div>
...
const Step = ({ num, isActive }) => {
  return (
    <div className="relative">
      <div
        className={`w-10 h-10 flex items-center justify-center shrink-0 border-2 text-l1 rounded-full font-semibold text-sm relative z-10 transition-colors duration-300 ${
          isActive
            ? "border-r text-l1"
