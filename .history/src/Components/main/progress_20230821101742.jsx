...
<div className="w-full p-4 lg:w-3/4">
    ...
    <div className="flex flex-wrap px-4 bg-d7 shadow-nimble rounded-2xl">
      ...
      <div className="flex items-center justify-end py-6 pr-6 lg:py-2 lg:pr-0 gap-x-7 text-r"><FiMessageCircle />
      ...
      <div className="flex items-center justify-end py-6 pr-6 lg:py-2 lg:pr-0 gap-x-7 text-r"><FiPhone />
      ...
      <div className="flex items-center justify-end py-6 pr-6 lg:py-2 lg:pr-0 gap-x-7 text-r"><FiSend />
