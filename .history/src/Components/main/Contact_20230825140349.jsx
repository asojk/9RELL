		...
		<div className='flex flex-col w-full my-4 bg-none'>
			<div className='flex flex-col w-full bg-none'>
				...
				<ReactDatePicker
					...
					className='w-full p-2 mx-8 mb-4 text-white border-none rounded-lg cursor-pointer bg-rd2 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm'
				/>
