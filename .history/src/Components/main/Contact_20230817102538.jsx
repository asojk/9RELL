          ...
          <div className="relative z-0 pl-8 mt-12 mb-8 lg:mt-4 group">
            <label htmlFor="notes" className="font-thin tracking-wide text-l5">
              ...
              <input type="text" name="user_notes" id="notes" value={notes} onChange={(e) => setNotes(e.target.value)}
                className="block w-full max-w-md px-0 py-2 text-base bg-transparent appearance-none h-fit borde border-b1 textarea textarea-bordered textarea-md text-l5 focus:outline-none focus:ring-0 focus:border-y2 peer"/></div>
