							...
							<div className='w-4/6'>
								...
								<motion.button
									...
									transition={{ duration: 0.225, ease: 'easeIn' }}
										...
										className='px-4 py-2 text-sm font-black rounded-lg cursor-pointer text-l1 shadow-nimble bg-r hover:bg-rd2 focus:outline-none focus:ring-1 focus:ring-rd2 active:bg-rl'>
