...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto flex flex-wrap items-start lg:flex-nowrap">
...
<div className="w-full p-4 lg:w-3/4">
    ...
    <div className="w-full p-4 transition-all duration-200 ease-in-out transform lg:pb-8 lg:my-12 lg:w-1/4 lg:sticky lg:top-0 lg:self-start hover:scale-105">
    <div className="flex flex-wrap px-4 bg-d7 shadow-nimble rounded-2xl">
      <div className="flex py-6 text-left"><div><h3 className="font-semibold text-yw">Other ways to connect</h3><p className="px-8 mt-1 text-sm lg:text-left lg:px-0 text-w3"> Our office is open Monday-Friday from 8am to 4pm. If you your request is urgent, we do our best to respond to calls and texts 24/7.</p></div></div>
