...
function Hero({ executeScroll }) {
	...
	return (
		<>
		<section className='relative max-w-[85rem] px-2'>
			<div className='container px-2 pt-16 lg:px-12'>
					<section className='relative max-w-[85rem] px-4 py-8'>
						<div className='container px-5 '>
							 <div className='items-start justify-center mt-6 md:grid md:grid-cols-2 md:grid-rows-1'>
								<div className='w-64 p-4 overflow-hidden  md:w-80 bg-d7 shadow-nimble rounded-2xl'>
									<img
										alt='moto'
					...
					<div className='pt-16'>
						<span className='relative p-4 h2'>Services</span>
...
const Card = ({ title, subtitle, Icon, href }) => {
	return (
		<a href={href} className='w-full p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group bg-d7'>
