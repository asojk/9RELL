...
const ServiceCards = () => {
  ...
  <section className="relative z-1 max-w-[85rem] px-4 py-24 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <Link to="/new-roof">
          <div className="relative w-2/3 p-4 m-auto cursor-pointer shadow-soft-md shadow-boxShadow lg:w-64 bg-d7 rounded-2xl group hover:bg-d6">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between h-48 lg:h-full">
                <RiCompasses2Line className="iMain" />
                <h1 className="h1 group-hover:scale-110">Build</h1>
          ...
          <Link to="/repair">
          <div className="relative w-2/3 p-4 m-auto shadow-sm cursor-pointer lg:w-64 bg-d7 rounded-2xl group hover:bg-d6">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between h-48 lg:h-full">
                <Ri24HoursLine className="iMain" />
                <h1 className="h1 group-hover:scale-110">Repair</h1>
                <p className="px-6 py-2 text-base font-thin text-l1">
          ...
          <Link to="/replacement">
          <div className="relative w-2/3 p-4 m-auto shadow-xl cursor-pointer lg:w-64 bg-d7 rounded-2xl group hover:bg-d6">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between h-48 lg:h-full">
                <RiCheckDoubleLine className="iMain" />
                <h1 className="h1 group-hover:scale-110">Replace</h1>
                <p className="px-6 py-2 text-base font-thin text-l1">
