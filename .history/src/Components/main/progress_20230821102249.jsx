...
<div className="max-w-[85rem] px-4 py-24 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-start lg:flex-nowrap">

<div className="container w-full px-5 py-12 lg:w-3/4">
      <div className="w-full p-8 px-12 mx-auto rounded-2xl bg-d7 shadow-nimble">
        ...
        <Steps numSteps={numSteps} stepsComplete={stepsComplete} className="w-full max-w-sm" />
