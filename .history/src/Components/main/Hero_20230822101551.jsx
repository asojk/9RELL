...
const ServiceCards = () => {
  ...
  <section className="relative z-1 max-w-[85rem] px-4 py-18 mx-auto">
		<div className="container px-5 lg:py-12 mx-auto rounded-2xl md:mt-[40vh]">
      <HoverDevCards />
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">

          <Link to="/new-roof">
          <div className="relative w-full h-32 p-0 m-auto cursor-pointer md:h-full md:p-4 shadow-nimble md:w-64 bg-d7 rounded-2xl group hover:bg-d6">
            <div className="w-full h-full text-center">
              <div className="grid grid-cols-1 grid-rows-3 md:flex md:justify-between md:flex-col md:h-full">
                <RiCompasses2Line className="iMain" />
                <h1 className="h3 lg:h1 group-hover:scale-110">Build</h1>
          ...
          <Link to="/repair">
          <div className="relative w-1/2 p-0 m-auto cursor-pointer lg:p-4 shadow-nimble lg:w-64 bg-d7 rounded-2xl group hover:bg-d6">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between lg:h-full">
                <Ri24HoursLine className="iMain" />
                <h1 className="h3 lg:h1 group-hover:scale-110">Repair</h1>
                <p className="py-2 text-base font-thin lg: lg:px-6 text-l1">
          ...
          <div className="relative w-1/2 p-0 m-auto cursor-pointer lg:p-4 shadow-nimble lg:w-64 bg-d7 rounded-2xl group hover:bg-d6">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between lg:h-full">
                ...
                <h1 className="h3 lg:h1 group-hover:scale-110">Replace</h1>
                <p className="py-2 text-base font-thin lg: lg:px-6 text-l1">
