...
const ServiceCards = () => {
  ...
  <section className="relative z-1 max-w-[85rem] lg:px-4 py-24 mx-auto">
		<div className="container lg:px-5 py-12 mx-auto rounded-2xl md:mt-[40vh]">


        <div className="grid grid-cols-3 lg:gap-8">

          <Link to="/new-roof">
          <div className="relative w-1/3 p-0 m-auto cursor-pointer lg:p-4 shadow-nimble lg:w-64 lg:bg-d7 rounded-2xl group hover:bg-d6">
