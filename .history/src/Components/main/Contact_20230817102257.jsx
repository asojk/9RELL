  ...
  <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div className="flex items-center justify-center w-full">
      <div><header className="header">
          <h2 className="head">Contact</h2></header>
        ...
        <div className="grid grid-cols-2 gap-8 py-8">
          ...
          <div className="relative z-0 pl-8 mt-12 mb-8 lg:mt-4 group">
            <label htmlFor="notes" className="font-thin tracking-wide text-l5">
              ...
              <input type="textarea" name="user_notes" id="notes" value={notes} onChange={(e) => setNotes(e.target.value)}
                className="block w-full max-w-md px-0 py-2 text-base bg-transparent border-0 border-b appearance-none textarea textarea-bordered textarea-md text-l5 border-b1 focus:outline-none focus:ring-0 focus:border-y2 peer"/></div>
            ...
            <div className="pl-6 md:pl-0">
              <div className="flex py-6 pr-8 text-right">
                <div><h3 className="font-semibold text-y">Other ways to connect</h3>
              ...
              <div className="flex justify-end py-6 pr-12 gap-x-7 text-w3"><FiMessageCircle /><div>
