                  ...
                  <div>
                    ...
                    <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
                      ...
                      <div className="first:flex min-h-[60px] flex-col-reverse">
                          <select id="application" name="user_application" required value={application} onChange={(e) => setApplication(e.target.value)}
                            className="text-base font-thin tracking-wide normal-case bg-transparent border-none rounded-lg outline-none cursor-pointer btn placeholder-l3 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0">
                    ...
                    <div className="relative z-0 px-12 mt-12 mb-8 lg:w-3/4 lg:mt-4 group">
                      <input
                        ...
                        name="user_notes"
                        id="floating_notes"
                        className="block w-full px-0 py-1 text-base bg-transparent border-0 border-b appearance-none text-l3 border-b1 focus:outline-none focus:ring-0 focus:border-y2 peer"
                        value={notes}
