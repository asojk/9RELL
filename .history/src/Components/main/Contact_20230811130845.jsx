        ...
        <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
          ...
          <div className="grid">
            ...
            <input
                      ...
                      />
                    <label htmlFor="floating_name" className="tracking-wide peer-focus:font-thin absolute text-base text-l3 duration-300 transform -translate-y-4 scale-100 top-3 -z-10 origin-[0] peer-focus:text-y2 peer-focus:scale-75 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-8">
                      * Name</label>
            </div>
          </div>
          <div className="grid">
            ...
            <input
                      ...
                      />
                    <label htmlFor="floating_phone" className="tracking-wide peer-focus:font-thin absolute text-base text-l3 duration-300 transform -translate-y-4 scale-100 top-3 -z-10 origin-[0] peer-focus:text-y2 peer-focus:scale-75 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-8">
                      * Phone</label>
            </div>
          </div>
          <div className="grid">
