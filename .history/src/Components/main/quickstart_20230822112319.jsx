    ...
    <div className="relative p-4 m-auto w-146">
      ...
      <div className="relative p-4 m-auto w-146">
          ...
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.9 }} transition={{ duration: 0.225, ease: "easeIn" }} className="">
            <button onClick={executeScroll} className="block w-full px-12 py-3 font-bold rounded cursor-pointer text-md shadow-nimble shadow-rd3 text-l1 bg-r hover:bg-rd1 focus:outline-none focus:ring active:bg-r sm:w-auto">Schedule your free estimate</button>
            </motion.button>
        </div>
      </div>
    </div>
