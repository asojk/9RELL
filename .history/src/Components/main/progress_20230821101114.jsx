...
<div className="w-full p-4 lg:w-3/4">
    ...
    <div className="flex flex-wrap px-4 bg-d7 shadow-nimble rounded-2xl">
      <div className="flex py-6 text-center"><div><h3 className="font-semibold text-yw">Other ways to connect</h3><p className="px-8 mt-1 text-sm lg:px-2 text-w3"> Our office is open Monday-Friday from 8am to 4pm. If you your request is urgent, we do our best to respond to calls and texts 24/7.</p></div></div>
