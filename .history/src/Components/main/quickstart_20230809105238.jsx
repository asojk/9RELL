		...
		<div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
			...
			<div className="relative p-4 m-auto shadow-lg w-128 bg-w2 rounded-2xl">
				<div className="w-full h-full text-center">
					...
					<h2 className="text-lg font-bold align-text-bottom heading xl:font-extrabold text-d9 xl:text-2xl md:text-lg">
        ...
        <div className="">
          ...
          >
			...
			<div className="relative p-4 m-auto shadow-lg w-128 bg-w2 rounded-2xl">
				<div className="w-full h-full text-center">
					<div className="flex flex-col justify-between h-full">
					<h2 className="text-lg font-bold align-text-bottom head3 xl:font-extrabold text-d9 xl:text-2xl md:text-lg">
