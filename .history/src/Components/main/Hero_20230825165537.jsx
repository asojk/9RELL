							...
							<div className='w-4/6'>
								...
								<div className='flex flex-wrap mt-8 mb-4 text-center'>
									<motion.button
										...
										Schedule your <a className='px-2 py-2 text-sm font-black rounded-lg cursor-pointer text-l1 shadow-nimble bg-rd1 hover:bg-r focus:outline-none focus:ring-1 focus:ring-rd2 active:bg-rl'> free
										estimate
									</motion.button>
								</div>
							</div>
