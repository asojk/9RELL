...
<label
  htmlFor="UserEmail"
  className="block px-3 py-2 overflow-hidden bg-gray-800 border rounded-md shadow-sm border-w4 focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600"
>
