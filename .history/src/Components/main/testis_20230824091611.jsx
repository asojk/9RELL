...
const Testis = () => {
	...
	return (
		<section className='relative max-w-[85rem] px-4 py-12 lg:py-24 mx-auto'>
			<div className='container px-5 mx-auto'>
				<span className='relative p-4 mb-8 border title-head shadow-nimble border-b3 bg-d7 rounded-2xl'>
					Getting Started
				</span>
					<Swiper
						modules={[Autoplay]}
