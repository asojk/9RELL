							...
							<div className='flex flex-col md:flex-row lg:flex-col'>
								<div className='w-full'>
									...
									<button className='border-0 btn group' href='sms:+15152276367'>
										<a className='inline-flex items-center font-medium text-md text-w3 group group-hover:text-r'>
											(515) 227-6367
											<svg
												width='16'
												height='16'
								...
								<div className='w-full'>
									<p className='p-1 font-semibold text-md text-l1'>Send an email</p>
										...
										<a
											...
											className='inline-flex items-center font-medium border-0 btn group text-md text-w3 group-hover:text-r'>
											roof@grell.pro
											<svg
												width='16'
												height='16'
