...
const Announcement = () => {
	...
	return (
		<div className='px-2 py-1 lg:p-4 text-black bg-yw border border-w3 shadow-nimble rounded-2xl fixed bottom-2 z-[999] grid grid-rows-2 lg:grid-rows-3'>
			<span className='mr-8 font-black text-center font-xs sm:font-sm md:font-md sm:text-left'>The New Look of Grell</span>
