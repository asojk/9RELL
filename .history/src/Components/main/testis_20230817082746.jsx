...
const Testis = () => {
	return (
		<section className="relative z-99 max-w-[85rem] px-4 py-24 mx-auto">
		<div className="container px-5 py-12 mx-auto rounded-2xl">
		  <div className="mb-8 bg-d7 rounded-2xl">
			...
			<div className="grid grid-cols-1 shadow-lg gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-2 rounded-2xl lg:py-16">
				<div className="max-w-lg mx-auto text-center lg:mx-0">
				<header className='header bg-d7 rounded-2xl'>
          ...
          disableOnInteraction={true}
					...
					className='w-full h-full px-4 pb-2 text-center text-l1 bg-d7 rounded-2xl'>
					{Quotes.map((quote, index) => (
						<SwiperSlide key={index}>
									<span className='px-4 pt-8 transition-all duration-700 line-clamp-3 hover:line-clamp-none text-l2'>{quote.description}</span>
