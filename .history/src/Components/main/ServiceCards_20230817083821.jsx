    ...
    <>
      ...
      <div className="items-center container mx-auto md:mt-[40vh] mb-16">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <Link to="/new-roof">
          <div className="relative w-64 p-4 m-auto shadow-lg cursor-pointer bg-d7 rounded-2xl group hover:bg-d6">
          ...
          <Link to="/repair">
          <div className="relative p-4 m-auto shadow-lg cursor-pointer lg:w-64 w-52 bg-d7 rounded-2xl group hover:bg-d6">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between h-full">
