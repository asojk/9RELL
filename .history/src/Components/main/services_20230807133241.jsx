		...
		<>
			<div className='flex mt-4 overflow-hidden'>
				<TranslateWrapper>
					...
					<div className='items-center px-8 mx-12 mt-[40vh] sm:mx-6 lg:mx-24 rounded-2xl max-w-6xl mb-16'>
								...
								<div className='relative group'>
									<div className='relative w-full h-64 overflow-hidden rounded-lg cursor-pointer sm:h-36'>
										<img
											...
											className='object-cover object-center w-full h-full transition-all transform rounded-2xl group-hover:scale-120'
										/>
