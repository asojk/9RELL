...
<label
  htmlFor="Username"
  className="relative block m-4 border rounded-md border-w4 shadow-nimble focus-within:border-rA focus-within:ring-1 bg-d7 focus-within:ring-r"
>
  <input
    type="text"
    id="user_name"
  ...
  <span
    className="pointer-events-none absolute start-2.5 top-0 -translate-y-1/2 bg-d7 p-3 px-12 text-xs text-l5 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-0 peer-focus:text-xs"
  >
    *Name
  </span>
</label>
