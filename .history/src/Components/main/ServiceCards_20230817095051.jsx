...
const ServiceCards = () => {
  return (
    <>
      ...
      <div className="mx-auto md:mt-[40vh] mb-16">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">

          <Link to="/new-roof">
          <div className="relative w-2/3 p-2 m-auto shadow-lg cursor-pointer lg:w-64 bg-b3 rounded-2xl group group-hover:scale-110">

              <div className="flex flex-col justify-between h-48 lg:h-full">
              <span className="flex flex-row rounded-lg bg-gradient-to-br from-rd3 from-10% to-rA p-3 text-8xl text-center justify-center items-center place-content-center text-yw shadow-rd3 transition-all duration-300">
                <RiCompasses2Line className="row"/>


                <h1 className="row h1 group-hover:opacity-50">Build</h1>
                <p className="px-6 py-2 text-base font-thin row text-l1">
