		...
		<div className="container px-5 py-12 mx-auto rounded-2xl">
		  <div className="mb-8 bg-d7 rounded-2xl">
			...
			<SwiperSlide key={index}>
				        <img alt="team" class="flex-shrink-0 object-cover object-center w-16 h-16 mx-auto -mt-8 rounded-full shadow-xl aboslute" src="https://storage.googleapis.com/indie-hackers.appspot.com/avatars/300x300_DUFTlhOdmSdoT9F4r1Woo40pyML2.webp"></img>
