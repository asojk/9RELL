		...
		<div className="container px-5 mx-auto lg:py-12 rounded-2xl">
		  <div className="mb-8 border shadow-nimble border-b3 bg-d7 rounded-2xl">
			...
			<SwiperSlide key={index}>
				        {quote.avatar}
				<span className='px-4 pt-4 transition-all duration-500 line-clamp-6 lg:line-clamp-3 group group-active:line-clamp-none text-l2'>{quote.description}<button className="btn group">...</button></span>
