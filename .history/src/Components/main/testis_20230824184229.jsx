		...
		<section className='relative max-w-[85rem] px-2 pt-16 lg:px-12'>
			<div className='p-4'>
				<div className='grid grid-cols-1 gap-4 md:grid-cols-[1fr,2fr]'>
					...
					<div className='w-full p-4 rounded-2xl border-[1px] border-b3 relative  group shadow-nimble bg-gradient-to-t from-d7 to-d6'>
						<Swiper
							modules={[Autoplay]}
							spaceBetween={10}
							slidesPerView={2}
						...
						<button
							...
							className='mb-2 text-xs text-right text-d71 hover:text-l3'>
