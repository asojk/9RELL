	...
	return (
		<div className='px-4 py-3 text-black bg-yw border border-w3 shadow-nimble flex items-center rounded-t-xl justify-between sm:px-6 lg:px-8 fixed bottom-0 z-[999] w-full'>
			...
			<span className='mr-8 text-center font-xs sm:font-sm md:font-md sm:text-left'>
				We are excited to announce the launch of our new website & logo! We have made it easier to navigate and find the
				information you are looking for. We have also added a new feature that allows you to request a quote online. We
