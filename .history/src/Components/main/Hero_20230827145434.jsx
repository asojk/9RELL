						...
						<div className='w-full p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6'>
							...
							<div className='w-4/6'>
								...
								<div className='flex flex-wrap'>
									...
									<p className='mt-8 text-center text-md text-l3'>Schedule your</p>
									<motion.button
										whileHover={{ scale: 1.05 }}
										whileTap={{ scale: 0.9 }}
										transition={{ duration: 0.225, ease: 'easeIn' }}
										onClick={executeScroll}
										className='px-2 py-2 font-black text-center uppercase rounded-lg cursor-pointer  xl:mt-6 text-md text-l1 shadow-nimble bg-rd1 hover:bg-r focus:outline-none focus:ring-1 focus:ring-rd2 active:bg-rl'>
										free estimate
									</motion.button>
								</div>
							</div>
