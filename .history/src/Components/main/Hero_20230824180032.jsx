			...
			<section className='relative max-w-[85rem] px-2 pt-16 lg:px-12'>
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
						<span className='relative p-4 leading-relaxed h2'>Getting Started</span>
						<div className='w-full p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-d7'>
							<img
								alt='moto'
...
const Card = ({ title, subtitle, Icon, href }) => {
	return (
		<a href={href} className='w-full p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-d7'>
