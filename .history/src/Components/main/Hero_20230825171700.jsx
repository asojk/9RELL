		...
		<>
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-center lg:flex-nowrap justify-center'>
				<div className='p-4'>
					...
					<span className='text-white text-xxs'>text-xxs</span>
					<span className='text-xs text-white'>text-xs</span>
					<span className='text-sm text-white'>text-sm</span>
					<span className='text-white text-md'>text-md</span>
					<span className='text-lg text-white'>text-lg</span>
					<span className='text-xl text-white'>text-xl</span>
					<span className='text-2xl text-white'>text-2xl</span>
					<span className='text-3xl text-white'>text-3xl</span>
					<span className='text-4xl text-white'>text-4xl</span>
					<span className='text-5xl text-white'>text-5xl</span>
...
const Card = ({ title, subtitle, Icon, href }) => {
	return (
		<a
			...
			<p className='relative z-10 pt-2 text-xs font-thin duration-300 md:text-sm text-l3 group-hover:text-l1'>
				{subtitle}
			</p>
		</a>
	);
