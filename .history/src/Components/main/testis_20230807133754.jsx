...
const Testis = () => {
	return (
		<div className='container flex flex-wrap px-12 pt-8 pb-8 mx-auto my-16'>
			<header className='header rounded-t-2xl bg-d9/90'>
				<span className='head'>What Others Say</span>
				<h2 className='heading'>Testimonials</h2>
			</header>
			<div className='w-full max-w-3xl px-4 rounded-b-2xl bg-d9/90'>
				<Swiper
          ...
          disableOnInteraction={true}
					...
					{Quotes.map((quote, index) => (
						<SwiperSlide key={index}>
							<div className='relative items-center justify-center w-full bg-transparent carousel-item'>
								<div className='items-center justify-center max-w-md text-center text-l1'>
