...
<label
  htmlFor="Username"
  className="relative block border rounded-md border-w4 shadow-nimble focus-within:border-rA focus-within:ring-1 bg-d7 text-d7 focus-within:ring-r"
>
  <input
    type="text"
    id="user_name"
    name="user_name" required autoComplete="name" value={name} onChange={(e) => setName(e.target.value)}
    className="placeholder-transparent border-none bg-d7 peer focus:border-d7 focus:outline-none focus:ring-0"
    placeholder="*Name"
  />
