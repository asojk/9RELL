    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="p-4 overflow-y-scroll cursor-pointer backdrop backdrop-blur place-items-center"
        >
          <motion.div
          ...
          >
            <div className="relative z-10">
              <div className="w-full px-2 py-2 text-lg text-center text-white bg-black">
              </div>
              <iframe
