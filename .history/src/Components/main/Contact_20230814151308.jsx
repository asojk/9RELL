      ...
      <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
        ...
        <div className="grid">
          <div className="first:flex min-h-[60px] flex-col-reverse my-8 justify-center px-3 py-2 shadow-sm focus-within:shadow-inner relative z-0 group">
            ...
            >* Phone</label></div></div>
      <div className="grid">
        <div className="first:flex min-h-[60px] flex-col-reverse justify-center px-4 py-2 shadow-sm focus-within:shadow-inner relative z-1 group">
          <ReactDatePicker autoComplete="off" selected={startDate} filterDate={isWeekday}
          onChange={(date) => setStartDate(date)} showPopperArrow={false}
          select="preset-range"
          firstSelectDay={1}
          selectSize={5} 
          monthsShown={2} minDate={minDate}
          type="date" name="user_date" value={date}
          placeholderText="Select a Date"
          className="mb-8 font-thin tracking-wide bg-transparent rounded-lg outline-none cursor-pointer w-fit btn border-b1 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0">
          <div style={{ color: "red" }}>Don't forget to check the weather!</div></ReactDatePicker></div></div>
          ...
          <div className="first:flex min-h-[60px] flex-col-reverse">
            <select id="building_type" name="user_buildingType" required value={buildingType}
                ...
                className="text-base font-thin tracking-wide normal-case bg-transparent border-none rounded-lg outline-none cursor-pointer w-fit btn text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0">
