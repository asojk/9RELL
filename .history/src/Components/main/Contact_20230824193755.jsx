				...
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-2 md:grid-cols-[1fr,2fr,1fr]'>
						...
						<div className='w-full p-4 lg:pb-8 rounded-2xl'>
							...
							<div className='relative w-32 p-4 overflow-hidden rounded-2xl'>
								<div className='absolute w-20 h-20 -right-12 -bottom-12'>
									<FiMessageCircle />
								</div>
								<div className='w-4/6'>
									<p className='mb-2 text-lg font-semibold text-w3'>Text us</p>
									<a
							...
							<div className='relative w-32 p-4 overflow-hidden bg-white shadow-lg rounded-2xl'>
