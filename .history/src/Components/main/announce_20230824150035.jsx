  ...
  return (
		<div className='px-4 py-3 text-black bg-yw sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 absolute z-[999] bottom-0 w-full'>
			<p className='font-bold text-center sm:text-left'>
				...
				<br className='hidden md:block' /> {' '}We are excited to announce the launch of our new website & logo! We have made it easier to navigate and find the information you are looking for. We have also added a new feature that allows you to request a quote online. We look forward to hearing from you!
			</p>
