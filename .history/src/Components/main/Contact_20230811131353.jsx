      ...
      <h2 className="heading">Get in touch</h2>
        ...
        <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
          ...
          <div className="grid">
            ...
            <div className="grid">
            <div className="first:flex min-h-[60px] flex-col-reverse my-8 justify-center px-3 py-1 shadow-sm focus-within:shadow-inner relative z-0 group">
            <input
                        id="floating_phone"
                        className="block w-full px-0 py-1 text-base bg-transparent border-0 border-b appearance-none text-l1 border-b1 focus:outline-none focus:ring-0 focus:border-y2 peer"
                        type="tel"
          ...
          <div className="grid">
            <div className="first:flex min-h-[60px] flex-col-reverse justify-center px-8 py-1 shadow-sm focus-within:shadow-inner relative z-0 group">
            <ReactDatePicker
                        selected={date}
