    ...
    <>
      ...
      <div className="mx-auto md:mt-[40vh] mb-16">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <Link to="/new-roof">
          <div className="relative w-2/3 p-4 m-auto border-8 border-[linear-gradient: #fff 0%, #000 100%] shadow-lg cursor-pointer lg:w-64 bg-d7 rounded-2xl group hover:bg-d6">
