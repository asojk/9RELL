...
function Hero({ executeScroll }) {
  ...
  <div className="px-6 m-auto text-gray-600 xl:container dark:text-gray-300 md:px-12 xl:px-6">
    ...
    <div className="grid gap-8 md:grid-rows-2 lg:grid-cols-2">
      <div className="row-span-2 p-8 text-center border border-gray-100 shadow-2xl rounded-3xl dark:border-gray-700 bg-gray-50 dark:bg-gray-800 shadow-gray-600/10 dark:shadow-none">
        <div className="flex flex-col justify-center h-full space-y-4">
          <img className="w-20 h-20 mx-auto rounded-full" src="images/avatars/second_user.webp" alt="user avatar" height="220" width="220" loading="lazy" />
      ...
      <div className="p-8 text-center border border-gray-100 shadow-2xl rounded-3xl sm:flex sm:space-x-8 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 shadow-gray-600/10 dark:shadow-none">
        <img className="w-20 h-20 mx-auto rounded-full" src="images/avatars/first_user.webp" alt="user avatar" height="220" width="220" loading="lazy" />
      ...
      <div className="p-8 text-center border border-gray-100 shadow-2xl rounded-3xl sm:flex sm:space-x-8 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 shadow-gray-600/10 dark:shadow-none">
        <img className="w-20 h-20 mx-auto rounded-full" src="images/avatars/third_user.webp" alt="user avatar" height="220" width="220" loading="lazy" />
        <div className="mt-4 space-y-4 text-center sm:mt-0 sm:text-left">
          <p>
            <span className="font-serif">&quot;</span> Lorem ipsum dolor sit amet consectetur adipisicing
            elit. Quaerat repellat perspiciatis excepturi est. Non ipsum iusto aliquam
			...
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-center lg:flex-nowrap justify-center'>
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-4 lg:gap-8 lg:grid-cols-3'>
						<h1 className='relative p-4 text-2xl text-l1'>Getting Started</h1>
