    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 z-50 grid p-8 overflow-y-scroll cursor-pointer backdrop backdrop-blur place-items-center"
        >
          <motion.div
          ...
          >
            ...
            <div className="flex justify-end">
              <div className="flex justify-center w-48 px-2 py-2 text-lg text-center text-white bg-black rounded-t-full bg-clip-padding">
              </div>
              </div>
              <iframe
              src="https://api.mapbox.com/styles/v1/grell/clkk0o55v00vq01qf1ze302fe.html?title=false&access_token=pk.eyJ1IjoiZ3JlbGwiLCJhIjoiY2xraXpib3NkMDBibTNybXZnbml5eGMwMyJ9.y69nZBItX012aWE7GWBfyA&zoomwheel=false#4.21/39.56/-94.35" title="GRELL-copy-copy" loading="lazy" style={{ height: "35vh", borderRadius: ".5rem", border: "5px solid black", borderTopLeftRadius: "30rem", borderBottomLeftRadius: "30rem", borderBottomRightRadius: "30rem"}}></iframe>
            </div>
          </motion.div>
        </motion.div>
      )}
