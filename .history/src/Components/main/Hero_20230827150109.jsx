...
function Hero({ executeScroll }) {
	...
	return (
		...
		<div className="py-16">
			...
			<div className='relative justify-center w-full p-4 overflow-hidden rounded-2xl group'>
							<img
								alt='moto'
							...
							<div className='w-full'>
								<p className='mb-8 text-lg font-black duration-300 md:text-xl text-l1'>Does Grell service my area?</p>
							...
							<div className='w-5/6 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6'>
															<img
								alt='moto'
				...
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-4 lg:gap-8 lg:grid-cols-3'>
						...
						<div className='relative justify-center w-full p-4 overflow-hidden rounded-2xl group'>
							...
							<div className='w-4/6 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6'>
