...
const Announcement = () => {
	...
	useEffect(() => {
		const seenAnnouncement = localStorage.getItem('hasSeenAnnouncement');
		if (seenAnnouncement) {
	...
	return (
		<div className='px-2 lg:p-4 text-black bg-y5 border border-b3 shadow-nimble rounded-2xl fixed bottom-2 z-[999] grid grid-rows-2 lg:grid-rows-3 ring-2 ring-yw cursor-default'>
			<span className='pt-1 font-black text-center font-xs md:font-sm lg:font-md'>The New Look of Grell</span>
			<span className='text-center font-xs md:font-sm lg:font-md'>
				We are excited to announce the launch of our new website & logo!
			</span>
			<span className='hidden text-center lg:block font-xs md:font-sm lg:font-md'>
