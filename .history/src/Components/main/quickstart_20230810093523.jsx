...
function GettingStarted({ executeScroll }) {
  ...
  return (
<section>
<div className="grid grid-cols-1 gap-4 lg:grid-rows-2 lg:grid-cols-2 lg:gap-8">
    <div className="grid col-span-1 col-start-1 row-span-1 row-start-1 shadow-lg rounded-2xl bg-d7 text-l1">
...
<div className="grid lg:col-start-2 lg:row-span-1">
      <div className="relative p-4 m-auto">
