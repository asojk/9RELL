  ...
  return (
		<>
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-start lg:flex-nowrap'>
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-4 md:grid-cols-[1fr,2fr,1fr]'>
						<h1 className='relative p-4 h1'>
							Schedule your<span className='text-r'> free</span> estimate
						</h1>
						<div className='w-full p-8 px-12 mx-auto rounded-2xl border-[1px] border-b3 group shadow-nimble bg-gradient-to-tl from-d7 to-d6'>
							...
							<div className='flex items-center justify-end gap-2'>
								<button onClick={() => handleSetStep(-1)} className='px-4 py-1 m-2 rounded text-l1 hover:bg-d6'>
									Prev
								</button>
								<button onClick={() => handleSetStep(1)} className='px-4 py-1 m-2 rounded text-l1 bg-r'>
									Next
								</button>
							</div>
						</div>
						<div className='w-full p-4 lg:pb-8 rounded-2xl'>
							...
							<div className='flex items-center justify-end py-6 pr-6 lg:py-2 lg:pr-0 gap-x-4 lg:gap-x-7 text-r'>
								<FiMessageCircle />
								<div>
