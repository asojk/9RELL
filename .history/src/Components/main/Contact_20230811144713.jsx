                  ...
                  <div>
                    ...
                    <div className="relative z-0 px-12 mt-12 mb-8 lg:w-3/4 lg:mt-4 group">
                      ...
                      <label
                        ...
                        className="tracking-wide peer-focus:font-thin absolute text-base text-l5 duration-300 transform -translate-y-8 scale-100 top-3 -z-10 origin-[0] peer-focus:text-y2 peer-focus:scale-75 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-8"
                      >
