...
const ServiceCards = () => {
  return (
    ...
    </div><div className="items-center container mx-auto md:mt-[40vh] mb-16">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="relative w-64 p-4 m-auto shadow-lg bg-d9 rounded-2xl">
            <div className="w-full h-full text-center">
              ...
              <svg height="60" id="Layer_1" width="60" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
	<defs>
		<style>.cls-6374f8d9b67f094e4896c652-1{fill:none;stroke:currentColor;stroke-miterlimit:10;}</style>
	</defs>
	<circle className="cls-6374f8d9b67f094e4896c652-1" cx="12" cy="12" r="10.5"/>
	<line className="cls-6374f8d9b67f094e4896c652-1" x1="6.27" x2="17.73" y1="12" y2="12"/>
	<line className="cls-6374f8d9b67f094e4896c652-1" x1="12" x2="12" y1="6.27" y2="17.73"/>
</svg>

                <p className="mt-4 text-lg text-d9">Package delivered</p>
