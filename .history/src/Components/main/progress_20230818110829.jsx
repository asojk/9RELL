...
<label
  htmlFor="UserEmail"
  className="block px-3 py-2 overflow-hidden bg-gray-800 border border-gray-700 rounded-md shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600"
>
  <span className="px-4 py-6 text-xs font-medium text-l1 bg-d7">
    Email
  </span>
