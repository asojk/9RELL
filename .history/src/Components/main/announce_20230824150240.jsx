...
const Announcement = () => {
  ...
  return (
		<div className='px-4 py-3 text-black bg-yw sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 absolute z-[999] w-full'>
			<p className='hidden font-black md:block'>The New Look of Grell {' '}</p>
