...
const Announcement = () => {
  ...
  return (
		<div className='px-4 py-3 text-black bg-yw border border-w3 shadow-nimble flex items-center rounded-top-xl justify-between sm:px-6 lg:px-8 fixed bottom-0 z-[999] w-full'>
			<span className='hidden text-lg font-black md:w-64 md:block sm:p-0 md:p-2 lg:text-center'>The New Look of Grell {' '}</span>
