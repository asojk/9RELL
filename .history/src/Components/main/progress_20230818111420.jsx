...
<label
  htmlFor="user_name"
  className="block px-3 py-2 overflow-hidden border rounded-xl shadow-nimble bg-d7 border-b3 focus-within:border-rd3 focus-within:ring-1 focus-within:ring-r">
