...
const Card = ({ title, subtitle, Icon, href }) => {
  return (
    ...
    >
      ...
      <Icon className="absolute z-10 transition-transform duration-300 -top-3 -right-1 text-7xl text-b3 group-hover:text-r group-hover:rotate-12" />
      <Icon className="relative z-10 mb-2 text-2xl transition-colors duration-300 text-r group-hover:text-l1" />
      <h3 className="relative z-10 pt-4 text-xl font-medium duration-300 text-l1 group-hover:text-white">
        {title}
      </h3>
