    ...
    return (
			<div className='flex flex-col w-full mb-8'>
				<select
					...
					className='select text-base font-thin tracking-wide normal-case bg-transparent rounded-lg outline-none cursor-pointer w-[12rem] btn border-b1 text-w4 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0'>
...
const ApplicationSelect = () => {
    ...
    return (
      <div className="flex flex-col w-full">
        ...
        className="select text-base font-thin tracking-wide normal-case bg-transparent rounded-lg outline-none cursor-pointer w-[12rem] btn border-b1 text-w4 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0">
        <option selected disabled value="NA">* Application</option>
...
<div className="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-start lg:flex-nowrap">

<div className="container w-full px-5 lg:py-12 lg:w-3/4">
      <div className="w-full p-8 px-12 mx-auto rounded-2xl bg-d7 shadow-nimble">

        <header className="header"><span className="title-head">Schedule a free estimate</span><h1 class="h1">Contact</h1></header>
    ...
    <div className="w-full p-4 transition-all duration-200 ease-in-out transform lg:my-12 lg:w-1/4 lg:sticky lg:top-0 lg:self-start hover:scale-105">
    <div className="flex flex-wrap px-4 lg:pb-8 bg-d7 shadow-nimble rounded-2xl">
      <div className="flex py-4 text-left"><div><h3 className="font-semibold text-yw">Other ways to connect</h3><p className="px-8 mt-1 text-sm lg:text-left lg:px-0 text-w3"> Our office is open Monday-Friday from 8am to 4pm. If you your request is urgent, we do our best to respond to calls and texts 24/7.</p></div></div>

      <div className="flex items-center justify-end py-6 pr-6 lg:py-2 lg:pr-0 gap-x-4 lg:gap-x-7 text-r"><FiMessageCircle />
      ...
      <div className="flex items-center justify-end py-6 pr-6 lg:py-2 lg:pr-0 gap-x-4 lg:gap-x-7 text-r"><FiPhone />
      ...
      <div className="flex items-center justify-end py-6 pr-6 lg:py-2 lg:pr-0 gap-x-4 lg:gap-x-7 text-r"><FiSend />
