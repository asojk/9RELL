...
const DateInput = () => {
	...
	return (
		<div className='flex flex-col w-full my-4 bg-none'>
			...
			<label htmlFor='date' className='block px-3 py-2 overflow-hidden rounded-md cursor-pointer'>
				<ReactDatePicker
					autoComplete='off'
					inputID='date'
					selected={date}
				...
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-2 lg:grid-cols-[1fr,1fr,1fr]'>
						...
						<div className='w-full p-4 pr-0 lg:pb-8 md:p-12'>
							...
							<div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-1 lg:gap-4'>
								<div className='w-full'>
								<p className='p-1 font-semibold text-md text-l3'>Text us</p>
									<button className='border-0 btn group' href='sms:+15152276367'>
									<a
										className='inline-flex items-center font-medium text-md text-w3 group group-hover:text-r'>
										(515) 227-6367
										<svg
											width='16'
											height='16'
							...
							<div className='w-full'>
							<p className='p-2 font-semibold text-md text-l3'>Call instead</p>
							<button className='border-0 btn group' href='tel:+18002089693'>
								<a
									className='inline-flex items-center font-medium text-md text-w3 group group-hover:text-r'>
									1-800-208-9693
									<svg
						...
						<div className='w-full'>
							<p className='p-2 font-semibold text-md text-l3'>Send an email</p>
							<button className='border-0 btn group' href='mailto:roof@grell.pro'>
								<a
									className='inline-flex items-center font-medium text-md text-w3 group group-hover:text-r'>
									roof@grell.pro
									<svg
