          ...
          <div className="grid items-center gap-4 mt-12 lg:grid-cols-2 lg:gap-8 bg-d7 rounded-2xl">
            ...
            <div className="pl-8 divide-y divide-d1">
              ...
              <div className="flex py-6 lg:py-12 gap-x-7">
                <FiMessageCircle />
                <div>
                  <h3 className="font-semibold text-l1">Text Us</h3>
                  <a
              ...
              <div className="flex py-6 lg:py-12 gap-x-7">
                <FiPhone />
                <div>
                  <h3 className="font-semibold text-l1">Call Instead</h3>
                  <a
                    className="inline-flex items-center mt-2 text-sm font-medium text-l3 gap-x-2 hover:text-r"
              ...
              <div className="flex py-6 lg:py-12 gap-x-7">
                <FiSend />
                <div>
                  <h3 className="font-semibold text-l1">Contact us by email</h3>
