...
const Announcement = () => {
  ...
  return (
		<div className='px-4 py-3 text-black bg-yw border border-w3 shadow-nimble sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 relative z-[999] w-full'>
