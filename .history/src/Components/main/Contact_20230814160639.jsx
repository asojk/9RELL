    ...
    <div className="flex items-center justify-center w-full">
      ...
      <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
        ...
        <div className="first:flex min-h-[60px] flex-col-reverse justify-center mx-8 py-2 shadow-sm focus-within:shadow-inner relative z-1 group">
          ...
          className="mt-2 mb-8 font-thin tracking-wide text-center bg-transparent border rounded-lg outline-none cursor-pointer w-fit border-b1 text-l5 bg-d7 focus:border-transparent focus:outline-none focus:ring-0">
          </ReactDatePicker>
