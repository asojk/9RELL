	...
	return (
		<>
			<section className='relative max-w-[85rem] px-2 mx-auto '>
				<div className='container px-2 pt-16 mx-auto lg:px-12'>
					<span className='relative p-4 border head shadow-nimble border-b3 bg-d7 rounded-xl'>Getting Started</span>

					<section className='relative z-1 max-w-[85rem] px-4 py-8 mx-auto'>
						<div className='container px-5 mx-auto'>
							<div className='items-start justify-between mt-8 md:grid md:grid-cols-2 md:grid-rows-1 md:gap-4 lg:gap-8'>
