...
<div className="container items-center mx-auto mb-16">
  <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    <div className="grid grid-cols-1 p-4 shadow-lg gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-4 bg-d7 text-l1 rounded-2xl lg:p-12">
      ...
      <div className="relative grid w-full h-full grid-rows-2 gap-6 p-4 m-auto lg:gap-8 w-128">
      <div className="">
          ...
          >
            <button
              ...
              className="relative inline-flex items-center justify-center m-1 mt-6 text-center cursor-pointer lg:text-lg lg:px-2 lg:py-3 btn bg-r border-l1 hover:bg-r text-l1"
            >
