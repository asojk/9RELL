...
const DateInput = () => {
	...
	return (
		<div className='flex flex-col w-full my-4 bg-none'>
			...
			<button onClick={() => setDate('')} className='px-4 py-1 mt-2 text-xs text-d71 hover:text-l3'>
				<ReactDatePicker
					autoComplete='off'
					inputID='date'
					selected={date}
					...
					className='w-full p-2 mb-4 border-none cursor-pointer bg-rd2 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm text-b5'
				/>
			</button>
		</div>
	);
