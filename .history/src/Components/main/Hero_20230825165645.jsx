						...
						<div className='w-full p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6'>
							...
							<div className='w-4/6'>
								...
								<div className='flex flex-wrap mt-8 mb-4 text-center'>
									<p className='text-md text-l3'>Schedule your</p>
									<motion.button
										...
										Schedule your{' '}
										<a className='px-2 py-2 font-black uppercase rounded-lg cursor-pointer text-md text-l1 shadow-nimble bg-rd1 hover:bg-r focus:outline-none focus:ring-1 focus:ring-rd2 active:bg-rl'>free estimate</a>
									</motion.button>
								</div>
							</div>
						</div>
