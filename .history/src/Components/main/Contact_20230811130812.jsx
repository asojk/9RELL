      ...
      <h2 className="heading">Get in touch</h2>
        ...
        <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
          ...
          <div className="grid">
            ...
            <input
                        id="floating_name"
                        className="block w-full px-0 py-1 text-base tracking-wide bg-transparent border-0 border-b appearance-none text-l1 border-b1 focus:outline-none focus:ring-0 focus:border-y2 peer"
                        type="text"
                        name="user_name"
                        required
                        autoComplete="name"
