    ...
    <>
      ...
      <div className="items-center container mx-auto md:mt-[40vh] mb-16">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="relative w-64 p-4 m-auto border-0 shadow-lg border-rA bg-d7 rounded-2xl group group-hover:border-2">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between h-full">

                <VscNewFile className="iMain group-hover:text-rA" />
