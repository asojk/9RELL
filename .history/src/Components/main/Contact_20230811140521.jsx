                ...
                <div className="flex items-center justify-center w-full">
                  <div>
                    ...
                    <div className="grid">
                        ...
                        <button
                          className="flex justify-end w-12 px-5 py-2 mt-1 mb-4 font-bold tracking-widest text-right uppercase transition-all duration-500 rounded-md text-l1 hover:text-l1 animate-btn-anim-1 hover:bg-r hover:shadow-xl"
                          type="submit"
                        >
                          SEND
                        </button>
