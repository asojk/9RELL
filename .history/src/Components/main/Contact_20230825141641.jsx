		...
		<div className='flex flex-col w-full my-4 text-black bg-none'>
			<div className='flex flex-col w-full bg-none'>
				...
				<ReactDatePicker
					...
					className='w-1/2 p-2 mt-2 mb-4 text-black rounded-lg cursor-pointer border-[1px] border-b3 bg-b4 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm'
				/>
