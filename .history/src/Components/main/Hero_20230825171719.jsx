		...
		<>
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-center lg:flex-nowrap justify-center'>
				<div className='p-4'>
					...
					<div className='text-white text-xxs'>text-xxs</div>
					<div className='text-xs text-white'>text-xs</div>
					<div className='text-sm text-white'>text-sm</div>
					<div className='text-white text-md'>text-md</div>
					<div className='text-lg text-white'>text-lg</div>
					<div className='text-xl text-white'>text-xl</div>
					<div className='text-2xl text-white'>text-2xl</div>
					<div className='text-3xl text-white'>text-3xl</div>
					<div className='text-4xl text-white'>text-4xl</div>
					<div className='text-5xl text-white'>text-5xl</div>
