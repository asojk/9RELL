      ...
      <div className="mx-auto md:mt-[40vh] mb-16">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="relative w-2/3 p-2 m-auto shadow-lg cursor-pointer lg:w-64 bg-b3 rounded-2xl group group-hover:scale-110">
              ...
              <span className="flex rounded-lg bg-gradient-to-br from-rd3 from-10% to-rA p-3 text-8xl text-center justify-center items-center place-content-center grid grid-rows-3 text-yw shadow-rd3 transition-all duration-300">
                <RiCompasses2Line />
