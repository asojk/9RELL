		...
		<div className="container px-5 py-12 mx-auto rounded-2xl">
		  <div className="mb-8 bg-d7 rounded-2xl">
			...
			<SwiperSlide key={index}>
				        <div class="flex-shrink-0 object-cover object-center w-16 h-16 mx-auto rounded-full shadow-xl aboslute">{quote.avatar}</div>
...
const Quotes = [
	{
		avatar: 'https://grell.s3.us-east-2.amazonaws.com/pics/generic-av.jpeg',
