...
function Hero({ executeScroll }) {
	...
	return (
		<>
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 xl:px-8 mx-auto flex flex-wrap items-center xl:flex-nowrap justify-center'>
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-4 xl:gap-8 xl:grid-cols-3'>
			...
			<section className='max-w-[85rem] px-4 pb-12 sm:px-6 xl:px-8 mx-auto flex flex-wrap items-center xl:flex-nowrap justify-center'>
