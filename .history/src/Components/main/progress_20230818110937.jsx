...
<label
  htmlFor="UserEmail"
  className="block px-3 py-2 overflow-hidden border rounded-md shadow-nimbal bg-d7 border-b3 focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600"
>
