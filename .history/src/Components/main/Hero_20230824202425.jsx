...
function Hero({ executeScroll }) {
	...
	return (
		<>
				...
				<div className='p-4'>
					<div className='grid grid-cols-2 gap-4 md:grid-cols-3'>
						...
						<div className='w-full p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6'>
							...
							/>
							<div className='w-4/6'>
								<p className='mb-2 text-sm duration-300 lg:text-base text-l1'>How soon can we start?</p>
								...
								<motion.button
									...
									transition={{ duration: 0.225, ease: 'easeIn' }}
										...
										className='px-4 py-2 font-medium rounded-lg cursor-pointer text-l1 shadow-nimble bg-r hover:bg-rd2 focus:outline-none focus:ring-1 focus:ring-rd2 active:bg-rl'>
			...
			<section className='max-w-[85rem] px-4 pb-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-start lg:flex-nowrap'>
