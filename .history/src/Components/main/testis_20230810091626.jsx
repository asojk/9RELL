...
const Testis = () => {
	return (
		...
		<div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
			<div className="grid grid-cols-1 shadow-lg gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-4 bg-d7 text-l1 rounded-2xl lg:py-16">
				<div className="max-w-lg mx-auto text-center lg:mx-0">
				<header className='header lg:pb-8'>
          ...
          disableOnInteraction={true}
					...
					{Quotes.map((quote, index) => (
						<SwiperSlide key={index}>
									<span className='pt-8 transition-all duration-700 line-clamp-3 hover:line-clamp-none'>{quote.description}</span>
