...
const DateInput = ({ date, setDate }) => {
	...
	const Send = () => {
		return (
			<button
				type='submit'
				className='flex px-5 py-2 m-6 font-bold tracking-widest text-right uppercase transition-all duration-500 rounded-md justify-self-start justify-items-center w-fit text-r hover:text-l1 animate-btn-anim-1 hover:bg-r hover:shadow-nimble'>
				SEND
			</button>
		);
	};
