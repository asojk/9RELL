    ...
    <div className="relative p-4 m-auto w-146">
      <div className="w-full h-full">
        <div className="flex flex-col justify-between h-full">
          <h2 className="text-lg font-bold align-text-bottom head4 xl:font-extrabold text-l1 xl:text-2xl">
          ...
          <div className="relative">
            ...
            >
              <a
                ...
                className="inline-flex mt-6 text-base cursor-pointer black text-r"
              >
                Find out
                <svg
                  fill="none"
