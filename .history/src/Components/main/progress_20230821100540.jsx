...
const Contact = ({ BuildingType, Application }) => {
  ...
  <div className="grid items-center lg:grid-template-columns: minmax(0, 1fr) minmax(0, 4fr) gap-2">

    <div className="grid max-w-5xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
