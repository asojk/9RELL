		...
		<div className='flex flex-col w-full my-4'>
			<label htmlFor='user_name' className='block px-3 py-2 overflow-hidden rounded-md'>
				...
				<input
					...
					className='w-full p-4 mt-1 border-none rounded-md bg-w4 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm text-b5'
				/>
			</label>
		</div>
	);
...
const DateInput = () => {
	...
	return (
		<div className='flex flex-col w-full my-4 text-white bg-none'>
			<div className='flex flex-col w-full bg-none'>
				...
				<ReactDatePicker
					...
					className='w-1/2 p-2 mt-2 mb-4 text-white rounded-lg cursor-pointer border-[1px] border-b3 bg-b4 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm'
				/>
...
const BuildingSelect = () => {
	...
	return (
		<div className='flex flex-col w-full my-4'>
			<span className='py-2 text-sm font-medium text-l1'>Please select one for each of the following:</span>
			<select
				id='building_type'
...
const NotesInput = () => {
	...
	return (
		<label htmlFor='user_notes' className='block px-3 py-4 overflow-hidden rounded-md'>
			<span className='py-2 text-sm font-medium text-l1'>
				Do you have a special request or additional information to provide?
			</span>
			<textarea
				rows='14' cols='10' wrap='soft' type='text'
				name='user_notes' id='notes' value={notes}
				onChange={(e) => setNotes(e.target.value)}
				className='w-full p-4 mt-1 border-none h-36 bg-w4 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm text-b5'></textarea>
		</label>
	);
};
const Send = () => {
	return (
		<button
			type='submit'
			className='flex px-5 py-2 m-6 font-bold tracking-widest text-center uppercase transition-all duration-500 rounded-md justify-self-start justify-items-center w-fit text-r hover:text-l1 animate-btn-anim-1 hover:bg-r hover:shadow-nimble'>
			SEND
		</button>
	);
};
...
const Contact = ({ BuildingType, Application }) => {
	...
	return (
		<>
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-start lg:flex-nowrap justify-center'>
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-2 lg:grid-cols-[1fr,1fr,1fr]'>
						...
						<div className='w-full p-4 pr-0 md:p-12'>
							<div className='flex py-2 text-left'>
								<div>
									<h3 className='font-semibold text-md text-yw'>Other ways to connect</h3>
									<p className='mt-2 mb-4 text-sm text-left text-l3'>
							...
							<div className='flex flex-col md:flex-row lg:flex-col'>
								<div className='w-full'>
									<p className='p-1 font-semibold text-md text-l1'>Text us</p>
									<a href='sms:+15152276367' 
									className='inline-flex items-center font-medium border-0 btn text-md text-w3 group hover:text-r'>
										(515) 227-6367
											<svg
												width='16'
												height='16'
								...
								<div className='w-full'>
									<p className='p-1 font-semibold text-md text-l1'>Call instead</p>
										<a
								...
								<div className='w-full'>
									<p className='p-1 font-semibold text-md text-l1'>Send an email</p>
									<a
