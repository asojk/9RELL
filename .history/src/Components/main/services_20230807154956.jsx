			...
			<div className='flex mt-4 overflow-hidden'>
				<TranslateWrapper>
					...
					<div className='items-center container mx-auto mt-[40vh] mb-16'>
							<div className='space-y-8 md:grid md:grid-cols-3 md:gap-x-6 md:space-y-0'>
								<div className='relative group'>
									<div className='relative w-full rounded-lg cursor-pointer h-36 md:h-64'>
										<img
											...
											className='object-cover object-center w-full h-full overflow-hidden transition-all transform rounded-2xl group-hover:scale-125'
										/>
