        ...
        <div className="grid">
          ...
          <div className="first:flex min-h-[60px] flex-col-reverse">
              <select id="application" name="user_application" required value={application} onChange={(e) => setApplication(e.target.value)}
                className="text-base font-thin tracking-wide normal-case bg-transparent rounded-lg outline-none cursor-pointer w-fit min-w-[8rem] btn border-b1 text-w4 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0">
