...
function GettingStarted({ executeScroll }) {
  ...
  <section className="relative z-1 max-w-[85rem] px-4 py-24 mx-auto">
    <div className="container px-5 py-12 mx-auto rounded-2xl">
      <div className="mb-8 shadow-nimble bg-d7 rounded-2xl ">
    ...
    <div className="relative p-4 m-auto ml-8 w-146">
          ...
          <div className="relative">
            <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}
              ...
              <a onClick={() => setIsOpen(true)}
                className="inline-flex mt-2 font-black cursor-pointer text-md shadow-nimble text-r">Find out
      ...
      <div className="relative p-4 pb-8 m-auto ml-8 lg:ml-0 w-146">
          ...
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.9 }} transition={{ duration: 0.225, ease: "easeIn" }} className="m-2">
            <button onClick={executeScroll} className="block w-full px-12 py-3 text-sm font-medium rounded cursor-pointer shadow-nimble shadow-rd3 text-l1 bg-r hover:bg-rd1 focus:outline-none focus:ring active:bg-r sm:w-auto">Schedule your free estimate</button>
            </motion.button>
        </div>
      </div>
    </div>
