		...
		<div className='flex flex-col w-full my-4 bg-none'>
			<div className='flex flex-col w-full bg-none'>
				...
				<ReactDatePicker
					...
					className='w-1/2 p-2 mt-2 mb-4 text-white rounded-lg cursor-pointer border-rA bg-rd2 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm'
				/>
