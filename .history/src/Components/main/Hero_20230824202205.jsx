							...
							<div className='w-4/6'>
								...
								<motion.button
									...
									<button
										...
										className='px-8 py-2 mb-4 font-medium rounded-lg cursor-pointer text-l1 shadow-nimble bg-r hover:bg-rd2 focus:outline-none focus:ring-2 focus:ring-rd2 active:bg-rl'>
