				...
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-2 md:grid-cols-[1fr,2fr,1fr]'>
						...
						<div className='w-full p-4 lg:pb-8 rounded-2xl'>
							...
							<div className='relative w-32 overflow-hidden group'>
								<div className='absolute w-20 h-20 -right-12 -bottom-4 group'>
									<FiMessageCircle />
								</div>
								<div className='w-full'>
									<p className='mb-2 text-lg font-semibold text-l3 group'>Text us</p>
									<a href='sms:+15152276367'
										className='items-center mt-2 text-sm font-medium text-w3 gap-x-2 group-hover:text-r'>
										(515) 227-6367
