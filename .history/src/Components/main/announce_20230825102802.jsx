...
const Announcement = () => {
	...
	return (
		<div className='px-2 py-1 lg:p-4 text-black bg-yw border border-w3 shadow-sm rounded-2xl sm:px-6 lg:px-8 fixed bottom-0 z-[999] w-10/12 grid grid-rows-2 lg:grid-rows-3'>
