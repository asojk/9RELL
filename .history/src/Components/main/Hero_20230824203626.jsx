...
function Hero({ executeScroll }) {
	...
	return (
		<>
					...
					<div className='grid grid-cols-2 gap-4 lg:gap-8 md:grid-cols-3'>
						...
						<div className='w-full p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6 justify-center'>
							...
							<div className='w-4/6'>
								...
								<motion.button
									...
									<a className='inline-flex p-2 mt-2 text-sm font-black cursor-pointer text-r'>
										Find out
										<svg
											fill='none'
											stroke='currentColor'
						...
						<div className='w-full p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6'>
							...
							<div className='w-4/6'>
								...
								<div className='flex flex-wrap mt-8 mb-4 text-center'>
								<motion.button
									whileHover={{ scale: 1.05 }}
									whileTap={{ scale: 0.9 }}
									transition={{ duration: 0.225, ease: 'easeIn' }}
										onClick={executeScroll}
										className='px-2 py-2 text-sm font-black rounded-lg cursor-pointer text-l1 shadow-nimble bg-rd1 hover:bg-r focus:outline-none focus:ring-1 focus:ring-rd2 active:bg-rl'>
			...
			<section className='max-w-[85rem] px-4 pb-12 sm:px-4 lg:px-8 mx-auto flex flex-wrap items-center lg:flex-nowrap justify-center'>
