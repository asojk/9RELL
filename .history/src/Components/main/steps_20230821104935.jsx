    ...
    <section className="relative text-l1 body-font">
      <div className="container flex flex-wrap px-5 py-24 mx-auto">
        <div className="relative flex pt-10 pb-20 mx-auto sm:items-center md:w-2/3">
          ...
          <div className="relative z-10 inline-flex items-center justify-center flex-shrink-0 w-6 h-6 mt-10 text-sm font-medium text-white bg-[var(--red-dark-1)] rounded-full sm:mt-0 title-font">
            1
          </div>
