    ...
    <>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl mx-auto lg:max-w-6xl">
          <div className="grid items-center gap-4 mt-12 lg:grid-cols-[4fr,2fr] lg:gap-8 bg-d7 rounded-2xl">
            {/* Card */}
                ...
                <div className="flex items-center justify-center w-full">
                  <div>
                    ...
                    <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
                      ...
                      <div className="grid">
                        <div className="first:flex min-h-[60px] flex-col-reverse justify-center px-8 py-2 shadow-sm focus-within:shadow-inner relative z-0 group">
                          <ReactDatePicker
                            ...
                            className="font-thin tracking-wide bg-transparent rounded-lg outline-none cursor-pointer w-fit btn placeholder-l3 border-b1 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                          />
                        </div>
                      </div>
                      <div className="grid">
                        <div className="pt-8 pr-4 md:pt-0 first:flex min-h-[60px] flex-col-reverse justify-center px-2 shadow-sm focus-within:shadow-inner relative z-0 group">
                          <select
                            id="building_type"
                            name="user_buildingType"
                            required
                            className="mb-12 text-base font-thin tracking-wide normal-case bg-transparent border-none rounded-lg outline-none cursor-pointer md:pl-12 w-fit btn placeholder-l3 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                            value={buildingType}
                      ...
                      <div className="grid">
                      <div className="pt-8 md:pt-0 first:flex min-h-[60px] flex-col-reverse justify-center md:pr-12 shadow-sm focus-within:shadow-inner relative z-0 group">
                          <select
                            id="application"
                            name="user_application"
                            required
                            className="pr-4 mb-12 text-base font-thin tracking-wide normal-case bg-transparent border-none rounded-lg outline-none cursor-pointer w-fit btn placeholder-l3 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                            value={application}
            ...
            <div className="pl-6 md:pl-0">
              {/* Icon Block */}
              <div className="flex py-6 pr-4 text-right">
                <div>
