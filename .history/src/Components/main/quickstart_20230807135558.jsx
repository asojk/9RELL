...
function GettingStarted({executeScroll}) {
  ...
  return (
			...
			<div className='container flex flex-wrap items-center px-16 pt-8 pb-4 mx-auto my-32 rounded-2xl'>
				<div className='flex flex-wrap -m-4'>
					<div className='p-2 md:w-1/2'>
						<div className='flex flex-col h-full p-8 pb-2 rounded-2xl bg-d9/90'>
							<div className='flex items-center mb-3'>
								...
								<h2 className='text-lg font-bold align-text-bottom bg-r xl:font-extrabold text-l1 xl:text-2xl md:text-lg'>Does Grell Service my Area?</h2>
							</div>
          ...
          <div className='p-2 md:w-1/2'>
						<div className='flex flex-col p-8 rounded-2xl h-fit bg-d9/90'>
							<div className='flex items-center mb-3'>
								<div className='inline-flex items-center justify-center flex-shrink-0 w-8 h-8 mr-3 rounded-full bg-r text-l1'>
									<svg fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} className='w-5 h-5' viewBox='0 0 24 24'>
