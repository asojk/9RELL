				...
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-2 md:grid-cols-[1fr,2fr,1fr]'>
						...
						<div className='w-full p-4 lg:pb-8 rounded-2xl'>
							...
							<div className='flex items-center justify-end pr-6 lg:py-2 lg:pr-0 gap-x-4 lg:gap-x-7 text-r'>
								<FiMessageCircle />
								<div>
							...
							<div className='flex pr-6 lg:py-2 lg:pr-0 gap-x-2 lg:gap-x-7 text-r'>
								<FiPhone />
								<div>
									<h3 className='font-semibold text-w3'>Call instead</h3>
									<a
										className='items-center mt-4 text-sm font-medium text-w3 gap-x-2 hover:text-r'
