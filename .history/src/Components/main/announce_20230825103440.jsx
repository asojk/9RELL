...
const Announcement = () => {
	...
	return (
		<div className='px-2 lg:p-4 text-black bg-y5 border border-b3 shadow-nimble rounded-2xl fixed bottom-2 z-[999] grid grid-rows-2 lg:grid-rows-3'>
			<span className='pt-1 font-black text-center font-xs md:font-sm lg:font-md ring-1'>The New Look of Grell</span>
