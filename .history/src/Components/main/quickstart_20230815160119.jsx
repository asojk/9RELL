...
function GettingStarted({ executeScroll }) {
  ...
  return (
<section className="max-w-[85rem] lg:px-12 mx-auto">
<div className="max-w-2xl mx-auto lg:max-w-6xl">
<div className="grid grid-cols-[1fr,2fr] grid-rows-2 gap-2 rounded-2xl">
    ...
    <div >
    <div className="relative p-4 m-auto w-146 bg-d7 rounded-2xl">
    ...
    <div className="grid col-start-2 row-span-1">
      <div className="relative p-4 m-auto w-128 bg-d7 rounded-2xl">
				<div className="w-full h-full">
					<div className="flex flex-col justify-between h-full">
