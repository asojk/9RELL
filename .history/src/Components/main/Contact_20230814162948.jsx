...
const Contact = ({ BuildingType, Application }) => {
  ...
  <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div className="flex items-center justify-center w-full">
      ...
      <div className="first:flex min-h-[60px] flex-col-reverse justify-center mx-8 py-2 relative lg:mb-8 z-1">
        
            <label htmlFor="date" className="px-4 font-thin tracking-wide text-l5">If you'd like, select a day that works best for an inspection</label>
              ...
              className="lg:mb-8 mt-2 text-base font-thin tracking-wide normal-case bg-transparent rounded-lg outline-none cursor-pointer w-[12rem] btn border-b1 text-w4 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"></ReactDatePicker>
          ...
          <div className="first:flex min-h-[60px] flex-col-reverse">
              <select id="application" name="user_application" required value={application} onChange={(e) => setApplication(e.target.value)}
                ...
                <option value="I'm Not Sure">Not Sure</option></select></div></div></div>
                    ...
                    <label htmlFor="notes" className="px-4 font-thin tracking-wide text-l5">If you'd like, select a day that works best for an inspection</label>
                      <input
                        type="text"
                        name="user_notes"
                        id="notes"
                      ...
                      >
                        Do you have a special request? If so, or if you'd like to provide any additional information, please do so here.
                      </label>
                    </div>
