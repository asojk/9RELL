...
const ServiceCards = () => {
  ...
  <section className="relative z-1 max-w-[85rem] px-4 py-24 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <Link to="/new-roof">
          <div className="relative w-1/3 p-0 m-auto cursor-pointer lg:p-4 shadow-nimble lg:w-64 bg-d7 rounded-2xl group hover:bg-d6">
            <div className="w-full h-full text-center">
              <div className="flex flex-col justify-between lg:h-full">
                ...
                <p className="py-2 text-base font-thin lg:px-6 text-l1">
          ...
          <Link to="/repair">
          <div className="relative w-2/3 p-2 m-auto cursor-pointer lg:p-4 shadow-nimble lg:w-64 bg-d7 rounded-2xl group hover:bg-d6">
            <div className="w-full h-full text-center">
