...
function Hero({ executeScroll }) {
	...
	return (
		...
		<div className="py-16">
			...
			<div className='w-full pb-8 p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6 justify-center'>
							<img
								alt='moto'
