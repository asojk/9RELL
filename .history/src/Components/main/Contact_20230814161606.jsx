        ...
        <div className="grid">
          ...
          <div className="first:flex min-h-[60px] flex-col-reverse justify-center mx-8 py-2 relative z-1">
            <label htmlFor="date" className="px-4 font-thin tracking-wide text-l5">If you'd like, select a day that works best for an inspection</label>
              ...
              className="mt-2 mb-8 font-thin tracking-wide text-center bg-transparent border rounded-lg outline-none w-[12rem] cursor-pointer border-b1 text-l5 bg-d7 focus:border-transparent focus:outline-none focus:ring-0"></ReactDatePicker>
