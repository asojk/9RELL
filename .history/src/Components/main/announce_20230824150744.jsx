...
const Announcement = () => {
  ...
  return (
		<div className='px-4 py-3 text-black bg-yw border border-w3 shadow-nimble sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 fixed bottom-0 z-[999] w-full'>
			<span className='hidden w-full font-black md:block sm:p-0 md:p-2'>The New Look of Grell {' '}</span>
			<span className='mr-4 font-medium text-center sm:text-left'>
