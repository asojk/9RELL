...
const Testis = () => {
  ...
  <label for="expanded" role="button">read more</label>
					...
					<span className='px-4 pt-4 transition-all duration-500 line-clamp-6 lg:line-clamp-3 group group-active:line-clamp-none text-l2'>{quote.description}<button className="btn group read-more">...</button></span>
