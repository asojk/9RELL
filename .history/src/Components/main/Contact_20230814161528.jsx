    ...
    <div className="flex items-center justify-center w-full">
      ...
      <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
        ...
        <div className="grid">
          ...
          <div className="first:flex min-h-[60px] flex-col-reverse justify-center mx-8 py-2 relative z-1">
            <label htmlFor="date" className="px-4 font-thin tracking-wide text-l5">If you'd like, select a day that works best for an inspection</label>
              ...
              className="mt-2 mb-8 font-thin tracking-wide text-center bg-transparent border rounded-lg outline-none cursor-pointer border-b1 text-l5 bg-d7 focus:border-transparent focus:outline-none focus:ring-0"></ReactDatePicker>
          ...
          <div className="first:flex min-h-[60px] flex-col-reverse">
              <select id="application" name="user_application" required value={application} onChange={(e) => setApplication(e.target.value)}
                className="text-base font-thin tracking-wide normal-case bg-transparent rounded-lg outline-none cursor-pointer w-fit min-w-[12rem] btn border-b1 text-w4 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0">
