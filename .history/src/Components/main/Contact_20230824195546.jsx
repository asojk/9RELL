		...
		<>
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-start lg:flex-nowrap'>
						...
						<div className='w-full p-4 lg:pb-8 rounded-2xl'>
							...
							<div className='relative w-1/3 overflow-hidden lg:w-full group'>
								...
								<div className='w-full'>
									<p className='mt-2 font-semibold text-md text-l3'>Text us</p>
									<a
							...
							<div className='relative w-1/3 overflow-hidden lg:w-full group'>
								...
								<div className='w-full'>
									<p className='mt-2 font-semibold text-md text-l3'>Call instead</p>
              ...
              <div className='relative w-1/3 overflow-hidden lg:w-full group'>
								...
								<div className='w-full'>
									<p className='mt-2 text-base font-semibold text-l3'>Send an email</p>
									<a className='inline-flex items-center text-sm font-medium text-w3 hover:text-r'
