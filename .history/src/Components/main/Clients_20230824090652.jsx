...
const Clients = () => {
  return (
		<>
			<section className='relative z-1 max-w-[85rem] px-4 pb-12 lg:pb-24 mt-4 mx-auto'>
				<div className='container px-5 mx-auto'>

						<span className='relative z-10 pb-4 head rounded-2xl md:-mt-16'>Current & Former Clients</span>
