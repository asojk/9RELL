  ...
  return (
          ...
          <div className='p-2 md:w-1/2'>
              ...
              <p className='pb-6 text-lg leading-relaxed text-l4'>
                ...
                <button onClick={executeScroll} className='relative inline-flex items-center justify-center px-2 py-3 m-1 mt-6 text-lg cursor-pointer btn bg-l1 border-l1 hover:border-y2 text-d9 hover:bg-l2'>Schedule your free estimate</button>
								</motion.button>
							</div>
						</div>
					</div>
