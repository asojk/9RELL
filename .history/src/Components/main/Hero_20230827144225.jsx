	...
	return (
		...
		<div className="py-16">
			<div className="px-6 m-auto text-l1 xl:container md:px-12 xl:px-6">
				...
				<div className="grid grid-cols-1 grid-rows-2 gap-8 place-content-center lg:grid-cols-2">
			<div className='w-full lg:w-2/3 p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6 justify-center'>
							<img
								alt='moto'
						...
						<div className='w-full lg:w-1/3 p-4 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6'>
							<img
								alt='moto'
