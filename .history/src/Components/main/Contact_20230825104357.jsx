			...
			<section className='max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 mx-auto flex flex-wrap items-start lg:flex-nowrap justify-center'>
				<div className='p-4'>
					<div className='grid grid-cols-1 gap-2 lg:grid-cols-[1fr,1fr,1fr]'>
						...
						<div className='w-full p-4 lg:pb-8 md:p-12'>
							...
							<div className='grid xs:grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 lg:gap-4'>
								<div className='w-full'>
									<p className='pl-8 mt-2 font-semibold text-md text-l3'>Text us</p>
									<a
										href='sms:+15152276367'
										className='inline-flex items-center font-medium text-md text-w3 hover:text-r'>
										(515) 227-6367
										<svg
											width='16'
											height='16'
							...
							<div className='w-full'>
								<p className='pl-8 mt-2 font-semibold text-md text-l3'>Call instead</p>
								<a
									className='inline-flex items-center font-medium text-md text-w3 hover:text-r'
						...
						<div className='w-full'>
							<p className='pl-8 mt-2 font-semibold text-md text-l3'>Send an email</p>
