        ...
        <div className="">
          ...
          >
            <button
              ...
              className="relative inline-flex items-center justify-center m-1 mt-6 cursor-pointer lg:text-lg lg:px-2 lg:py-3 btn bg-r border-l1 hover:border-y2 text-l1"
            >
