        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="relative w-2/3 p-4 m-auto shadow-lg cursor-pointer lg:w-64 bg-d7 rounded-2xl group group-hover:bg-d6">
            <div className="w-full h-full text-center">
              ...
              <span className="rounded-lg bg-gradient-to-br from-rd3 from-10% to-rA p-3 text-8xl text-center grid grid-rows-2 text-l1 shadow-rd3 transition-all duration-300">
                <RiCompasses2Line />
