...
const Contact = ({ BuildingType, Application }) => {
  ...
  <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div className="max-w-2xl mx-auto lg:max-w-6xl">
      ...
      <div className="grid items-center gap-4 lg:grid-cols-[4fr,2fr] lg:gap-8">{/* Card */}
        <div className="flex flex-col p-2 rounded-2xl sm:p-6 lg:p-4">
          <form ref={form} onSubmit={sendEmail} className="shadow-nimble bg-d7 rounded-2xl">{/* Grid */}
      ...
      <div className="first:flex min-h-[60px] flex-col-reverse justify-center mx-8 relative lg:mb-8 z-1 items-center content-center">
        ...
        <div className="grid grid-cols-2 gap-8 py-8">
          ...
          <div className="relative z-0 pl-8 mt-12 mb-8 lg:mt-4 group">
            <label htmlFor="notes" className="font-thin tracking-wide text-l5">
              ...
              <input type="text" name="user_notes" id="notes" value={notes} onChange={(e) => setNotes(e.target.value)}
                ...
                <div className="grid pr-8">
                  <button type="submit" className="flex px-5 py-2 m-6 font-bold tracking-widest text-center uppercase transition-all duration-500 rounded-md justify-self-start justify-items-center w-fit text-r hover:text-l1 animate-btn-anim-1 hover:bg-r hover:shadow-xl">SEND</button></div>
              </div></div>
              </form>
            </div>
            {/* End Card */}
            ...
            <div className="lg:ml-6 md:pl-0 bg-d7 shadow-sm rounded-2xl md:max-w-[300px] lg:max-w-[300px]">
              ...
              <div className="flex items-center justify-end py-6 pr-12 gap-x-7 text-r"><FiMessageCircle /><div>
                <h3 className="font-semibold text-w3">Text us</h3>
                <a href="sms:+15152276367" className="items-center mt-2 text-sm font-medium text-w3 gap-x-2 hover:text-r">(515) 227-6367
