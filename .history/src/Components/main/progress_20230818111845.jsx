...
const NameInput = () => {
    ...
    className="block px-3 py-2 overflow-hidden border rounded-md shadow-nimble bg-d7 border-b3 focus-within:border-rd3 focus-within:ring-1 focus-within:ring-r">
  ...
  return (
    <div className="px-4 py-14">
      <div className="w-full max-w-2xl p-8 mx-auto rounded-2xl bg-d7 shadow-nimble">
        ...
        <div className="h-48 p-2 my-6 border-2 rounded-lg">
