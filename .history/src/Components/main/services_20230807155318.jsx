		...
		<>
			<div className='flex mt-4 overflow-hidden'>
				<TranslateWrapper>
					...
					<div className='items-center container mx-auto mt-[40vh] mb-16'>
							<div className='space-y-8 md:grid md:grid-cols-3 md:gap-x-6 md:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0'>
								<div className='relative group'>
									<div className='relative w-full overflow-hidden rounded-lg cursor-pointer h-36 md:h-64'>
										<img
                    ...
                    <div className='flex flex-row items-center gap-2 px-2 py-2 -mr-2 rounded-2xl hover:bg-r bg-d9/90'>
                          ...
                          New Construction</span>
								...
								<div className='relative group'>
								<div className='relative w-full rounded-lg cursor-pointer h-36 md:h-64'>
										<img
