...
const SteppedProgress = () => {
  ...
  return (
    <div className="px-4 bg-d9 py-14">
      <div className="w-full max-w-2xl p-8 mx-auto rounded-md shadow-blue bg-d7">
        <Steps numSteps={numSteps} stepsComplete={stepsComplete} />
        <div className="h-48 p-2 my-6 border-2 border-gray-200 border-dashed rounded-lg bg-d7"></div>
