        ...
        <div className="max-w-2xl mx-auto lg:max-w-6xl">
          <div className="grid items-center gap-4 mt-12 lg:grid-cols-2 lg:gap-8 bg-d7 rounded-2xl">
            ...
            <div className="pl-8 divide-y divide-d1">
              ...
              {/* Icon Block */}
              <div className="flex py-6 lg:py-8 gap-x-7 text-w3">
                <FiPhone />
                <div>
                  <h3 className="font-semibold text-w3">Call Instead</h3>
                  <a
                    className="inline-flex items-center mt-2 text-sm font-medium text-w4 gap-x-2 hover:text-r"
              ...
              <div className="flex py-6 lg:py-8 gap-x-7 text-w3">
                <FiSend />
                <div>
                  <h3 className="font-semibold text-w3">Contact us by email</h3>
                  <p className="mt-1 text-sm text-w4">
