...
const Clients = () => {
  return (
		<>
			<section className='relative z-1 max-w-[85rem] border border-b3 pb-4  -mt-12 mx-auto bg-gradient-to-b from-d6 to-d7 shadow-nimble'>
				<div className='container px-5 mx-auto'>

						<span className='relative z-10 pt-2 -mx-4 text-xs italic text-yw'>Current & Former Clients</span>
