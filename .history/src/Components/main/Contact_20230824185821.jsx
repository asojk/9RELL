...
const Contact = ({ BuildingType, Application }) => {
  ...
  return (
    ...
    </div><section className='relative max-w-[85rem] px-2 pt-16 lg:px-12'>
        <div className='p-4'>
          <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
            <h1 className='relative p-4 h1'>Getting Started</h1>
            <div className='w-full p-4 lg:pb-8 rounded-2xl border-[1px] border-b3 relative overflow-hidden group shadow-nimble bg-gradient-to-tl from-d7 to-d6'>
