                ...
                <div className="flex items-center justify-center w-full">
                  <div>
                    ...
                    <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
                      ...
                      <div className="grid">
                        <div className="first:flex min-h-[60px] flex-col-reverse justify-center px-8 b-12 py-2 shadow-sm focus-within:shadow-inner relative z-0 group">
                          <ReactDatePicker
                            selected={date}
                            ...
                            className="mb-12 font-thin tracking-wide bg-transparent rounded-lg outline-none cursor-pointer w-fit btn placeholder-l3 border-b1 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                          />
                        </div>
                      </div>
                      <div className="grid">
