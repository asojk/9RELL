...
const DateInput = () => {
    ...
    return (
      <div className="flex flex-col w-full">
        <div className="flex flex-col w-full">
          <p className="text-xs font-medium text-l1">If you'd like, select a day that works best for an inspection</p>
          </div>

    <label htmlFor="date"
    className="block px-3 py-2 overflow-hidden rounded-md bg-d7 focus-within:border-rd3 focus-within:ring-1 focus-within:ring-r">
