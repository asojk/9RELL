							...
							<SwiperSlide key={index}>
								...
								<div>
									<input type='checkbox' id='expanded'>
										<p>
											Hey, don't cut me off like that. I want to speak my mind and don't appreciate being put into a
											box.
										</p>
								...
								<span className='px-4 pt-4 transition-all duration-500 line-clamp-6 lg:line-clamp-3 group group-active:line-clamp-none text-l2'>
									{quote.description}
									<button className='btn group read-more'>...</button>
								</span>
								<h6 className='flex flex-row items-center justify-center gap-4 mt-4 text-lg font-semibold leading-none'>
									{quote.icon}
									{quote.name}
								</h6>
