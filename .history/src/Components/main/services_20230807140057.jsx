		...
		<>
			<div className='flex mt-4 overflow-hidden'>
				<TranslateWrapper>
					...
					<div className='items-center mx-12 mt-[40vh] rounded-2xl max-w-6xl mb-16 p-2'>
							<div className='lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0 rounded-2xl'>
								<div className='relative group'>
									<div className='relative w-full h-64 max-w-3xl overflow-hidden rounded-lg cursor-pointer sm:h-36'>
										<img
