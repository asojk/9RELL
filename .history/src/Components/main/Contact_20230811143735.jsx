              ...
              <form ref={form} onSubmit={sendEmail} className="">
                ...
                <div className="flex items-center justify-center w-full">
                  <div>
                    ...
                    <div className="grid max-w-3xl gap-2 px-8 py-10 rounded-md sm:grid-cols-2">
                      ...
                      <div className="grid">
                        <div className="first:flex min-h-[60px] flex-col-reverse justify-center px-8 py-2 shadow-sm focus-within:shadow-inner relative z-0 group">
                          <ReactDatePicker
                            ...
                            className="mb-8 font-thin tracking-wide bg-transparent rounded-lg outline-none cursor-pointer w-fit btn placeholder-l3 border-b1 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0"
                          />
                        </div>
                      </div>


                      <div className="grid my-2 lg:mb-16">
                      <div className="first:flex min-h-[60px] flex-col-reverse">
                        <select id="building_type" name="user_buildingType" required value={buildingType}
                            ...
                            className="text-base font-thin tracking-wide normal-case bg-transparent border-none rounded-lg outline-none cursor-pointer w-fit btn placeholder-l3 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0">
                      ...
                      <div className="first:flex min-h-[60px] flex-col-reverse">
                          <select id="application" name="user_application" required value={application} onChange={(e) => setApplication(e.target.value)}
                            className="items-start text-base font-thin tracking-wide normal-case bg-transparent border-none rounded-lg outline-none cursor-pointer place-items-start justify-items-start w-fit btn placeholder-l3 text-l5 bg-d7 peer focus:border-transparent focus:outline-none focus:ring-0">
                    ...
                    <div className="relative z-0 w-3/4 px-12 mt-12 mb-8 md:mt-4 group">
                      <input
                        type="text"
                        name="user_notes"
                        id="floating_notes"
