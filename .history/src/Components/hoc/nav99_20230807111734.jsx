      ...
      <Menu allowHover open={isMenuOpen} handler={setIsMenuOpen}>
        <MenuHandler>
          <Typography as="a" href="#" className="font-normal">
            <MenuItem className="items-center hidden gap-2 text-l1 text-sm md:text-[1rem] lg:text-2cl lg:flex lg:rounded-full">
...
function NavList() {
  return (
    <ul className="flex flex-col gap-4 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center">
      <NavListMenu />
  ...
  return (
    <Navbar className="fixed z-10 items-center p-2 py-4 mx-auto border-0">
      ...
      <Link to='/'>
        ...
        <div className="absolute hidden top-1/4 left-3/4 -translate-x-2/4 -translate-y-2/4 lg:block">
          <NavList />
        </div>
        <IconButton
          size="sm"
