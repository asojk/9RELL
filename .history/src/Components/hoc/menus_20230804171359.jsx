  ...
  return (
    ...
    >
      ...
      <SectionTitle text="Services" />
        <MenuLink to='/repair' text='Repair' icon={<ToolsI />} />
        <MenuLink to='/replacement' text='Replace' icon={<ReplaceI />} />
        <MenuLink to='/new-roof' text='Building New' icon={<NewI />} />
        <MenuLink to='/maintenance' text='Maintenance' icon={<MaintenanceI />} />
      </div>
      <div className="flex flex-col w-1/3 gap-2">
        <SectionTitle text="More Info" />
          <MenuLink to='/warranty' text='Warranty' icon={<WarrantyI />} />
          <MenuLink to='/products' text='Products' icon={<CgMenuRoundI />} />
          <MenuLink to='/faq' text='FAQ' icon={<QuestionI />} />
      </div>
      <div className="flex flex-col w-1/3 gap-2">
        <SectionTitle text="About" />
          <MenuLink to='/about' text='About' icon={<UserIcon />} />
          <MenuLink to='/projects' text='Projects' icon={<FlashIcon />} />
          <MenuLink to='/press' text='Press' icon={<ActivityIcon />} />
      </div>
    </motion.div>
  );
};
