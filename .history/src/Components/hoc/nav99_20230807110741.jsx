  ...
  return (
    <React.Fragment>
      <Menu allowHover open={isMenuOpen} handler={setIsMenuOpen}>
        <MenuHandler>
          <Typography as="a" href="#" variant="small" className="font-normal">
            <MenuItem className="items-center hidden gap-2 text-l1 lg:flex lg:rounded-full">
              <Square3Stack3DIcon className="h-[24px] w-[24px]" /> Pages{" "}
              <ChevronDownIcon
                strokeWidth={2}
      ...
      <MenuItem className="flex items-center gap-2 text-l1 lg:hidden">
        <Square3Stack3DIcon className="h-[24px] w-[24px]" /> More Info{" "}
      </MenuItem>
