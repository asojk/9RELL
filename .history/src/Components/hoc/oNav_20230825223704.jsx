  ...
  return (
		<>
			<nav className='fixed w-full flex items-center md:px-[5vw] xl:px-[10vw] py-4 z-[99]'>
				<div className='w-1/5 md:w-1/3 pl-8 z-[99]'>
					<div>
				...
				<div className='items-center w-3/5 text-center bg-transparent md:w-1/3 place-content-center'>
					<Link to='/'>
						<img
				...
				<div className='items-end justify-end hidden w-1/5 md:w-1/3 md:block'>
					<Cbuttons className='' />
				</div>
			</nav>
		</>
