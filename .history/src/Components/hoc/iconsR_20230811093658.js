...
const CgMenuRoundI = () => (
	<IconContext.Provider value={{color: 'var(--y)', className: 'iconR', size: '24', cursor: 'pointer'}}>
		<CgMenuRound />
...
const ToolsI = () => (
	<IconContext.Provider value={{color: 'var(--y)', className: 'iconR', size: '24'}}>
		<BsTools />
	</IconContext.Provider>
);

const NewI = () => (
	<IconContext.Provider value={{color: 'var(--b)', className: 'iconR', size: '24'}}>
		<VscNewFile />
	</IconContext.Provider>
);
...
const QuestionI = () => (
	<IconContext.Provider value={{color: 'var(--g)', className: 'iconR', size: '24'}}>
		<FaQuestionCircle />
	</IconContext.Provider>
);
