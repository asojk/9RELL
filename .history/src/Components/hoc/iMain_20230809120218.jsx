...
const iActivity = () => (
	<svg data-name='Iconly/Curved/Activity' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'>
		<g fill='none' stroke='var(--m3)' strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit={10} strokeWidth={1.5}>
...
const iMenuRound = () => (
	<IconContext.Provider value={{color: 'var(--m3)', className: 'iMain', size: '24', cursor: 'pointer'}}>
		<CgMenuRound />
...
const iProfile = () => (
	<IconContext.Provider value={{color: 'var(--m3)', className: 'iMain', size: '24'}}>
		<CgProfile />
	</IconContext.Provider>
);
