      ...
      {isOpen && (
        ...
        <nav className="flex flex-col flex-wrap w-full p-6">
          ...
          <div className="w-full pt-6 pb-2 pl-4 text-sm lg:text-sm md:pt-8 text-w4">
            ...
            <div className='flex items-center justify-between w-full pt-6 pb-2 text-sm lg:text-base md:pt-8 text-w4'>
            <div className="absolute grid grid-cols-2 gap-4 bottom-8">
              <div className='col-span-1'>
              <button onClick={onClose} className="text-l1 btn">Close</button></div>
              <div className='col-start-2'>
              <Link to="/">
                <button className="grid grid-cols-2 pl-2 ml-2 btn -pr-2 text-l1">
                  <FiHome/>
