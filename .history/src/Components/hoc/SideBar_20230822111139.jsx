  ...
  <nav className="flex flex-col flex-wrap justify-center w-full px-6 lg:px-8">
    ...
    <motion.div variants={menuVariants}>
      ...
      <ul className='flex flex-col justify-center h-full gap-2 z-[99]'>
        ...
        <div className="hidden w-full pt-6 pl-2 text-sm lg:text-sm md:pt-8 text-w4 md:display-block">Information</div>
        ...
        <div className="hidden w-full pt-6 pl-2 text-sm lg:text-sm md:pt-8 text-w4 md:display-block">About</div>
