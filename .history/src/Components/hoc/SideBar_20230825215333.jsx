		...
		<AnimatePresence>
			...
			{isOpen && (
				<motion.div
					...
					animate='open'
					exit='closed'
					className='fixed top-0 left-0 h-screen py-4 overflow-auto border-r-2 w-content bg-gradient-to-l from-d7 to-d8 via-d8 rounded-r-lg border-b3 z-[99]'>
					<nav className='grid w-full h-full px-6 place-content-center lg:px-8'>
						<motion.div variants={menuVariants}>
							<ul className='flex flex-col h-fit justify-items-center gap-4 bg-gradient-to-l from-d7 to-d8 via-d8 rounded-r-lg border-b3 z-[99] '>
