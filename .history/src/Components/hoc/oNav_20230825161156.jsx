						...
						<button onClick={() => setSidebarOpen(true)} className='relative group'>
							<div className='relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] md:w-[65px] md:h-[65px] transform transition-all bg-rd1 ring-0 ring-rd3 hover:ring-8 group-focus:ring-4 ring-opacity-30 duration-200 shadow-nimble'>
								<div className='flex flex-col justify-between w-[20px] h-[20px] md:w-[31px] md:h-[31px] transform transition-all duration-500 origin-center overflow-hidden'>
									<div className='bg-d9 h-[2px] w-7 md:h-[4px] md:w-9 transform transition-all duration-500 group-focus:rotate-45 -translate-x-1' />
									<div className='bg-d9 h-[2px] w-7 md:h-[4px] md:w-9 rounded transform transition-all duration-500 ' />
									<div className='bg-d9 h-[2px] w-7 md:h-[4px] md:w-9 transform transition-all duration-500 group-focus:-rotate-45 -translate-x-1' />
								</div>
							</div>
						</button>
