      ...
      <nav className="fixed w-full flex items-center px-2 md:px-[10vw] xl:px-[20vw] py-4 z-[99]">
        <div className="w-1/3 pl-8 z-[99]">
          <button onClick={() => setSidebarOpen(true)}
            className="w-12 h-12 p-2 transition-colors duration-200 border rounded-lg cursor-pointer shadow-nimble text-l1 lg:w-16 lg:h-16 bg-d6 shadow-d9 border-b3 hover:bg-d6 hover:text-r">
