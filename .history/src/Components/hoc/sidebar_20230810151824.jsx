      ...
      {isOpen && (
        ...
        >
          <nav className="flex flex-col flex-wrap w-full p-6">
            <div className='absolute top-0 right-0 bg-d7 opacity-30'>
          <button
                    onClick={onClose}
                    type="button"
                    className="inline-flex items-center justify-center w-8 h-8 gap-2 transition border rounded-2xl text-l1 border-d5 hover:text-l5"
