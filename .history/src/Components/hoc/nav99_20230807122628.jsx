...
function NavList() {
  return (
    ...
    <ul className="flex flex-wrap gap-8 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center">
      <NavListMenu />
      ...
      >
                <button className='flex items-center gap-3 py-2 cursor-pointer md:py-4 rounded-xl'>
        <MenuItem className="">
