    ...
    <Navbar className="fixed z-10 items-center p-2 py-4 mx-auto border-0">
      ...
      <Link to='/'>
        ...
        <div className="w-1/3">
          <div
            aria-label="dropdown"
            className="relative w-[340px] text-sm font-medium"
          >
            <div className="flex items-center justify-between w-full p-3 border border-blue-500 rounded cursor-pointer">
              <span className="pointer-events-none">Option A</span>
      ...
      <MobileNav open={isNavOpen} className="p-12 m-4 w-fit rounded-xl bg-d9/70">
        <NavList />
      </MobileNav>
    </Navbar>
  );
