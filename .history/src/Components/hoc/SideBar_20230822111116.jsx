  ...
  <nav className="flex flex-col flex-wrap justify-center w-full px-6 lg:px-8">
    ...
    <motion.div variants={menuVariants}>
      ...
      <ul className='flex flex-col justify-center h-full gap-2 z-[99]'>
        <div className="w-full pt-6 pl-2 text-sm lg:text-sm md:pt-8 text-w4 display-none md:display-block">Services</div>
        ...
        <div className="w-full pt-6 pl-2 text-sm lg:text-sm md:pt-8 text-w4 display-none md:display-block">Information</div>
        ...
        <div className="w-full pt-6 pl-2 text-sm lg:text-sm md:pt-8 text-w4 display-none md:display-block">About</div>
    ...
    <div className="flex items-baseline justify-center w-full pt-8">
      ...
      <Link to="/" onClick={onClose}><button type="button" className="p-3 md:mt-6 btn border-d5 text-l1">
