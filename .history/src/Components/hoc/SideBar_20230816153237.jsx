...
<AnimatePresence> {isOpen && (
  <motion.div ref={node} variants={sidebarVariants} initial="closed" animate="open" exit="closed"
    className="fixed top-0 left-0 z-50 content-center py-12 overflow-auto text-base border-r-2 h-fit w-42 lg:w-64 bg-gradient-to-r from-d7 to-d6 rounded-r-2xl text-l1 border-b3">
