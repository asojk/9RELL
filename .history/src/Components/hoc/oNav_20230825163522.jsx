				...
				<div className='w-1/3 pl-8 z-[99]'>
					<div>
						<button onClick={() => setSidebarOpen(true)} className='relative group'>
							<div className='relative inline-flex overflow-hidden border rounded-md shadow-nimble border-b3 bg-d7 inline-block p-4 text-l1 md:text-l1 border-e-[.5px] border-b3 focus:relative hover:bg-d6'>
