  ...
  return (
    <Navbar className="fixed z-10 items-center p-2 py-4 mx-auto border-0">
      ...
      <Link to='/'>
        ...
        <MenuIcon
          onClick={toggleIsNavOpen}
          className="w-12 h-12 p-3 ml-12 bg-l1 text-d9 rounded-2xl md:invisible"
        >
        <MenuItem className="flex items-center gap-2 lg:rounded-full">
            <CgProfile className="h-[18px] w-[18px] mr-3" />
            <a className="text-l1 hover:text-r text-sm md:text-[1rem] lg:text-xl" href="tel:1-800-123-4567">1-800-123-4567</a>
          </MenuItem>
        </MenuIcon>
