...
<AnimatePresence> {isOpen && (
  <motion.div ref={node} variants={sidebarVariants} initial="closed" animate="open" exit="closed"
    className="fixed top-0 left-0 z-50 h-screen py-12 overflow-clip text-base border-r-2 w-42 lg:max-w-[80] lg:w-[25vw] bg-gradient-to-r from-d7 to-d6/95 via-d7 rounded-r-[25%] text-l1 border-b3">
