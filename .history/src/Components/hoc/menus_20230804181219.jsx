...
const MenuItem = ({to, title, icon}) => (
	<Link to={to}>
      ...
      href="#"
      rel="nofollow"
      className="flex items-center gap-4 text-lg transition-colors hover:text-r"
    >
			<button className='flex items-center px-8 py-2 cursor-pointer md:py-4 rounded-xl'>
