...
<AnimatePresence> {isOpen && (
  <motion.div ref={node} variants={sidebarVariants} initial="closed" animate="open" exit="closed"
    className="fixed top-0 left-0 z-50 h-full py-12 overflow-clip text-base border-r-2 w-42 lg:w-72 bg-gradient-to-r from-d7 to-d6 rounded-r-[20%] text-l1 border-b3">
