...
const CgMenuRoundI = () => (
	<IconContext.Provider value={{color: 'var(--y)', className: 'iconR', size: '36', cursor: 'pointer'}}>
		<CgMenuRound />
...
const ToolsI = () => (
	<IconContext.Provider value={{color: 'var(--y)', className: 'iconR', size: '36'}}>
		<BsTools />
	</IconContext.Provider>
);

const NewI = () => (
	<IconContext.Provider value={{color: 'var(--b)', className: 'iconR', size: '36'}}>
		<VscNewFile />
	</IconContext.Provider>
);
...
const ProfileI = () => (
	<IconContext.Provider value={{color: 'var(--m3)', className: 'iconR', size: '36'}}>
		<CgProfile />
	</IconContext.Provider>
);

const QuestionI = () => (
	<IconContext.Provider value={{color: 'var(--g)', className: 'iconR', size: '36'}}>
		<FaQuestionCircle />
	</IconContext.Provider>
);
