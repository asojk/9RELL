  ...
  <nav className="flex flex-col flex-wrap justify-center w-full px-6 lg:px-8">
    ...
    <div className="flex items-baseline justify-center w-full pt-8">
      <button onClick={onClose} type="button" aria-label="Toggle navigation"
        className="inline-flex items-center justify-center w-8 h-8 mr-6 transition border rounded-lg shadow-2xl text-l1 border-d5 shadow-nimble hover:text-l5">
      ...
      <Link to="/" onClick={onClose}><button type="button" className="p-3 md:mt-6 btn border-w3 shadow-nimble text-l1">
