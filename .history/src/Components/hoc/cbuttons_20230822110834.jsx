  ...
  return (
    ...
    <span className="relative inline-flex overflow-hidden border rounded-md shadow-nimble border-b3 bg-d7">
      ...
      <a href="tel:+18002089693"
        className="inline-block p-3 text-rd2 md:text-l1 border-e-[.5px] border-b3 focus:relative hover:bg-d6">
      ...
      <a href="sms:+15152276367"
        className="inline-block p-3 text-rd2 md:text-l1 focus:relative hover:bg-d6">
