...
const Contact = ({
  ...
  return (
    <div className='container px-12 pt-16 pb-16 mx-auto rounded-2xl bg-d9/90'>
      ...
      <h2 className='px-12 heading'>Get in touch</h2>
        <ul className="items-center justify-center gap-4 list-none">
          <form ref={form} onSubmit={sendEmail} className="container relative flex flex-wrap items-center max-w-3xl justify-left">
