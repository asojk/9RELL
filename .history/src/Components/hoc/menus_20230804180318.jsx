...
const Menu = () => {
  return (
    <motion.div
      ...
      className="p-6 shadow-lg bg-d6 text-l1 absolute top-[125%] left-[50%] flex w-[calc(100vw_-_48px)] max-w-lg rounded-xl"
    >
      <div className="flex flex-col w-1/3 gap-2">
      <SectionTitle text="Services" />
        <MenuItem Link to='/repair' text='Repair' icon={<ToolsI />} />
        <MenuItem Link to='/replacement' text='Replace' icon={<ReplaceI />} />
        <MenuItem Link to='/new-roof' text='Building New' icon={<NewI />} />
        <MenuItem Link to='/maintenance' text='Maintenance' icon={<MaintenanceI />} />
      </div>
      <div className="flex flex-col w-1/3 gap-2">
        <SectionTitle text="More Info" />
          <MenuItem Link to='/warranty' text='Warranty' icon={<WarrantyI />} />
          <MenuItem Link to='/products' text='Products' icon={<CgMenuRoundI />} />
          <MenuItem Link to='/faq' text='FAQ' icon={<QuestionI />} />
      </div>
      <div className="flex flex-col w-1/3 gap-2">
        <SectionTitle text="About" />
          <MenuItem Link to='/about' text='About' icon={<UserIcon />} />
          <MenuItem Link to='/projects' text='Projects' icon={<FlashIcon />} />
          <MenuItem Link to='/press' text='Press' icon={<ActivityIcon />} />
      </div>
      <div className="bottom">
        <MenuItem Link to='/' text='Home' icon={<FiHome />} />
        </div>
    </motion.div>
  );
};
