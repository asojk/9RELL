				...
				<motion.div
					...
					<nav className='flex flex-col flex-wrap justify-center w-full px-6 lg:px-8'>
						<motion.div variants={menuVariants}>
							<ul className='flex flex-col justify-center h-fit justify-items-center gap-2 z-[99]'>
						...
						<section className='flex items-center justify-around py-4 lg:py-12'>
							<button
								onClick={onClose}
								type='button'
								aria-label='Toggle navigation'
								className='relative inline-flex overflow-hidden border rounded-md shadow-nimble border-b3 bg-d7'>
								<a className=' p-3 text-l1 md:text-l1 border-e-[.5px] border-b3 focus:relative hover:bg-d6 inline-flex items-center text-sm gap-x-2'>
									<svg className='w-4 h-4 lg:w-8 lg:h-8' fill='#f3f3f1' viewBox='0 0 16 16'>
						...
						<div className='pt-8 display-block md:hidden'>
							<div className='hidden w-full pt-6 pl-2 text-sm lg:text-sm md:pt-8 text-w4 md:block'>Contact</div>
							<Cbuttons />
						</div>
					</nav>
				</motion.div>
