      ...
      <nav className="fixed w-full flex items-center px-2 md:px-[10vw] xl:px-[20vw] py-4 z-10">
        <div className="w-1/3 pl-8">
          <button onClick={() => setSidebarOpen(true)}
            className="w-8 h-8 p-2 border rounded-lg shadow-sm cursor-pointer lg:w-16 lg:h-16 bg-d6 shadow-d9 border-b3 hover:bg-d6">
            <svg stroke="var(--l1)" strokeWidth="1px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
