...
function NavList() {
  return (
    ...
    <ul className="grid grid-flow-row gap-8 p-4 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center bg-d9 rounded-xl">
      <NavListMenu />
...
export function ComplexNavbar() {
  ...
  return (
    <Navbar className="fixed z-10 items-center p-2 py-4 mx-auto border-0">
      ...
      <MobileNav open={isNavOpen} className="gap-8 px-8 py-4 mr-4 w-fit rounded-xl bg-d9/90 bg-filter bg-filter-blur">
        <NavList />
      </MobileNav>
    </Navbar>
  );
