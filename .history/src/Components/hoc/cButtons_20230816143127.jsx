...
const Cbuttons = () => {
  return (
    ...
    <span className="relative inline-flex overflow-hidden border rounded-md shadow-sm shadow-d9 border-b3 bg-d7">
      <button
        className="inline-block p-3 text-l1 border-e focus:relative border-e-gray-800 hover:bg-d6"
        title="Edit Product">
        <svg
      ...
      <button
        className="inline-block p-3 text-l1 border-e-[.5px] focus:relative hover:bg-d6"
