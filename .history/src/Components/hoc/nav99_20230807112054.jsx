    ...
    <React.Fragment>
      <Menu allowHover open={isMenuOpen} handler={setIsMenuOpen}>
        ...
        <MenuList className="hidden w-[36rem] grid-cols-7 gap-3 overflow-visible lg:grid">
          ...
          <ul className="flex flex-col w-full col-span-4 gap-1 rounded-lg text-l1 bg-d9/50">
            {renderItems}
          </ul>
        </MenuList>
      </Menu>
  ...
  return (
    <Navbar className="fixed z-10 items-center p-2 py-4 mx-auto border-0">
      ...
      <Link to='/'>
        ...
        <div className="absolute hidden top-1/4 left-2/4 -translate-x-1/4 -translate-y-2/4 lg:block">
          <NavList />
        </div>
        <IconButton
          size="sm"
