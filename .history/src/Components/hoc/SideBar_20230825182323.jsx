		...
		<AnimatePresence>
			...
			{isOpen && (
				<motion.div
					...
					animate='open'
					exit='closed'
					className='fixed top-0 left-0 h-screen py-4 overflow-auto border-r-2 max-w-[20rem] w-[45vw] bg-gradient-to-l from-d7 to-d8 via-d8 rounded-r-lg border-b3 z-[99]'>
