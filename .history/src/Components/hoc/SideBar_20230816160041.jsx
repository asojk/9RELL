...
<AnimatePresence> {isOpen && (
  ...
  <nav className="flex flex-col flex-wrap justify-center w-full px-6 lg:px-8">
    ...
    <div className="grid grid-cols-2 gap-2 mt-[10vh] content-center align-middle justify-center items-center">
      <button onClick={onClose} type="button" aria-label="Toggle navigation"
        className="inline-flex items-center justify-center w-8 h-8 gap-2 transition border shadow-2xl rounded-2xl text-l1 border-d5 shadow-d7 hover:text-l5">
