  ...
  return (
    ...
    <span className="relative inline-flex overflow-hidden border rounded-md shadow-nimble border-b3 bg-d7">
      ...
      <a href="tel:+18002089693"
        className="inline-block p-3 text-l1 md:text-l1 border-e-[.5px] border-b3 focus:relative hover:bg-d6">
      ...
      <Tooltip className="p-4 text-l3 bg-d7" placement="bottom" content="Text (515) 227-6367"
        animate={{mount: { scale: 1, y: 0 }, unmount: { scale: 0, y: 25 }}}>
      <a href="sms:+15152276367"
        className="inline-block p-3 text-l1 md:text-l1 focus:relative hover:bg-d6">
