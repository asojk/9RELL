  ...
  return (
    <Navbar className="fixed z-10 items-center p-2 py-4 mx-auto border-0">
      ...
      <Link to='/'>
        ...
        <button className="ml-12 btn cursor:pointer md:hidden text-l1 bg-r group">
          Contact
          <ul className="relative hidden w-48 h-64 p-4 m-0 mt-2 group-hover:block">
            <li className="flex items-center gap-2 btn">
              <FiPhone className="w-6 h-6" />
              <a href="tel:1-800-555-5555">Call 1-800-555-5555</a>
            </li>
            <li className="flex items-center gap-2 m-0 btn">
              <FiSend className="w-6 h-6" />
              <a href="mailto:roof@grell.pro">Email roof@grell.pro</a>
            </li>
            <li className="flex items-center gap-2 m-0 btn">
              <FiMessageCircle className="w-6 h-6" />
              <a href="sms:1-800-555-5555">Text Us</a>
            </li>
