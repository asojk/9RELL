				...
				<div className='w-1/3 pl-8 z-[99]'>
					<div>
						<button onClick={() => setSidebarOpen(true)} className='relative group'>
							<div className='relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] md:w-[65px] md:h-[65px] transform transition-all bg-rd1 ring-b3 hover:ring-8 group-focus:ring-4 ring-opacity-30 duration-200'>
