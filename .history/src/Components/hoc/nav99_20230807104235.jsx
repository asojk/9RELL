  ...
  return (
    <Navbar className="max-w-screen-xl p-2 mx-auto lg:rounded-full lg:pl-6">
      <div className="relative flex items-center mx-auto text-blue-gray-900">
        <image className="mr-4 ml-2 cursor-pointer py-1.5 font-medium z-50 mx-auto w-2/2 md:w-4/4 lg:w-5/6 xl:w-5/8' src='https://grell.s3.us-east-2.amazonaws.com/grell/W-Tag.svg" alt='Logo' />
