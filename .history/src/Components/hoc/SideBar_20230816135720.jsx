      ...
      <ul className='flex flex-col h-full gap-4'>
        ...
        <div className="w-full pt-6 pb-2 pl-4 text-sm lg:text-sm md:pt-8 text-w4">About</div>
          ...
          <MenuItem to="/press" title="Press" icon={<ActivityIcon />} />
            <Link to="/"><button type="button" className="p-3 mt-6 btn border-d5 text-l1">
...
const MenuItem = ({ to, title, icon, onClose }) => (
  <Link to={to}>
    <button onClick={onClose} className="flex items-center px-6 py-2 border-[1px] cursor-pointer border-d7 md:py-4 rounded-2xl hover:border-w4 transition-colors duration-150">
