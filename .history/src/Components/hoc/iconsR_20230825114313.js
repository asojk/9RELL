...
const ActivityIcon = () => (
	<svg data-name='Iconly/Curved/Activity' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'>
		<g fill='none' stroke='var(--r)' strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit={10} strokeWidth={1.5}>
...
const CgMenuRoundI = () => (
	<IconContext.Provider value={{color: 'var(--b)', className: 'iconR', size: '24', cursor: 'pointer'}}>
		<CgMenuRound />
