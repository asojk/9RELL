      ...
      <nav className="fixed w-full flex items-center justify-between px-2 md:px-[10vw] xl:px-[20vw] py-4 z-10">
        <div className="w-1/3">
          <button
            ...
            className="w-[3.5rem] h-[3.5rem] lg:w-[4.5rem] lg:h-[4.5rem] cursor-pointer items-center text-center ml-8 border rounded-md shadow-sm shadow-d9 border-b3 bg-d7 hover:bg-d6">
            <CategoryI />
          </button>
