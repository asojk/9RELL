...
const Cbuttons = () => {
  return (
    ...
    <span className="relative inline-flex overflow-hidden border rounded-md shadow-nimble border-b3 bg-d7">
      <Tooltip className="p-2 text-r md:text-l3 bg-d7" placement="bottom" content="Call 1-800 208-9693"
      ...
      <Tooltip className="p-2 text-r md:text-l3 bg-d7" placement="bottom" content="Email Roof@Grell.pro"
        animate={{mount: { scale: 1, y: 0 }, unmount: { scale: 0, y: 25 }}}>
      ...
      <Tooltip className="p-2 text-r md:text-l3 bg-d7" placement="bottom" content="Text (515) 227-6367"
        animate={{mount: { scale: 1, y: 0 }, unmount: { scale: 0, y: 25 }}}>
