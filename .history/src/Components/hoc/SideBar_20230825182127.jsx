		...
		<AnimatePresence>
			...
			{isOpen && (
				<motion.div
					...
					animate='open'
					exit='closed'
					className='fixed top-0 left-0 h-screen py-4 overflow-auto text-lg border-r-2 w-42 md:text-xl lg:text-2xl md:max-w-[28rem] md:w-[45vw] bg-gradient-to-l from-d7 to-d8 via-d8 rounded-r-lg text-l1 border-b3 z-[99]'>
