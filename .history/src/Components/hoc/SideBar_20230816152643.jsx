...
const MenuItem = ({ to, title, icon, onClick }) => (
  <Link to={to} onClick={onClick}>
    <button className="flex items-center px-2 lg:px-6 py-2 border-[1px] cursor-pointer border-b3 md:py-4 rounded-2xl hover:border-w4 transition-colors duration-150">
