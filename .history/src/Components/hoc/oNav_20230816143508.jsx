...
function Navbar() {
  ...
  return (
    <>
      <nav className="fixed w-full flex items-center justify-between px-2 lg:px-[10vw] py-4 z-10">
        <div className="w-1/3">
				<button
      ...
      <SideBar isOpen={isSidebarOpen} onClose={() => setSidebarOpen(false)} />
        ...
        <div className="items-center w-1/3 text-center bg-transparent place-content-center">
          <Link to="/">
            <img
              className="mx-auto w-2/2 md:w-4/4 lg:w-5/6 xl:w-5/8 xl:max-w-[20rem]"
