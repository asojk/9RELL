  ...
  return (
    <Navbar className="fixed z-10 items-center p-2 py-4 mx-auto border-0">
      ...
      <Link to='/'>
        ...
        <button className="ml-12 cursor:pointer text-end btn md:hidden text-l1 bg-r group">
          Contact
          <ul className="absolute hidden w-48 p-4 mt-2 group-hover:block bg-l1 rounded-xl">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:roof@grell.pro">roof@grell.pro</a>
            </li>
            <li className="flex items-center gap-2">
