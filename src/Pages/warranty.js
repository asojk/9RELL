      ...
      <div className="py-20">
        <div className="xl:container m-auto px-6 text-white md:px-12 xl:px-6">
          <div className="grid gap-8 md:grid-rows-2 lg:grid-cols-2">
            ...
            <div className="rgroup relative rounded-3xl space-y-6 border border-gray-500 p-8 text-left">
              <div>
                <h5 className="mb-4 text-xl font-bold text-white md:text-2xl">
                  More Information
                </h5>
              </div>
              <img
            ...
            <div className="rgroup relative rounded-3xl space-y-6 border border-gray-500 p-8 text-left">
              <div>
                <h5 className="mb-2 text-lg font-bold text-white md:text-xl">
                  Inspection
                </h5>
              </div>
              <img
              ...
              <p className="text-white-600">
                ...
                Roofing System. Click{' '}
                <a href="/media/marketing/literature/maintenance_checklist.pdf">
                  here
                </a>{' '}
                to access the Owners Maintenance Checklist and learn what you
                can do to help protect your Duro-Last Roofing System.
              </p>
            </div>
          </div>
        </div>
