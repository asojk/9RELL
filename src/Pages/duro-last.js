...
const DuroLast = (props) => {
	return (
		<div className="page-container" style={{ zIndex: "9999" }}>

			<iframe width="560" height="315" src="https://www.youtube.com/embed/dFxkGoFoyQY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
