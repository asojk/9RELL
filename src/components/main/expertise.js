...
const Expertise = () => (
  <div className="exp">
    <header className="header">
      ...
      <h2 className="heading">We work across a variety of industries</h2>
    </header>
    <div className="exp-container1">
      ...
      <p className="exp-text">
        ...
        <strong> confident</strong> that we can take care of you. Our team is
        experienced in working with all parties including building owners,
        architects, and specifiers to make sure the re-roofing process goes as
